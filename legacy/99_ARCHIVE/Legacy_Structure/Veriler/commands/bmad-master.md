...
commands:
  ...
  - kb: Toggle KB mode off (default) or on, when on will load and reference the .YBIS_Dev/Veriler/data/bmad-kb.md and converse with the user answering his questions with this informational resource
