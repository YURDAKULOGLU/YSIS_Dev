...
$TEMPLATE_FILE = Join-Path $REPO_ROOT '.YBIS_Dev/Veriler/templates/agent-file-template.md'
...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Run specify init to scaffold .YBIS_Dev/Veriler/templates, or add agent-file-template.md there.'
        exit 1
    }
}
