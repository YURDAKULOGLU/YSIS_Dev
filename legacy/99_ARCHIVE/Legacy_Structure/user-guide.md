...
- Two installation modes:
  - Codex (local only): keeps `.YBIS_Dev/Veriler/` ignored for local dev.
    - `npx bmad-method install -f -i codex -d .`
  - Codex Web Enabled: ensures `.YBIS_Dev/Veriler/` is tracked so you can commit it for Codex Web.
...
- Using Codex:
  ...
  - Web: commit `.YBIS_Dev/Veriler/` and `AGENTS.md`, then open the repo in Codex and prompt the same way.
...
BMad includes a personalization system through the `technical-preferences.md` file located in `.YBIS_Dev/Veriler/data/` - this can help bias the PM and Architect to recommend your preferences for design patterns, technology selection, or anything else you would like to put in here.
