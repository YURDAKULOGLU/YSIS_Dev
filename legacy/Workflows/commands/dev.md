...
activation-instructions:
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for development standards for this project - .YBIS_Dev/Veriler/core-config.yaml devLoadAlwaysFiles list
