...
[Skip to content](#answer-correctness)
...
Next, we calculate the semantic similarity between the generated answer and the ground truth. Read more about it [here](../semantic_similarity/).
