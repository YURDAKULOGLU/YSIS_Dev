...
[Skip to content](#answer-relevancy)
...
2. Compute the cosine similarity between the embedding of the user input (\(E\_o\)) and the embedding of each generated question (\(E\_{g\_i}\)).
3. Take the average of these cosine similarity scores to get the **Answer Relevancy**:

\[
\text{Answer Relevancy} = \frac{1}{N} \sum\_{i=1}^{N} \text{cosine similarity}(E\_{g\_i}, E\_o)
\]

\[
\text{Answer Relevancy} = \frac{1}{N} \sum\_{i=1}^{N} \frac{E\_{g\_i} \cdot E\_o}{\|E\_{g\_i}\| \|E\_o\|}
\]

Where:  
- \(E\_{g\_i}\): Embedding of the \(i^{th}\) generated question.  
- \(E\_o\): Embedding of the user input.  
