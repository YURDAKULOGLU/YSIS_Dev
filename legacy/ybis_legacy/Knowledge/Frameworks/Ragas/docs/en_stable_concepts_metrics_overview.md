...
[Skip to content](#overview-of-metrics)
...
[![Component-wise Evaluation](../../../_static/imgs/metrics_mindmap.png)](../../../_static/imgs/metrics_mindmap.png)
...
Each LLM based metrics also will have prompts associated with it written using [Prompt Object](../../components/prompt/). You can customize these prompts to suit your domain and use-case. Learn more in the [Modifying Prompts in Metrics](../../../howtos/customizations/metrics/modifying-prompts-metrics/) guide.
...
**Single turn metrics**: These metrics evaluate the performance of the AI application based on a single turn of interaction between the user and the AI. All metrics in ragas that supports single turn evaluation are inherited from [SingleTurnMetric](../../../references/metrics/#ragas.metrics.base.SingleTurnMetric) class and scored using `single_turn_ascore` method. It also expects a [Single Turn Sample](../../../references/evaluation_schema/#ragas.dataset_schema.SingleTurnSample) object as input.
...
For modifying prompts in existing collection metrics (like Faithfulness, FactualCorrectness), see [Modifying prompts in metrics](../../../howtos/customizations/metrics/modifying-prompts-metrics/).
