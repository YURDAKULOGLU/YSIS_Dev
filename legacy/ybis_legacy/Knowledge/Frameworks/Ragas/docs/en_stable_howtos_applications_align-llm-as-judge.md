...
[Skip to content](#how-to-align-an-llm-as-a-judge)
...
The real value: Looking at your data
...
| question | grading\_notes | response | target |
| --- | --- | --- | --- |
...
Understanding your ground truth
...
The evaluation generates comprehensive CSV results containing all inputs (question, grading\_notes, response), human targets, judge decisions with reasoning, and alignment comparisons.
