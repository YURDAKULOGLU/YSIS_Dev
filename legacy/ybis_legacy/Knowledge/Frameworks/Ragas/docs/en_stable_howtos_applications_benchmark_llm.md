...
[Skip to content](#how-to-evaluate-a-new-llm-for-your-use-case)
...
To customize the dataset for your use case, create a `datasets/` directory and add your own CSV file. Refer to [Core Concepts - Evaluation Dataset](../../../concepts/components/eval_dataset/) for more information.
...
It is generally better to use a simple metric. You should use a metric relevant to your use case. More information on metrics can be found in [Core Concepts - Metrics](../../../concepts/metrics/). The evaluation uses this accuracy metric to score each response:
...
* id, model, response, predicted\_discount, score, score\_reason
...
| id | customer\_profile | description | expected\_discount | gpt-4.1-nano-2025-04-14\_score | gpt-5-nano-2025-08-07\_score | gpt-4.1-nano-2025-04-14\_score\_reason | gpt-5-nano-2025-08-07\_score\_reason | gpt-4.1-nano-2025-04-14\_response | gpt-5-nano-2025-08-07\_response |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
* Use each row's score\_reason to see why it was marked correct/incorrect.
