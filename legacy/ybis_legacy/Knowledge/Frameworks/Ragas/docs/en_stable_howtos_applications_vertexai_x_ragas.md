Evaluations with Vertex AI models - Ragas
...
[Skip to content](#getting-started-ragas-with-vertex-ai)
...
* [Align LLM Metrics](../vertexai_alignment/): Train and align your LLM evaluators to better match human judgment.
* [Model Comparison](../vertexai_model_comparision/): Compare models provided by VertexAI on RAG-based Q&A task using Ragas metrics.
...
These metrics employ established string matching, n-gram, and statistical methods to quantify text similarity and quality computed entirely mathematically without LLM calls. For more details, please visit the [computation-based metrics documentation](../../../concepts/metrics/available_metrics/traditional/).
...
To perform evaluations using Ragas metrics, you need to convert your data into an `EvaluationDataset`, a data type in Ragas. You can read more about it [here](../../../concepts/components/eval_dataset/).
...
|  | user\_input | retrieved\_contexts | response | reference | maliciousness | context\_precision | faithfulness | rouge\_score(mode=fmeasure) | helpfulness |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
