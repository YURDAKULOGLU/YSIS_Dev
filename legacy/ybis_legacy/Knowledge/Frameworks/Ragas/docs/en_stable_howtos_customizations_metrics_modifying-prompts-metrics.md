...
[Skip to content](#modifying-prompts-in-metrics)
...
**Quick start**: If you need a simple custom metric, consider using [`DiscreteMetric`](../../../../references/metrics/#ragas.metrics.DiscreteMetric) or [`NumericMetric`](../../../../references/metrics/#ragas.metrics.NumericMetric) which accept custom prompts directly. See [Discrete Metrics](../../../../concepts/metrics/overview/#1-discrete-metrics) for examples.

This guide covers modifying prompts in **existing collection metrics** (like Faithfulness, FactualCorrectness) which use the [`BasePrompt`](../../../../references/prompt/#ragas.prompt.BasePrompt) class. Make sure you have an understanding of the [Prompt Object documentation](../../../../concepts/components/prompt/) before going further.
