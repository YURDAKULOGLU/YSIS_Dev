Non-English Testset Generation - Ragas
...
[Skip to content](#synthetic-test-generation-from-non-english-corpus)
...
you may automatically create personas using this [notebook](../_persona_generator/). For the sake of simplicity, I am using a pre-defined person, two basic transforms and simple query distribution.
