...
[Skip to content](#create-custom-single-hop-queries-from-your-documents)
...
You may use any of [your choice](../../customize_models/), here I am using models from open-ai.
...
You can also do this automatically by using the [automatic persona generator](../_persona_generator/)
