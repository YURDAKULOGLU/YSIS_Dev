...
[Skip to content](#langchain-integration)
...
To evaluate the Q&A system we need to structure the queries, expected\_responses and other metric specific requirements to [EvaluationDataset](../../../references/evaluation_schema/#ragas.dataset_schema.EvaluationDataset).
