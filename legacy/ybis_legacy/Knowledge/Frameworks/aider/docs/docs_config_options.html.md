...
* [Git settings:](#git-settings)
  ...
  + [`--attribute-co-authored-by`](#--attribute-co-authored-by)
...
* [Analytics:](#analytics)
  ...
  + [`--analytics-posthog-host ANALYTICS_POSTHOG_HOST`](#--analytics-posthog-host-analytics_posthog_host)
  + [`--analytics-posthog-project-api-key ANALYTICS_POSTHOG_PROJECT_API_KEY`](#--analytics-posthog-project-api-key-analytics_posthog_project_api_key)
* [Upgrading:](#upgrading)
...
* [Other settings:](#other-settings)
  ...
  + [`--commit-language COMMIT_LANGUAGE`](#--commit-language-commit_language)
  ...
  + [`--shell-completions SHELL`](#--shell-completions-shell)
