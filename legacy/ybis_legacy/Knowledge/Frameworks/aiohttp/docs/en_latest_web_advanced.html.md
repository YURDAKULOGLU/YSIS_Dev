Web Server Advanced — aiohttp 4.0.0a2.dev0 documentation
...
stored in a [`Request`](web_reference.html#aiohttp.web.Request "aiohttp.web.Request"). Similarly to [`Application`](web_reference.html#aiohttp.web.Application "aiohttp.web.Application"), [`RequestKey`](web_reference.html#aiohttp.web.RequestKey "aiohttp.web.RequestKey")
...
[`HTTPException`](web_exceptions.html#aiohttp.web.HTTPException "aiohttp.web.HTTPException") it is converted to `500`
[`HTTPInternalServerError`](web_exceptions.html#aiohttp.web.HTTPInternalServerError "aiohttp.web.HTTPInternalServerError") after processing the
middlewares chain.
...
e.g. displaying *403 Forbidden page* or raising [`HTTPForbidden`](web_exceptions.html#aiohttp.web.HTTPForbidden "aiohttp.web.HTTPForbidden") exception
...
[`HTTPExpectationFailed`](web_exceptions.html#aiohttp.web.HTTPExpectationFailed "aiohttp.web.HTTPExpectationFailed") if header value is not equal to
...
handler can raise a subclass of [`HTTPException`](web_exceptions.html#aiohttp.web.HTTPException "aiohttp.web.HTTPException"). In this case all
...
* [Server](web.html)
  ...
  + [Web Exceptions](web_exceptions.html)
