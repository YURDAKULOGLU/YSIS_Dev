...
- Client supports :ref:`middleware ` for
...
Body: 
...
Coming from :term:`requests` ? Read :ref:`why we need so many lines `.
Server example:
----------------
.. code-block:: python
...
app = web.Application()
app.add\_routes([web.get('/', handle),
web.get('/{name}', handle)])
...
========================
Go to :ref:`aiohttp\_whats\_new\_3\_0` page for aiohttp 3.0 major release
changes.
Tutorial
========
:ref:`Polls tutorial `
