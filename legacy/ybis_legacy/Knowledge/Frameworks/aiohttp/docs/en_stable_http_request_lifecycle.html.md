The aiohttp Request Lifecycle — aiohttp 3.13.3 documentation

# The aiohttp Request Lifecycle[¶](#the-aiohttp-request-lifecycle "Link to this heading")

## Why is aiohttp client API that way?[¶](#why-is-aiohttp-client-api-that-way "Link to this heading")
...
It’s especially unexpected when coming from other libraries such as the very popular [requests](glossary.html#term-requests), where the “hello world” looks like this:
...
|
[Page source](_sources/http_request_lifecycle.rst.txt)
