celery.utils.dispatch.signal — Celery 5.6.2 documentation

### Navigation

* [index](../../genindex.html "General Index")
* [modules](../../py-modindex.html "Python Module Index") |
* [next](celery.platforms.html "celery.platforms") |
* [previous](celery.utils.dispatch.html "celery.utils.dispatch") |
...
# `celery.utils.dispatch.signal`[¶](#celery-utils-dispatch-signal "Link to this heading")

Implementation of the Observer pattern.

*class* celery.utils.dispatch.signal.Signal(*providing\_args=None*, *use\_caching=False*, *name=None*)[[source]](../../_modules/celery/utils/dispatch/signal.html#Signal)[¶](#celery.utils.dispatch.signal.Signal "Link to this definition")
:   Create new signal.
    ...
    connect(*\*args*, *\*\*kwargs*)[[source]](../../_modules/celery/utils/dispatch/signal.html#Signal.connect)[¶](#celery.utils.dispatch.signal.Signal.connect "Link to this definition")
    ...
    disconnect(*receiver=None*, *sender=None*, *weak=None*, *dispatch\_uid=None*)[[source]](../../_modules/celery/utils/dispatch/signal.html#Signal.disconnect)[¶](#celery.utils.dispatch.signal.Signal.disconnect "Link to this definition")
    ...
    has\_listeners(*sender=None*)[[source]](../../_modules/celery/utils/dispatch/signal.html#Signal.has_listeners)[¶](#celery.utils.dispatch.signal.Signal.has_listeners "Link to this definition")

    receivers *= None*[¶](#celery.utils.dispatch.signal.Signal.receivers "Link to this definition")
    :   Holds a dictionary of
        `{receiverkey (id): weakref(receiver)}` mappings.

    send(*sender*, *\*\*named*)[[source]](../../_modules/celery/utils/dispatch/signal.html#Signal.send)[¶](#celery.utils.dispatch.signal.Signal.send "Link to this definition")
    ...
    send\_robust(*sender*, *\*\*named*)[¶](#celery.utils.dispatch.signal.Signal.send_robust "Link to this definition")
    :   Send signal from sender to all connected receivers.
...
[`celery.utils.dispatch`](celery.utils.dispatch.html "previous chapter")

#### Next topic

[`celery.platforms`](celery.platforms.html "next chapter")

### This Page

* [Show Source](../../_sources/internals/reference/celery.utils.dispatch.signal.rst.txt)
