...
### [​](#human-in-the-loop-human-feedback) Human in the Loop (human feedback)
...
#### [​](#option-1:-using-the-plot-method) Option 1: Using the `plot()` Method
...
### [​](#using-the-flow-api) Using the Flow API
...
### [​](#streaming-flow-execution) Streaming Flow Execution
...
Previous](/en/concepts/crews)[Production Architecture

Next](/en/concepts/production-architecture)
