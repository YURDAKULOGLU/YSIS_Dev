...
## [​](#1-basic-memory-system-recommended) 1. Basic Memory System (Recommended)
...
## [​](#storage-location-transparency) Storage Location Transparency
...
### [​](#where-crewai-stores-files) Where CrewAI Stores Files
...
### [​](#finding-your-storage-location) Finding Your Storage Location
...
### [​](#controlling-storage-locations) Controlling Storage Locations
...
#### [​](#option-2:-custom-storage-paths) Option 2: Custom Storage Paths
...
#### [​](#option-3:-project-specific-storage) Option 3: Project-Specific Storage
...
### [​](#embedding-provider-defaults) Embedding Provider Defaults
...
#### [​](#customizing-embedding-providers) Customizing Embedding Providers
...
#### [​](#check-storage-permissions) Check Storage Permissions
...
#### [​](#inspect-chromadb-collections) Inspect ChromaDB Collections
...
#### [​](#reset-storage-debugging) Reset Storage (Debugging)
...
### [​](#common-storage-issues) Common Storage Issues
...
## [​](#custom-embedder-configuration) Custom Embedder Configuration
...
### [​](#why-choose-different-embedding-providers) Why Choose Different Embedding Providers?
...
### [​](#openai-embeddings-default) OpenAI Embeddings (Default)
...
### [​](#google-ai-embeddings) Google AI Embeddings
...
### [​](#voyageai-embeddings) VoyageAI Embeddings
...
### [​](#aws-bedrock-embeddings) AWS Bedrock Embeddings
...
### [​](#ibm-watson-embeddings) IBM Watson Embeddings
...
### [​](#testing-different-embedding-providers) Testing Different Embedding Providers
...
### [​](#troubleshooting-embedding-issues) Troubleshooting Embedding Issues
...
### [​](#entity-memory-batching-behavior) Entity Memory batching behavior
...
### [​](#advanced-external-memory-with-mem0-client) Advanced External Memory with Mem0 Client
...
## [​](#🧠-memory-system-comparison) 🧠 Memory System Comparison
...
### [​](#available-memory-events) Available Memory Events
...
#### [​](#1-memory-performance-monitoring) 1. Memory Performance Monitoring
...
#### [​](#2-memory-content-logging) 2. Memory Content Logging
...
#### [​](#3-error-tracking-and-notifications) 3. Error Tracking and Notifications
...
### [​](#integrating-with-analytics-platforms) Integrating with Analytics Platforms
...
### [​](#best-practices-for-memory-event-listeners) Best Practices for Memory Event Listeners
...
Previous](/en/concepts/training)[Reasoning

Next](/en/concepts/reasoning)
