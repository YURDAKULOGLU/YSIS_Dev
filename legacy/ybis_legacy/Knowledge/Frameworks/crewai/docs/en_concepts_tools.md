...
CrewAI AOP provides a comprehensive Tools Repository with pre-built integrations for common business systems and APIs. Deploy agents with enterprise tools in minutes instead of days.The Enterprise Tools Repository includes:
...
## [​](#asynchronous-tool-support) Asynchronous Tool Support
...
#### [​](#1-using-the-tool-decorator-with-async-functions) 1. Using the `tool` Decorator with Async Functions
...
#### [​](#2-implementing-async-methods-in-custom-tool-classes) 2. Implementing Async Methods in Custom Tool Classes
...
### [​](#using-async-tools) Using Async Tools
...
Previous](/en/concepts/cli)[Event Listeners

Next](/en/concepts/event-listener)
