...
### [​](#1-trusting-mcp-servers) 1. Trusting MCP Servers
...
### [​](#2-secure-prompt-injection-via-tool-metadata:-the-“model-control-protocol”-risk) 2. Secure Prompt Injection via Tool Metadata: The “Model Control Protocol” Risk
...
### [​](#stdio-transport-security) Stdio Transport Security
...
### [​](#remote-transport-security-sse-&-streamable-http) Remote Transport Security (SSE & Streamable HTTP)
...
### [​](#sse-security-considerations) SSE Security Considerations

### [​](#a-dns-rebinding-attacks-especially-for-sse) a. DNS Rebinding Attacks (Especially for SSE)
...
### [​](#c-token-passthrough-anti-pattern) c. Token Passthrough (Anti-Pattern)
...
### [​](#d-input-validation-and-sanitization) d. Input Validation and Sanitization
...
### [​](#e-rate-limiting-and-resource-management) e. Rate Limiting and Resource Management
...
## [​](#4-secure-mcp-server-implementation-advice-for-developers) 4. Secure MCP Server Implementation Advice (For Developers)
...
Previous](/en/mcp/multiple-servers)[Tools Overview

Next](/en/tools/overview)
