NetworkX — Grimp 3.14 documentation



* NetworkX
* [View page source](_sources/networkx.rst.txt)

---

# NetworkX[](#networkx "Link to this heading")

If you want to analyze the graph in a way that isn’t provided by Grimp, you may want to consider converting the graph to a [NetworkX](https://networkx.org/) graph.

NetworkX is a third-party Python library with a large number of algorithms for working with graphs.

## Converting the Grimp graph to a NetworkX graph[](#converting-the-grimp-graph-to-a-networkx-graph "Link to this heading")
