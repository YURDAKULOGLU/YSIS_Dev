...
[Skip to content](#langchain-ollama)

# `langchain-ollama`[¶](#langchain-ollama "Copy anchor link to this section for reference")
...
## langchain\_ollama [¶](#langchain_ollama "Copy anchor link to this section for reference")
...
### ChatOllama [¶](#langchain_ollama.ChatOllama "Copy anchor link to this section for reference")
...
#### name `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.name "Copy anchor link to this section for reference")
...
#### InputType `property` [¶](#langchain_ollama.ChatOllama.InputType "Copy anchor link to this section for reference")
...
#### OutputType `property` [¶](#langchain_ollama.ChatOllama.OutputType "Copy anchor link to this section for reference")
...
#### input\_schema `property` [¶](#langchain_ollama.ChatOllama.input_schema "Copy anchor link to this section for reference")
...
#### output\_schema `property` [¶](#langchain_ollama.ChatOllama.output_schema "Copy anchor link to this section for reference")
...
#### config\_specs `property` [¶](#langchain_ollama.ChatOllama.config_specs "Copy anchor link to this section for reference")
...
#### lc\_secrets `property` [¶](#langchain_ollama.ChatOllama.lc_secrets "Copy anchor link to this section for reference")
...
#### lc\_attributes `property` [¶](#langchain_ollama.ChatOllama.lc_attributes "Copy anchor link to this section for reference")
...
#### cache `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.cache "Copy anchor link to this section for reference")
...
#### verbose `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.verbose "Copy anchor link to this section for reference")
...
#### callbacks `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.callbacks "Copy anchor link to this section for reference")
...
#### tags `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.tags "Copy anchor link to this section for reference")
...
#### metadata `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.metadata "Copy anchor link to this section for reference")
...
#### custom\_get\_token\_ids `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.custom_get_token_ids "Copy anchor link to this section for reference")
...
#### rate\_limiter `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.rate_limiter "Copy anchor link to this section for reference")
...
#### disable\_streaming `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.disable_streaming "Copy anchor link to this section for reference")
...
#### output\_version `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.output_version "Copy anchor link to this section for reference")
...
#### profile `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.profile "Copy anchor link to this section for reference")
...
#### model `instance-attribute` [¶](#langchain_ollama.ChatOllama.model "Copy anchor link to this section for reference")
...
#### reasoning `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.reasoning "Copy anchor link to this section for reference")
...
#### validate\_model\_on\_init `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.validate_model_on_init "Copy anchor link to this section for reference")
...
#### mirostat `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.mirostat "Copy anchor link to this section for reference")
...
#### mirostat\_eta `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.mirostat_eta "Copy anchor link to this section for reference")
...
#### mirostat\_tau `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.mirostat_tau "Copy anchor link to this section for reference")
...
#### num\_ctx `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.num_ctx "Copy anchor link to this section for reference")
...
#### num\_gpu `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.num_gpu "Copy anchor link to this section for reference")
...
#### num\_thread `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.num_thread "Copy anchor link to this section for reference")
...
#### num\_predict `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.num_predict "Copy anchor link to this section for reference")
...
#### repeat\_last\_n `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.repeat_last_n "Copy anchor link to this section for reference")
...
#### repeat\_penalty `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.repeat_penalty "Copy anchor link to this section for reference")
...
#### temperature `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.temperature "Copy anchor link to this section for reference")
...
#### seed `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.seed "Copy anchor link to this section for reference")
...
#### stop `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.stop "Copy anchor link to this section for reference")
...
#### tfs\_z `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.tfs_z "Copy anchor link to this section for reference")
...
#### top\_k `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.top_k "Copy anchor link to this section for reference")
...
#### top\_p `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.top_p "Copy anchor link to this section for reference")
...
#### format `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.format "Copy anchor link to this section for reference")
...
#### keep\_alive `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.keep_alive "Copy anchor link to this section for reference")
...
#### base\_url `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.base_url "Copy anchor link to this section for reference")
...
#### client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.client_kwargs "Copy anchor link to this section for reference")
...
#### async\_client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.async_client_kwargs "Copy anchor link to this section for reference")
...
#### sync\_client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.ChatOllama.sync_client_kwargs "Copy anchor link to this section for reference")
...
#### get\_name [¶](#langchain_ollama.ChatOllama.get_name "Copy anchor link to this section for reference")
...
#### get\_input\_schema [¶](#langchain_ollama.ChatOllama.get_input_schema "Copy anchor link to this section for reference")
...
#### get\_input\_jsonschema [¶](#langchain_ollama.ChatOllama.get_input_jsonschema "Copy anchor link to this section for reference")
...
#### get\_output\_schema [¶](#langchain_ollama.ChatOllama.get_output_schema "Copy anchor link to this section for reference")
...
#### get\_output\_jsonschema [¶](#langchain_ollama.ChatOllama.get_output_jsonschema "Copy anchor link to this section for reference")
...
#### config\_schema [¶](#langchain_ollama.ChatOllama.config_schema "Copy anchor link to this section for reference")
...
#### get\_config\_jsonschema [¶](#langchain_ollama.ChatOllama.get_config_jsonschema "Copy anchor link to this section for reference")
...
#### get\_graph [¶](#langchain_ollama.ChatOllama.get_graph "Copy anchor link to this section for reference")
...
#### get\_prompts [¶](#langchain_ollama.ChatOllama.get_prompts "Copy anchor link to this section for reference")
...
#### \_\_or\_\_ [¶](#langchain_ollama.ChatOllama.__or__ "Copy anchor link to this section for reference")
...
#### \_\_ror\_\_ [¶](#langchain_ollama.ChatOllama.__ror__ "Copy anchor link to this section for reference")
...
#### pipe [¶](#langchain_ollama.ChatOllama.pipe "Copy anchor link to this section for reference")
...
#### pick [¶](#langchain_ollama.ChatOllama.pick "Copy anchor link to this section for reference")
...
#### assign [¶](#langchain_ollama.ChatOllama.assign "Copy anchor link to this section for reference")
...
#### invoke [¶](#langchain_ollama.ChatOllama.invoke "Copy anchor link to this section for reference")
...
#### ainvoke `async` [¶](#langchain_ollama.ChatOllama.ainvoke "Copy anchor link to this section for reference")
...
#### batch [¶](#langchain_ollama.ChatOllama.batch "Copy anchor link to this section for reference")
...
#### batch\_as\_completed [¶](#langchain_ollama.ChatOllama.batch_as_completed "Copy anchor link to this section for reference")
...
#### abatch `async` [¶](#langchain_ollama.ChatOllama.abatch "Copy anchor link to this section for reference")
...
#### abatch\_as\_completed `async` [¶](#langchain_ollama.ChatOllama.abatch_as_completed "Copy anchor link to this section for reference")
...
#### stream [¶](#langchain_ollama.ChatOllama.stream "Copy anchor link to this section for reference")
...
#### astream `async` [¶](#langchain_ollama.ChatOllama.astream "Copy anchor link to this section for reference")
...
#### astream\_log `async` [¶](#langchain_ollama.ChatOllama.astream_log "Copy anchor link to this section for reference")
...
#### astream\_events `async` [¶](#langchain_ollama.ChatOllama.astream_events "Copy anchor link to this section for reference")
...
#### transform [¶](#langchain_ollama.ChatOllama.transform "Copy anchor link to this section for reference")
...
#### atransform `async` [¶](#langchain_ollama.ChatOllama.atransform "Copy anchor link to this section for reference")
...
#### bind [¶](#langchain_ollama.ChatOllama.bind "Copy anchor link to this section for reference")
...
#### with\_config [¶](#langchain_ollama.ChatOllama.with_config "Copy anchor link to this section for reference")
...
#### with\_listeners [¶](#langchain_ollama.ChatOllama.with_listeners "Copy anchor link to this section for reference")
...
#### with\_alisteners [¶](#langchain_ollama.ChatOllama.with_alisteners "Copy anchor link to this section for reference")
...
#### with\_types [¶](#langchain_ollama.ChatOllama.with_types "Copy anchor link to this section for reference")
...
#### with\_retry [¶](#langchain_ollama.ChatOllama.with_retry "Copy anchor link to this section for reference")
...
#### map [¶](#langchain_ollama.ChatOllama.map "Copy anchor link to this section for reference")
...
#### with\_fallbacks [¶](#langchain_ollama.ChatOllama.with_fallbacks "Copy anchor link to this section for reference")
...
#### as\_tool [¶](#langchain_ollama.ChatOllama.as_tool "Copy anchor link to this section for reference")
...
#### \_\_init\_\_ [¶](#langchain_ollama.ChatOllama.__init__ "Copy anchor link to this section for reference")

```
__init__(*args: Any, **kwargs: Any) -> None
```

#### is\_lc\_serializable `classmethod` [¶](#langchain_ollama.ChatOllama.is_lc_serializable "Copy anchor link to this section for reference")
...
#### get\_lc\_namespace `classmethod` [¶](#langchain_ollama.ChatOllama.get_lc_namespace "Copy anchor link to this section for reference")
...
For example, if the class is [`langchain.llms.openai.OpenAI`](../langchain_openai/OpenAI/#langchain_openai.OpenAI "<code class=\"doc-symbol doc-symbol-heading doc-symbol-class\"></code>            <span class=\"doc doc-object-name doc-class-name\">OpenAI</span>"),
...
#### lc\_id `classmethod` [¶](#langchain_ollama.ChatOllama.lc_id "Copy anchor link to this section for reference")
...
#### to\_json [¶](#langchain_ollama.ChatOllama.to_json "Copy anchor link to this section for reference")
...
#### to\_json\_not\_implemented [¶](#langchain_ollama.ChatOllama.to_json_not_implemented "Copy anchor link to this section for reference")
...
#### configurable\_fields [¶](#langchain_ollama.ChatOllama.configurable_fields "Copy anchor link to this section for reference")
...
#### configurable\_alternatives [¶](#langchain_ollama.ChatOllama.configurable_alternatives "Copy anchor link to this section for reference")
...
#### set\_verbose [¶](#langchain_ollama.ChatOllama.set_verbose "Copy anchor link to this section for reference")
...
#### generate\_prompt [¶](#langchain_ollama.ChatOllama.generate_prompt "Copy anchor link to this section for reference")
...
#### agenerate\_prompt `async` [¶](#langchain_ollama.ChatOllama.agenerate_prompt "Copy anchor link to this section for reference")
...
#### get\_token\_ids [¶](#langchain_ollama.ChatOllama.get_token_ids "Copy anchor link to this section for reference")
...
#### get\_num\_tokens [¶](#langchain_ollama.ChatOllama.get_num_tokens "Copy anchor link to this section for reference")
...
#### get\_num\_tokens\_from\_messages [¶](#langchain_ollama.ChatOllama.get_num_tokens_from_messages "Copy anchor link to this section for reference")
...
#### generate [¶](#langchain_ollama.ChatOllama.generate "Copy anchor link to this section for reference")
...
#### agenerate `async` [¶](#langchain_ollama.ChatOllama.agenerate "Copy anchor link to this section for reference")
...
#### dict [¶](#langchain_ollama.ChatOllama.dict "Copy anchor link to this section for reference")
...
#### bind\_tools [¶](#langchain_ollama.ChatOllama.bind_tools "Copy anchor link to this section for reference")
...
| PARAMETER | DESCRIPTION |
| --- | --- |
| `tools` | A list of tool definitions to bind to this chat model.  Supports any tool definition handled by [`convert_to_openai_tool`](../../langchain_core/utils/#langchain_core.utils.function_calling.convert_to_openai_tool "<code class=\"doc-symbol doc-symbol-heading doc-symbol-function\"></code>            <span class=\"doc doc-object-name doc-function-name\">convert_to_openai_tool</span>").  **TYPE:** `Sequence[dict[str, Any] | type | Callable | BaseTool]` |
| `tool_choice` | If provided, which tool for model to call. **This parameter is currently ignored as it is not supported by Ollama.**  **TYPE:** `dict | str | Literal['auto', 'any'] | bool | None`  **DEFAULT:** `None` |
| `kwargs` | Any additional parameters are passed directly to `self.bind(**kwargs)`.  **TYPE:** `Any`  **DEFAULT:** `{}` |

#### with\_structured\_output [¶](#langchain_ollama.ChatOllama.with_structured_output "Copy anchor link to this section for reference")
...
| `method` | The method for steering model generation, one of:   * `'json_schema'`:   Uses Ollama's [structured output API](https://ollama.com/blog/structured-outputs) * `'function_calling'`:   Uses Ollama's tool-calling API * `'json_mode'`:   Specifies `format='json'`. Note that if using JSON mode then you   must include instructions for formatting the output into the   desired schema into the model call.  **TYPE:** `Literal['function_calling', 'json_mode', 'json_schema']`  **DEFAULT:** `'json_schema'` |
...
### OllamaEmbeddings [¶](#langchain_ollama.OllamaEmbeddings "Copy anchor link to this section for reference")
...
#### model `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.model "Copy anchor link to this section for reference")
...
#### validate\_model\_on\_init `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.validate_model_on_init "Copy anchor link to this section for reference")
...
#### base\_url `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.base_url "Copy anchor link to this section for reference")
...
#### client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.client_kwargs "Copy anchor link to this section for reference")
...
#### async\_client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.async_client_kwargs "Copy anchor link to this section for reference")
...
#### sync\_client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.sync_client_kwargs "Copy anchor link to this section for reference")
...
#### mirostat `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.mirostat "Copy anchor link to this section for reference")
...
#### mirostat\_eta `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.mirostat_eta "Copy anchor link to this section for reference")
...
#### mirostat\_tau `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.mirostat_tau "Copy anchor link to this section for reference")
...
#### num\_ctx `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.num_ctx "Copy anchor link to this section for reference")
...
#### num\_gpu `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.num_gpu "Copy anchor link to this section for reference")
...
#### keep\_alive `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.keep_alive "Copy anchor link to this section for reference")
...
#### num\_thread `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.num_thread "Copy anchor link to this section for reference")
...
#### repeat\_last\_n `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.repeat_last_n "Copy anchor link to this section for reference")
...
#### repeat\_penalty `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.repeat_penalty "Copy anchor link to this section for reference")
...
#### temperature `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.temperature "Copy anchor link to this section for reference")
...
#### stop `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.stop "Copy anchor link to this section for reference")
...
#### tfs\_z `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.tfs_z "Copy anchor link to this section for reference")
...
#### top\_k `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.top_k "Copy anchor link to this section for reference")
...
#### top\_p `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaEmbeddings.top_p "Copy anchor link to this section for reference")
...
#### embed\_documents [¶](#langchain_ollama.OllamaEmbeddings.embed_documents "Copy anchor link to this section for reference")
...
#### embed\_query [¶](#langchain_ollama.OllamaEmbeddings.embed_query "Copy anchor link to this section for reference")
...
#### aembed\_documents `async` [¶](#langchain_ollama.OllamaEmbeddings.aembed_documents "Copy anchor link to this section for reference")
...
#### aembed\_query `async` [¶](#langchain_ollama.OllamaEmbeddings.aembed_query "Copy anchor link to this section for reference")
...
### OllamaLLM [¶](#langchain_ollama.OllamaLLM "Copy anchor link to this section for reference")
...
#### name `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.name "Copy anchor link to this section for reference")
...
#### InputType `property` [¶](#langchain_ollama.OllamaLLM.InputType "Copy anchor link to this section for reference")
...
#### OutputType `property` [¶](#langchain_ollama.OllamaLLM.OutputType "Copy anchor link to this section for reference")
...
#### input\_schema `property` [¶](#langchain_ollama.OllamaLLM.input_schema "Copy anchor link to this section for reference")
...
#### output\_schema `property` [¶](#langchain_ollama.OllamaLLM.output_schema "Copy anchor link to this section for reference")
...
#### config\_specs `property` [¶](#langchain_ollama.OllamaLLM.config_specs "Copy anchor link to this section for reference")
...
#### lc\_secrets `property` [¶](#langchain_ollama.OllamaLLM.lc_secrets "Copy anchor link to this section for reference")
...
#### lc\_attributes `property` [¶](#langchain_ollama.OllamaLLM.lc_attributes "Copy anchor link to this section for reference")
...
#### cache `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.cache "Copy anchor link to this section for reference")
...
#### verbose `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.verbose "Copy anchor link to this section for reference")
...
#### callbacks `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.callbacks "Copy anchor link to this section for reference")
...
#### tags `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.tags "Copy anchor link to this section for reference")
...
#### metadata `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.metadata "Copy anchor link to this section for reference")
...
#### custom\_get\_token\_ids `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.custom_get_token_ids "Copy anchor link to this section for reference")
...
#### model `instance-attribute` [¶](#langchain_ollama.OllamaLLM.model "Copy anchor link to this section for reference")
...
#### reasoning `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.reasoning "Copy anchor link to this section for reference")
...
#### validate\_model\_on\_init `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.validate_model_on_init "Copy anchor link to this section for reference")
...
#### mirostat `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.mirostat "Copy anchor link to this section for reference")
...
#### mirostat\_eta `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.mirostat_eta "Copy anchor link to this section for reference")
...
#### mirostat\_tau `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.mirostat_tau "Copy anchor link to this section for reference")
...
#### num\_ctx `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.num_ctx "Copy anchor link to this section for reference")
...
#### num\_gpu `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.num_gpu "Copy anchor link to this section for reference")
...
#### num\_thread `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.num_thread "Copy anchor link to this section for reference")
...
#### num\_predict `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.num_predict "Copy anchor link to this section for reference")
...
#### repeat\_last\_n `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.repeat_last_n "Copy anchor link to this section for reference")
...
#### repeat\_penalty `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.repeat_penalty "Copy anchor link to this section for reference")
...
#### temperature `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.temperature "Copy anchor link to this section for reference")
...
#### seed `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.seed "Copy anchor link to this section for reference")
...
#### stop `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.stop "Copy anchor link to this section for reference")
...
#### tfs\_z `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.tfs_z "Copy anchor link to this section for reference")
...
#### top\_k `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.top_k "Copy anchor link to this section for reference")
...
#### top\_p `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.top_p "Copy anchor link to this section for reference")
...
#### format `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.format "Copy anchor link to this section for reference")
...
#### keep\_alive `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.keep_alive "Copy anchor link to this section for reference")
...
#### base\_url `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.base_url "Copy anchor link to this section for reference")
...
#### client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.client_kwargs "Copy anchor link to this section for reference")
...
#### async\_client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.async_client_kwargs "Copy anchor link to this section for reference")
...
#### sync\_client\_kwargs `class-attribute` `instance-attribute` [¶](#langchain_ollama.OllamaLLM.sync_client_kwargs "Copy anchor link to this section for reference")
...
#### get\_name [¶](#langchain_ollama.OllamaLLM.get_name "Copy anchor link to this section for reference")
...
#### get\_input\_schema [¶](#langchain_ollama.OllamaLLM.get_input_schema "Copy anchor link to this section for reference")
...
#### get\_input\_jsonschema [¶](#langchain_ollama.OllamaLLM.get_input_jsonschema "Copy anchor link to this section for reference")
...
#### get\_output\_schema [¶](#langchain_ollama.OllamaLLM.get_output_schema "Copy anchor link to this section for reference")
...
#### get\_output\_jsonschema [¶](#langchain_ollama.OllamaLLM.get_output_jsonschema "Copy anchor link to this section for reference")
...
#### config\_schema [¶](#langchain_ollama.OllamaLLM.config_schema "Copy anchor link to this section for reference")
...
#### get\_config\_jsonschema [¶](#langchain_ollama.OllamaLLM.get_config_jsonschema "Copy anchor link to this section for reference")
...
#### get\_graph [¶](#langchain_ollama.OllamaLLM.get_graph "Copy anchor link to this section for reference")
...
#### get\_prompts [¶](#langchain_ollama.OllamaLLM.get_prompts "Copy anchor link to this section for reference")
...
#### \_\_or\_\_ [¶](#langchain_ollama.OllamaLLM.__or__ "Copy anchor link to this section for reference")
...
#### \_\_ror\_\_ [¶](#langchain_ollama.OllamaLLM.__ror__ "Copy anchor link to this section for reference")
...
#### pipe [¶](#langchain_ollama.OllamaLLM.pipe "Copy anchor link to this section for reference")
...
#### pick [¶](#langchain_ollama.OllamaLLM.pick "Copy anchor link to this section for reference")
...
#### assign [¶](#langchain_ollama.OllamaLLM.assign "Copy anchor link to this section for reference")
...
#### invoke [¶](#langchain_ollama.OllamaLLM.invoke "Copy anchor link to this section for reference")
...
#### ainvoke `async` [¶](#langchain_ollama.OllamaLLM.ainvoke "Copy anchor link to this section for reference")
...
#### batch [¶](#langchain_ollama.OllamaLLM.batch "Copy anchor link to this section for reference")
...
#### batch\_as\_completed [¶](#langchain_ollama.OllamaLLM.batch_as_completed "Copy anchor link to this section for reference")
...
#### abatch `async` [¶](#langchain_ollama.OllamaLLM.abatch "Copy anchor link to this section for reference")
...
#### abatch\_as\_completed `async` [¶](#langchain_ollama.OllamaLLM.abatch_as_completed "Copy anchor link to this section for reference")
...
#### stream [¶](#langchain_ollama.OllamaLLM.stream "Copy anchor link to this section for reference")
...
#### astream `async` [¶](#langchain_ollama.OllamaLLM.astream "Copy anchor link to this section for reference")
...
#### astream\_log `async` [¶](#langchain_ollama.OllamaLLM.astream_log "Copy anchor link to this section for reference")
...
#### astream\_events `async` [¶](#langchain_ollama.OllamaLLM.astream_events "Copy anchor link to this section for reference")
...
#### transform [¶](#langchain_ollama.OllamaLLM.transform "Copy anchor link to this section for reference")
...
#### atransform `async` [¶](#langchain_ollama.OllamaLLM.atransform "Copy anchor link to this section for reference")
...
#### bind [¶](#langchain_ollama.OllamaLLM.bind "Copy anchor link to this section for reference")
...
#### with\_config [¶](#langchain_ollama.OllamaLLM.with_config "Copy anchor link to this section for reference")
...
#### with\_listeners [¶](#langchain_ollama.OllamaLLM.with_listeners "Copy anchor link to this section for reference")
...
#### with\_alisteners [¶](#langchain_ollama.OllamaLLM.with_alisteners "Copy anchor link to this section for reference")
...
#### with\_types [¶](#langchain_ollama.OllamaLLM.with_types "Copy anchor link to this section for reference")
...
#### with\_retry [¶](#langchain_ollama.OllamaLLM.with_retry "Copy anchor link to this section for reference")
...
#### map [¶](#langchain_ollama.OllamaLLM.map "Copy anchor link to this section for reference")
...
#### with\_fallbacks [¶](#langchain_ollama.OllamaLLM.with_fallbacks "Copy anchor link to this section for reference")
...
#### as\_tool [¶](#langchain_ollama.OllamaLLM.as_tool "Copy anchor link to this section for reference")
...
#### \_\_init\_\_ [¶](#langchain_ollama.OllamaLLM.__init__ "Copy anchor link to this section for reference")

```
__init__(*args: Any, **kwargs: Any) -> None
```

#### is\_lc\_serializable `classmethod` [¶](#langchain_ollama.OllamaLLM.is_lc_serializable "Copy anchor link to this section for reference")
...
#### get\_lc\_namespace `classmethod` [¶](#langchain_ollama.OllamaLLM.get_lc_namespace "Copy anchor link to this section for reference")
...
#### lc\_id `classmethod` [¶](#langchain_ollama.OllamaLLM.lc_id "Copy anchor link to this section for reference")
...
#### to\_json [¶](#langchain_ollama.OllamaLLM.to_json "Copy anchor link to this section for reference")
...
#### to\_json\_not\_implemented [¶](#langchain_ollama.OllamaLLM.to_json_not_implemented "Copy anchor link to this section for reference")
...
#### configurable\_fields [¶](#langchain_ollama.OllamaLLM.configurable_fields "Copy anchor link to this section for reference")
...
#### configurable\_alternatives [¶](#langchain_ollama.OllamaLLM.configurable_alternatives "Copy anchor link to this section for reference")
...
#### set\_verbose [¶](#langchain_ollama.OllamaLLM.set_verbose "Copy anchor link to this section for reference")
...
#### generate\_prompt [¶](#langchain_ollama.OllamaLLM.generate_prompt "Copy anchor link to this section for reference")
...
#### agenerate\_prompt `async` [¶](#langchain_ollama.OllamaLLM.agenerate_prompt "Copy anchor link to this section for reference")
...
#### with\_structured\_output [¶](#langchain_ollama.OllamaLLM.with_structured_output "Copy anchor link to this section for reference")
...
#### get\_token\_ids [¶](#langchain_ollama.OllamaLLM.get_token_ids "Copy anchor link to this section for reference")
...
#### get\_num\_tokens [¶](#langchain_ollama.OllamaLLM.get_num_tokens "Copy anchor link to this section for reference")
...
#### get\_num\_tokens\_from\_messages [¶](#langchain_ollama.OllamaLLM.get_num_tokens_from_messages "Copy anchor link to this section for reference")
...
#### generate [¶](#langchain_ollama.OllamaLLM.generate "Copy anchor link to this section for reference")
...
#### agenerate `async` [¶](#langchain_ollama.OllamaLLM.agenerate "Copy anchor link to this section for reference")
...
#### \_\_str\_\_ [¶](#langchain_ollama.OllamaLLM.__str__ "Copy anchor link to this section for reference")
...
#### dict [¶](#langchain_ollama.OllamaLLM.dict "Copy anchor link to this section for reference")
...
#### save [¶](#langchain_ollama.OllamaLLM.save "Copy anchor link to this section for reference")
