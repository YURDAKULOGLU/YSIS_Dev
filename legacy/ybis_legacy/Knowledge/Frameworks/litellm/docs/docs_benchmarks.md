...
See [Production Configuration](/docs/proxy/prod) for detailed best practices.
...
* [2 Instance LiteLLM Proxy](#2-instance-litellm-proxy)
* [4 Instances](#4-instances)
* [Machine Spec used for testing](#machine-spec-used-for-testing)
* [Configuration](#configuration)
* [Infrastructure Recommendations](#infrastructure-recommendations)
  + [PostgreSQL](#postgresql)
  + [Redis (Recommended)](#redis-recommended)
* [Locust Settings](#locust-settings)
* [How to measure LiteLLM Overhead](#how-to-measure-litellm-overhead)
* [LiteLLM vs Portkey Performance Comparison](#litellm-vs-portkey-performance-comparison)
  + [Multi-Instance (4×) Performance](#multi-instance-4-performance)
  + [Technical Insights](#technical-insights)
* [Logging Callbacks](#logging-callbacks)
  + [GCS Bucket Logging](#gcs-bucket-logging)
  + [LangSmith logging](#langsmith-logging)