...
## Checking if a model supports function calling[​](#checking-if-a-model-supports-function-calling "Direct link to Checking if a model supports function calling")
...
## Checking if a model supports parallel function calling[​](#checking-if-a-model-supports-parallel-function-calling "Direct link to Checking if a model supports parallel function calling")
...
## Quick Start - gpt-3.5-turbo-1106[​](#quick-start---gpt-35-turbo-1106 "Direct link to Quick Start - gpt-3.5-turbo-1106")
...
### Full Code - Parallel function calling with `gpt-3.5-turbo-1106`[​](#full-code---parallel-function-calling-with-gpt-35-turbo-1106 "Direct link to full-code---parallel-function-calling-with-gpt-35-turbo-1106")
...
### Explanation - Parallel function calling[​](#explanation---parallel-function-calling "Direct link to Explanation - Parallel function calling")
...
### Step1: litellm.completion() with `tools` set to `get_current_weather`[​](#step1-litellmcompletion-with-tools-set-to-get_current_weather "Direct link to step1-litellmcompletion-with-tools-set-to-get_current_weather")
...
### Step 2 - Parse the Model Response and Execute Functions[​](#step-2----parse-the-model-response-and-execute-functions "Direct link to Step 2 - Parse the Model Response and Execute Functions")
...
### Step 3 - Second litellm.completion() call[​](#step-3---second-litellmcompletion-call "Direct link to Step 3 - Second litellm.completion() call")
...
#### Expected output[​](#expected-output-1 "Direct link to Expected output")
...
## Parallel Function Calling - Azure OpenAI[​](#parallel-function-calling---azure-openai "Direct link to Parallel Function Calling - Azure OpenAI")
...
## Deprecated - Function Calling with `completion(functions=functions)`[​](#deprecated---function-calling-with-completionfunctionsfunctions "Direct link to deprecated---function-calling-with-completionfunctionsfunctions")
...
## litellm.function\_to\_dict - Convert Functions to dictionary for OpenAI function calling[​](#litellmfunction_to_dict---convert-functions-to-dictionary-for-openai-function-calling "Direct link to litellm.function_to_dict - Convert Functions to dictionary for OpenAI function calling")

`function_to_dict` allows you to pass a function docstring and produce a dictionary usable for OpenAI function calling

### Using `function_to_dict`[​](#using-function_to_dict "Direct link to using-function_to_dict")
...
#### Output from function\_to\_dict[​](#output-from-function_to_dict "Direct link to Output from function_to_dict")
...
### Using function\_to\_dict with Function calling[​](#using-function_to_dict-with-function-calling "Direct link to Using function_to_dict with Function calling")
...
## Function calling for Models w/out function-calling support[​](#function-calling-for-models-wout-function-calling-support "Direct link to Function calling for Models w/out function-calling support")

### Adding Function to prompt[​](#adding-function-to-prompt "Direct link to Adding Function to prompt")
...
* [Checking if a model supports function calling](#checking-if-a-model-supports-function-calling)
* [Checking if a model supports parallel function calling](#checking-if-a-model-supports-parallel-function-calling)
* [Parallel Function calling](#parallel-function-calling)
* [Quick Start - gpt-3.5-turbo-1106](#quick-start---gpt-35-turbo-1106)
  + [Full Code - Parallel function calling with `gpt-3.5-turbo-1106`](#full-code---parallel-function-calling-with-gpt-35-turbo-1106)
  + [Explanation - Parallel function calling](#explanation---parallel-function-calling)
  + [Step1: litellm.completion() with `tools` set to `get_current_weather`](#step1-litellmcompletion-with-tools-set-to-get_current_weather)
  + [Step 2 - Parse the Model Response and Execute Functions](#step-2----parse-the-model-response-and-execute-functions)
  + [Step 3 - Second litellm.completion() call](#step-3---second-litellmcompletion-call)
* [Parallel Function Calling - Azure OpenAI](#parallel-function-calling---azure-openai)
* [Deprecated - Function Calling with `completion(functions=functions)`](#deprecated---function-calling-with-completionfunctionsfunctions)
* [litellm.function\_to\_dict - Convert Functions to dictionary for OpenAI function calling](#litellmfunction_to_dict---convert-functions-to-dictionary-for-openai-function-calling)
  + [Using `function_to_dict`](#using-function_to_dict)
  + [Using function\_to\_dict with Function calling](#using-function_to_dict-with-function-calling)
* [Function calling for Models w/out function-calling support](#function-calling-for-models-wout-function-calling-support)
