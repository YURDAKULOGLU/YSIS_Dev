...
* [LiteLLM Exceptions](#litellm-exceptions)
* [Usage](#usage)
* [Usage - Catching Streaming Exceptions](#usage---catching-streaming-exceptions)
* [Usage - Should you retry exception?](#usage---should-you-retry-exception)
* [Advanced](#advanced)
  + [Accessing Provider-Specific Error Details](#accessing-provider-specific-error-details)