...
![](/assets/ideal-img/mcp_2.3dfbc0f.640.png)
...
**See all available object types:** [Config Settings - supported\_db\_objects](/docs/proxy/config_settings#general_settings---reference)
...
![](/assets/ideal-img/add_mcp.f8b4944.640.png)
...
![](/assets/ideal-img/add_stdio_mcp.006f8b8.640.png)

  
  

### Static Headers[​](#static-headers "Direct link to Static Headers")
...
![](/assets/ideal-img/static_headers.e6c6986.640.png)
...
### MCP Walkthroughs[​](#mcp-walkthroughs "Direct link to MCP Walkthroughs")
...
### MCP Aliases[​](#mcp-aliases "Direct link to MCP Aliases")
...
Cursor MCP Configuration for OpenAPI Server
...
[**See Claude Code Tutorial**](/docs/tutorials/claude_responses_api#connecting-mcp-servers)
...
## Forwarding Custom Headers to MCP Servers[​](#forwarding-custom-headers-to-mcp-servers "Direct link to Forwarding Custom Headers to MCP Servers")
...
### Passing Request Headers to STDIO env Vars[​](#passing-request-headers-to-stdio-env-vars "Direct link to Passing Request Headers to STDIO env Vars")
...
### New Server-Specific Auth Headers (Recommended)[​](#new-server-specific-auth-headers-recommended "Direct link to New Server-Specific Auth Headers (Recommended)")
...
### Legacy Auth Header (Deprecated)[​](#legacy-auth-header-deprecated "Direct link to Legacy Auth Header (Deprecated)")
...
#### Connect via LiteLLM Proxy Responses API with Server-Specific Auth[​](#connect-via-litellm-proxy-responses-api-with-server-specific-auth "Direct link to Connect via LiteLLM Proxy Responses API with Server-Specific Auth")
...
#### Connect via LiteLLM Proxy Responses API with Legacy Auth[​](#connect-via-litellm-proxy-responses-api-with-legacy-auth "Direct link to Connect via LiteLLM Proxy Responses API with Legacy Auth")
...
#### Connect via Cursor IDE with Server-Specific Auth[​](#connect-via-cursor-ide-with-server-specific-auth "Direct link to Connect via Cursor IDE with Server-Specific Auth")
...
#### Connect via Cursor IDE with Legacy Auth[​](#connect-via-cursor-ide-with-legacy-auth "Direct link to Connect via Cursor IDE with Legacy Auth")
...
#### Connect via Streamable HTTP Transport with Server-Specific Auth[​](#connect-via-streamable-http-transport-with-server-specific-auth "Direct link to Connect via Streamable HTTP Transport with Server-Specific Auth")
...
#### Connect via Streamable HTTP Transport with Legacy Auth[​](#connect-via-streamable-http-transport-with-legacy-auth "Direct link to Connect via Streamable HTTP Transport with Legacy Auth")
...
#### Connect via Python FastMCP Client with Server-Specific Auth[​](#connect-via-python-fastmcp-client-with-server-specific-auth "Direct link to Connect via Python FastMCP Client with Server-Specific Auth")
...
#### Connect via Python FastMCP Client with Legacy Auth[​](#connect-via-python-fastmcp-client-with-legacy-auth "Direct link to Connect via Python FastMCP Client with Legacy Auth")
...
### Customize the MCP Auth Header Name[​](#customize-the-mcp-auth-header-name "Direct link to Customize the MCP Auth Header Name")
...
#### Using the authorization header[​](#using-the-authorization-header "Direct link to Using the authorization header")
...
## Use MCP tools with `/chat/completions`[​](#use-mcp-tools-with-chatcompletions "Direct link to use-mcp-tools-with-chatcompletions")
...
* [Adding your MCP](#adding-your-mcp)
  ...
  + [Add HTTP MCP Server](#add-http-mcp-server)
  + [Add SSE MCP Server](#add-sse-mcp-server)
  + [Add STDIO MCP Server](#add-stdio-mcp-server)
  + [Static Headers](#static-headers)
  + [MCP Walkthroughs](#mcp-walkthroughs)
  + [MCP Aliases](#mcp-aliases)
* [Converting OpenAPI Specs to MCP Servers](#converting-openapi-specs-to-mcp-servers)
  + [Usage Example](#usage-example)
* [MCP Oauth](#mcp-oauth)
  + [How It Works](#how-it-works)
* [Forwarding Custom Headers to MCP Servers](#forwarding-custom-headers-to-mcp-servers)
  + [Passing Request Headers to STDIO env Vars](#passing-request-headers-to-stdio-env-vars)
* [Using your MCP with client side credentials](#using-your-mcp-with-client-side-credentials)
  + [New Server-Specific Auth Headers (Recommended)](#new-server-specific-auth-headers-recommended)
  + [Legacy Auth Header (Deprecated)](#legacy-auth-header-deprecated)
  + [Customize the MCP Auth Header Name](#customize-the-mcp-auth-header-name)
* [Use MCP tools with `/chat/completions`](#use-mcp-tools-with-chatcompletions)
* [LiteLLM Proxy - Walk through MCP Gateway](#litellm-proxy---walk-through-mcp-gateway)
* [LiteLLM Python SDK MCP Bridge](#litellm-python-sdk-mcp-bridge)
  + [1. List Available MCP Tools](#1-list-available-mcp-tools)
  + [2. List and Call MCP Tools](#2-list-and-call-mcp-tools)