...
### Supported Callback Integrations[​](#supported-callback-integrations "Direct link to Supported Callback Integrations")
...
### Related Cookbooks[​](#related-cookbooks "Direct link to Related Cookbooks")
...
* [Use Callbacks to send Output Data to Posthog, Sentry etc](#use-callbacks-to-send-output-data-to-posthog-sentry-etc)
  + [Supported Callback Integrations](#supported-callback-integrations)
  + [Related Cookbooks](#related-cookbooks)
