...
* [Common Hooks](#common-hooks)
  + [Example: Modifying the Response in async\_post\_call\_success\_hook](#example-modifying-the-response-in-async_post_call_success_hook)
* [Callback Functions](#callback-functions)
* [Defining a Custom Callback Function](#defining-a-custom-callback-function)
  + [Setting the custom callback function](#setting-the-custom-callback-function)
* [Using Your Custom Callback Function](#using-your-custom-callback-function)
* [Async Callback Functions](#async-callback-functions)
* [What's Available in kwargs?](#whats-available-in-kwargs)
* [Practical Examples](#practical-examples)
  + [Track API Costs](#track-api-costs)
  + [Log Inputs to LLMs](#log-inputs-to-llms)
  + [Send to External Service](#send-to-external-service)
* [Common Issues](#common-issues)
  + [Callback Not Called](#callback-not-called)
