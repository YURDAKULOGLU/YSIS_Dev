...
![](/assets/ideal-img/mlflow_tracing.5e78520.640.png)
...
## Tracing Tool Calls[​](#tracing-tool-calls "Direct link to Tracing Tool Calls")
...
![](/assets/ideal-img/mlflow_tool_calling_tracing.5ceefa1.640.png)
...
* [Tracing Tool Calls](#tracing-tool-calls)
* [Evaluation](#evaluation)
* [Exporting Traces to OpenTelemetry collectors](#exporting-traces-to-opentelemetry-collectors)
* [Combine LiteLLM Trace with Your Application Trace](#combine-litellm-trace-with-your-application-trace)
* [LiteLLM Proxy Server](#litellm-proxy-server)
  + [Dependencies](#dependencies)
  + [Configuration](#configuration)
  + [Environment Variables](#environment-variables)
  + [Adding Tags for Better Tracing](#adding-tags-for-better-tracing)
* [Support](#support)