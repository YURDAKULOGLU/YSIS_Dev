...
**[model\_prices\_and\_context\_window.json](https://github.com/BerriAI/litellm/blob/main/model_prices_and_context_window.json)**

### Sample Spec[​](#sample-spec "Direct link to Sample Spec")
...
#### Vertex AI Gemini[​](#vertex-ai-gemini "Direct link to Vertex AI Gemini")
