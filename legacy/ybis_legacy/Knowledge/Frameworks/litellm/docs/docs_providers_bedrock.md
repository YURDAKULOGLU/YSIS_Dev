...
| Provider Route on LiteLLM | `bedrock/`, [`bedrock/converse/`](#set-converse--invoke-route), [`bedrock/invoke/`](#set-invoke-route), [`bedrock/converse_like/`](#calling-via-internal-proxy), [`bedrock/llama/`](#deepseek-not-r1), [`bedrock/deepseek_r1/`](#deepseek-r1), [`bedrock/qwen3/`](#qwen3-imported-models), [`bedrock/qwen2/`](/docs/providers/bedrock_imported#qwen2-imported-models), [`bedrock/openai/`](/docs/providers/bedrock_imported#openai-compatible-imported-models-qwen-25-vl-etc) |
...
## Usage - Request Metadata[​](#usage---request-metadata "Direct link to Usage - Request Metadata")
...
## Usage - Function Calling / Tool calling[​](#usage---function-calling--tool-calling "Direct link to Usage - Function Calling / Tool calling")
...
| TwelveLabs Pegasus 1.2 (US) | `completion(model='bedrock/us.twelvelabs.pegasus-1-2-v1:0', messages=messages, mediaSource={...})` |
| TwelveLabs Pegasus 1.2 (EU) | `completion(model='bedrock/eu.twelvelabs.pegasus-1-2-v1:0', messages=messages, mediaSource={...})` |
...
See [Bedrock Image Generation](/docs/providers/bedrock_image_gen) for using Stable Diffusion and Amazon Nova Canvas models on Bedrock.

## Rerank API[​](#rerank-api "Direct link to Rerank API")

See [Bedrock Rerank](/docs/providers/bedrock_rerank) for using Bedrock's Rerank API in the Cohere `/rerank` format.
...
### Passing extra headers + Custom API Endpoints[​](#passing-extra-headers--custom-api-endpoints "Direct link to Passing extra headers + Custom API Endpoints")
...
* [Usage - Request Metadata](#usage---request-metadata)
* [Usage - Function Calling / Tool calling](#usage---function-calling--tool-calling)
* [Usage - Vision](#usage---vision)
* [Usage - 'thinking' / 'reasoning content'](#usage---thinking--reasoning-content)
  + [Pass `thinking` to Anthropic models](#pass-thinking-to-anthropic-models)
* [Usage - Anthropic Beta Features](#usage---anthropic-beta-features)
  + [Supported Beta Features](#supported-beta-features)
* [Usage - Structured Output / JSON mode](#usage---structured-output--json-mode)
* [Usage - Latency Optimized Inference](#usage---latency-optimized-inference)
* [Usage - Service Tier](#usage---service-tier)
* [Usage - Bedrock Guardrails](#usage---bedrock-guardrails)
  + [Selective Content Moderation with `guarded_text`](#selective-content-moderation-with-guarded_text)
* [Usage - "Assistant Pre-fill"](#usage---assistant-pre-fill)
  + [Example prompt sent to Claude](#example-prompt-sent-to-claude)
* [Usage - "System" messages](#usage---system-messages)
  + [Example prompt sent to Claude](#example-prompt-sent-to-claude-1)
* [Usage - Streaming](#usage---streaming)
* [Cross-region inferencing](#cross-region-inferencing)
* [Set 'converse' / 'invoke' route](#set-converse--invoke-route)
* [Alternate user/assistant messages](#alternate-userassistant-messages)
* [Usage - PDF / Document Understanding](#usage---pdf--document-understanding)
  + [url](#url)
  + [base64](#base64)
  + [OpenAI GPT OSS](#openai-gpt-oss)
* [TwelveLabs Pegasus - Video Understanding](#twelvelabs-pegasus---video-understanding)
  + [Supported Features](#supported-features)
  + [Usage with S3 Video](#usage-with-s3-video)
  + [Usage with Base64 Video](#usage-with-base64-video)
...
* [Bedrock Embedding](#bedrock-embedding)
  + [API keys](#api-keys)
  + [Usage](#usage-1)
* [Supported AWS Bedrock Embedding Models](#supported-aws-bedrock-embedding-models)
  + [Advanced - Drop Unsupported Params](#advanced---drop-unsupported-params)
  + [Advanced - Pass model/provider-specific Params](#advanced---pass-modelprovider-specific-params)
* [Image Generation](#image-generation)
* [Rerank API](#rerank-api)
* [Bedrock Application Inference Profile](#bedrock-application-inference-profile)
  + [Set via `model_id`](#set-via-model_id)
* [Boto3 - Authentication](#boto3---authentication)
  + [Passing credentials as parameters - Completion()](#passing-credentials-as-parameters---completion)
  + [Passing extra headers + Custom API Endpoints](#passing-extra-headers--custom-api-endpoints)
  + [SSO Login (AWS Profile)](#sso-login-aws-profile)
  + [STS (Role-based Auth)](#sts-role-based-auth)
  + [Required AWS IAM Policy for AssumeRole](#required-aws-iam-policy-for-assumerole)
  + [Passing an external BedrockRuntime.Client as a parameter - Completion()](#passing-an-external-bedrockruntimeclient-as-a-parameter---completion)
* [Calling via Internal Proxy (not bedrock url compatible)](#calling-via-internal-proxy-not-bedrock-url-compatible)