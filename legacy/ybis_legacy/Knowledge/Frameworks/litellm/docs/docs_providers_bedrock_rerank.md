...
### 2. Start proxy server[​](#2-start-proxy-server "Direct link to 2. Start proxy server")
...
All standard Bedrock authentication methods are supported for rerank. See [Bedrock Authentication](/docs/providers/bedrock#boto3---authentication) for details.

* [Supported Parameters](#supported-parameters)
* [Usage](#usage)
  + [1. Setup config.yaml](#1-setup-configyaml)
  + [2. Start proxy server](#2-start-proxy-server)
  + [3. Test it!](#3-test-it)
