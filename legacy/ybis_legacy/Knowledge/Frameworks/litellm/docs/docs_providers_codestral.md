...
#### Expected Response[​](#expected-response-1 "Direct link to Expected Response")
...
#### Sample Usage - Streaming[​](#sample-usage---streaming-1 "Direct link to Sample Usage - Streaming")
...
#### Expected Response[​](#expected-response-3 "Direct link to Expected Response")
...
* [API Key](#api-key)
* [FIM / Completions](#fim--completions)
