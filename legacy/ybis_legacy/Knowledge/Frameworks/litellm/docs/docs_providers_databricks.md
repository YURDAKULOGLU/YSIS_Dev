...
* [Authentication](#authentication)
  + [OAuth M2M (Recommended for Production)](#oauth-m2m-recommended-for-production)
  + [Personal Access Token (PAT)](#personal-access-token-pat)
  + [Databricks SDK Authentication (Automatic)](#databricks-sdk-authentication-automatic)
* [Custom User-Agent for Partner Attribution](#custom-user-agent-for-partner-attribution)
* [Security](#security)
* [Usage](#usage)
  + [ENV VAR](#env-var)
...
* [Embedding Models](#embedding-models)
  + [Passing Databricks specific params - 'instruction'](#passing-databricks-specific-params---instruction)
