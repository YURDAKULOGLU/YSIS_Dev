...
### 1. Set Github Models on config.yaml[​](#1-set-github-models-on-configyaml "Direct link to 1. Set Github Models on config.yaml")
...
## Supported Models - ALL Github Models Supported![​](#supported-models---all-github-models-supported "Direct link to Supported Models - ALL Github Models Supported!")
...
## Github - Tool / Function Calling Example[​](#github---tool--function-calling-example "Direct link to Github - Tool / Function Calling Example")
...
* [Usage with LiteLLM Proxy](#usage-with-litellm-proxy)
  + [1. Set Github Models on config.yaml](#1-set-github-models-on-configyaml)
  + [2. Start Proxy](#2-start-proxy)
  + [3. Test it](#3-test-it)
* [Supported Models - ALL Github Models Supported!](#supported-models---all-github-models-supported)
* [Github - Tool / Function Calling Example](#github---tool--function-calling-example)