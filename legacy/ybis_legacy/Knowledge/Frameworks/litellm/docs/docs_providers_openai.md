...
### Getting OpenAI API Response Headers[​](#getting-openai-api-response-headers "Direct link to Getting OpenAI API Response Headers")
...
### Setting `extra_headers` for completion calls[​](#setting-extra_headers-for-completion-calls "Direct link to setting-extra_headers-for-completion-calls")
...
For detailed documentation on video generation, see [OpenAI Video Generation →](/docs/providers/openai/video_generation.md)
...
* [PDF File Parsing](#pdf-file-parsing)
* [OpenAI Fine Tuned Models](#openai-fine-tuned-models)
* [Getting Reasoning Content in `/chat/completions`](#getting-reasoning-content-in-chatcompletions)
  + [Advanced: Using `reasoning_effort` with `summary` field](#advanced-using-reasoning_effort-with-summary-field)
  + [Verbosity Control for GPT-5 Models](#verbosity-control-for-gpt-5-models)
* [OpenAI Chat Completion to Responses API Bridge](#openai-chat-completion-to-responses-api-bridge)
* [OpenAI Audio Transcription](#openai-audio-transcription)
* [Advanced](#advanced)
  ...
  + [Setting `extra_headers` for completion calls](#setting-extra_headers-for-completion-calls)
  + [Setting Organization-ID for completion calls](#setting-organization-id-for-completion-calls)
  + [Set `ssl_verify=False`](#set-ssl_verifyfalse)
  + [Using OpenAI Proxy with LiteLLM](#using-openai-proxy-with-litellm)
  + [Forwarding Org ID for Proxy requests](#forwarding-org-id-for-proxy-requests)
* [GPT-5 Pro Special Notes](#gpt-5-pro-special-notes)
