...
Use Vertex AI context caching in the same way as [**Google AI Studio - Context Caching**](/docs/providers/gemini#context-caching)
...
| `input_type` | **Literal["RETRIEVAL\_QUERY","RETRIEVAL\_DOCUMENT", "SEMANTIC\_SIMILARITY", "CLASSIFICATION", "CLUSTERING", "QUESTION\_ANSWERING", "FACT\_VERIFICATION"]** | `task_type` |
...
| --- | --- |
| `auto_truncate` | **bool** |
| `task_type` | **Literal["RETRIEVAL\_QUERY","RETRIEVAL\_DOCUMENT", "SEMANTIC\_SIMILARITY", "CLASSIFICATION", "CLUSTERING", "QUESTION\_ANSWERING", "FACT\_VERIFICATION"]** |
| `title` | **str** |
...
## Extra[​](#extra "Direct link to Extra")
...
![](/assets/ideal-img/gcp_acc_1.4549bf5.640.png)
...
![](/assets/ideal-img/gcp_acc_2.91788ff.640.png)

4. Specify the Service Account as the principal and Vertex AI User as the role

![](/assets/ideal-img/gcp_acc_3.c247d08.640.png)
...
* [Overview](#overview)
* [`vertex_ai/` route](#vertex_ai-route)
  + [**System Message**](#system-message)
  + [**Function Calling**](#function-calling)
  + [**JSON Schema**](#json-schema)
  + [**Google Hosted Tools (Web Search, Code Execution, etc.)**](#google-hosted-tools-web-search-code-execution-etc)
...
* [Authentication - vertex\_project, vertex\_location, etc.](#authentication---vertex_project-vertex_location-etc)
  + [**Dynamic Params**](#dynamic-params)
  + [**Environment Variables**](#environment-variables)
* [Specifying Safety Settings](#specifying-safety-settings)
  + [Set per model/request](#set-per-modelrequest)
  + [Set Globally](#set-globally)
* [Set Vertex Project & Vertex Location](#set-vertex-project--vertex-location)
* [Gemini Pro](#gemini-pro)
* [Private Service Connect (PSC) Endpoints](#private-service-connect-psc-endpoints)
  + [Usage](#usage)
  + [Configuration](#configuration)
* [Fine-tuned Models](#fine-tuned-models)
* [Gemini Pro Vision](#gemini-pro-vision)
* [Gemini 1.5 Pro (and Vision)](#gemini-15-pro-and-vision)
* [Usage - Function Calling](#usage---function-calling)
* [Usage - PDF / Videos / Audio etc. Files](#usage---pdf--videos--audio-etc-files)
  + [**Using `gs://` or any URL**](#using-gs-or-any-url)
  + [**using base64**](#using-base64)
* [Chat Models](#chat-models)
* [Code Chat Models](#code-chat-models)
* [Text Models](#text-models)
* [Code Text Models](#code-text-models)
* [**Embedding Models**](#embedding-models)
  + [Supported OpenAI (Unified) Params](#supported-openai-unified-params)
  + [Supported Vertex Specific Params](#supported-vertex-specific-params)
* [**Multi-Modal Embeddings**](#multi-modal-embeddings)
  + [Usage](#usage-1)
  + [Text + Image + Video Embeddings](#text--image--video-embeddings)
