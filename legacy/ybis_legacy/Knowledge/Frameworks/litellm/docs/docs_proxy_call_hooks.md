...
**Understanding Callback Hooks?** Check out our [Callback Management Guide](/docs/observability/callback_management.md) to understand the differences between proxy-specific hooks like `async_pre_call_hook` and general logging hooks like `async_log_success_event`.

## Which Hook Should I Use?[​](#which-hook-should-i-use "Direct link to Which Hook Should I Use?")
...
## [BETA] *NEW* async\_moderation\_hook[​](#beta-new-async_moderation_hook "Direct link to beta-new-async_moderation_hook")
...
We might need to update the function schema in the future, to support multiple endpoints (e.g. accept a call\_type). Please keep that in mind, while trying this feature
...
## Advanced - Enforce 'user' param[​](#advanced---enforce-user-param "Direct link to Advanced - Enforce 'user' param")
...
![](/assets/ideal-img/end_user_enforcement.d48fc0c.640.png)

## Advanced - Return rejected message as response[​](#advanced---return-rejected-message-as-response "Direct link to Advanced - Return rejected message as response")
...
### 1. Create Custom Handler[​](#1-create-custom-handler "Direct link to 1. Create Custom Handler")
...
### 2. Update config.yaml[​](#2-update-configyaml "Direct link to 2. Update config.yaml")
...
## Advanced - Transform Error Responses[​](#advanced---transform-error-responses "Direct link to Advanced - Transform Error Responses")
...
* [Which Hook Should I Use?](#which-hook-should-i-use)
* [Quick Start](#quick-start)
* [[BETA] *NEW* async\_moderation\_hook](#beta-new-async_moderation_hook)
* [Advanced - Enforce 'user' param](#advanced---enforce-user-param)
* [Advanced - Return rejected message as response](#advanced---return-rejected-message-as-response)
  + [1. Create Custom Handler](#1-create-custom-handler)
  + [2. Update config.yaml](#2-update-configyaml)
  + [3. Test it!](#3-test-it)
* [Advanced - Transform Error Responses](#advanced---transform-error-responses)