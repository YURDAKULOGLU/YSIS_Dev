...
[Sync model pricing data from GitHub](/docs/proxy/sync_models_github) to ensure accurate cost tracking.
...
![](/assets/ideal-img/response_cost_img.b16fcc8.640.png)
...
![](/assets/ideal-img/admin_ui_spend.44da2bc.640.png)
...
This means if you need to track user spend, and are giving end users API keys, you must always set user\_id when creating their api keys, and use keys issued for that user every time you're making LLM calls on their behalf in backend services. This will track their spend.
...
![](/assets/ideal-img/claude_cli_tag_usage.590a53b.640.png)
...
### Add custom headers to spend tracking[​](#add-custom-headers-to-spend-tracking "Direct link to Add custom headers to spend tracking")
...
## ✨ Custom Spend Log metadata[​](#-custom-spend-log-metadata "Direct link to ✨ Custom Spend Log metadata")
...
* [Total spend per user](#total-spend-per-user)
* [Daily Spend Breakdown API](#daily-spend-breakdown-api)
  + [API Reference](#api-reference)
* [Custom Tags](#custom-tags)
  + [Client-side spend tag](#client-side-spend-tag)
  + [Add custom headers to spend tracking](#add-custom-headers-to-spend-tracking)
  + [Disable user-agent tracking](#disable-user-agent-tracking)
* [✨ (Enterprise) Generate Spend Reports](#-enterprise-generate-spend-reports)
* [📊 Spend Logs API - Individual Transaction Logs](#-spend-logs-api---individual-transaction-logs)
