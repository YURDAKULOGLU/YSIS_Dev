...
## 1. Add a model[​](#1-add-a-model "Direct link to 1. Add a model")
...
### Model List Specification[​](#model-list-specification "Direct link to Model List Specification")
...
## 2. Make a successful /chat/completion call[​](#2-make-a-successful-chatcompletion-call "Direct link to 2. Make a successful /chat/completion call")

LiteLLM Proxy is 100% OpenAI-compatible. Test your azure model via the `/chat/completions` route.

### 2.1 Start Proxy[​](#21-start-proxy "Direct link to 2.1 Start Proxy")
...
### 2.2 Make Call[​](#22-make-call "Direct link to 2.2 Make Call")
...
### Useful Links[​](#useful-links-1 "Direct link to Useful Links")
...
## 3. Generate a virtual key[​](#3-generate-a-virtual-key "Direct link to 3. Generate a virtual key")

Track Spend, and control model access via virtual keys for the proxy

### 3.1 Set up a Database[​](#31-set-up-a-database "Direct link to 3.1 Set up a Database")
...
### 3.2 Start Proxy[​](#32-start-proxy "Direct link to 3.2 Start Proxy")
...
### 3.3 Create Key w/ RPM Limit[​](#33-create-key-w-rpm-limit "Direct link to 3.3 Create Key w/ RPM Limit")
...
### 3.4 Test it![​](#34-test-it "Direct link to 3.4 Test it!")
...
### Useful Links[​](#useful-links-2 "Direct link to Useful Links")
...
### Understanding Model Configuration[​](#understanding-model-configuration "Direct link to Understanding Model Configuration")
...
* **`model` (in litellm\_params)**: Format is `<provider>/<model-identifier>`
...
### Non-root docker image?[​](#non-root-docker-image "Direct link to Non-root docker image?")
...
### SSL Verification Issue / Connection Error.[​](#ssl-verification-issue--connection-error "Direct link to SSL Verification Issue / Connection Error.")
...
### (DB) All connection attempts failed[​](#db-all-connection-attempts-failed "Direct link to (DB) All connection attempts failed")
...
* [1. Add a model](#1-add-a-model)
  + [Model List Specification](#model-list-specification)
  + [Useful Links](#useful-links)
* [2. Make a successful /chat/completion call](#2-make-a-successful-chatcompletion-call)
  + [2.1 Start Proxy](#21-start-proxy)
  + [2.2 Make Call](#22-make-call)
  + [Useful Links](#useful-links-1)
* [3. Generate a virtual key](#3-generate-a-virtual-key)
  + [3.1 Set up a Database](#31-set-up-a-database)
  + [3.2 Start Proxy](#32-start-proxy)
  + [3.3 Create Key w/ RPM Limit](#33-create-key-w-rpm-limit)
  + [3.4 Test it!](#34-test-it)
  + [Useful Links](#useful-links-2)
* [Key Concepts](#key-concepts)
  + [Understanding Model Configuration](#understanding-model-configuration)
* [Troubleshooting](#troubleshooting)
  + [Non-root docker image?](#non-root-docker-image)
  + [SSL Verification Issue / Connection Error.](#ssl-verification-issue--connection-error)
  + [(DB) All connection attempts failed](#db-all-connection-attempts-failed)
