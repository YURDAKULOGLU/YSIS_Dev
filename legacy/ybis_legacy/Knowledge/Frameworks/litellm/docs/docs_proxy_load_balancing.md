...
## How Load Balancing Works[​](#how-load-balancing-works "Direct link to How Load Balancing Works")
...
## Quick Start - Load Balancing[​](#quick-start---load-balancing "Direct link to Quick Start - Load Balancing")

#### Step 1 - Set deployments on config[​](#step-1---set-deployments-on-config "Direct link to Step 1 - Set deployments on config")
...
### Test - Simple Call[​](#test---simple-call "Direct link to Test - Simple Call")
...
### Test - Loadbalancing[​](#test---loadbalancing "Direct link to Test - Loadbalancing")
...
## Load Balancing using multiple litellm instances (Kubernetes, Auto Scaling)[​](#load-balancing-using-multiple-litellm-instances-kubernetes-auto-scaling "Direct link to Load Balancing using multiple litellm instances (Kubernetes, Auto Scaling)")
...
## Router settings on config - routing\_strategy, model\_group\_alias[​](#router-settings-on-config---routing_strategy-model_group_alias "Direct link to Router settings on config - routing_strategy, model_group_alias")

Expose an 'alias' for a 'model\_name' on the proxy server.
...
### Hide Alias Models[​](#hide-alias-models "Direct link to Hide Alias Models")
...
### Complete Spec[​](#complete-spec "Direct link to Complete Spec")
...
### When You'll See Load Balancing in Action[​](#when-youll-see-load-balancing-in-action "Direct link to When You'll See Load Balancing in Action")
...
* [Quick Start - Load Balancing](#quick-start---load-balancing)
  + [Test - Simple Call](#test---simple-call)
  + [Test - Loadbalancing](#test---loadbalancing)
...
* [Router settings on config - routing\_strategy, model\_group\_alias](#router-settings-on-config---routing_strategy-model_group_alias)
  + [Usage](#usage)
  + [Hide Alias Models](#hide-alias-models)
  + [Complete Spec](#complete-spec)
* [Deployment Ordering (Priority)](#deployment-ordering-priority)
  + [When You'll See Load Balancing in Action](#when-youll-see-load-balancing-in-action)