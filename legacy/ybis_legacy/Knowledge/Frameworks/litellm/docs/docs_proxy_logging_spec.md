...
## StandardLoggingPayload[​](#standardloggingpayload "Direct link to StandardLoggingPayload")
...
### CostBreakdown Type[​](#costbreakdown-type "Direct link to CostBreakdown Type")
...
## StandardLoggingUserAPIKeyMetadata[​](#standardlogginguserapikeymetadata "Direct link to StandardLoggingUserAPIKeyMetadata")
...
## StandardLoggingMetadata[​](#standardloggingmetadata "Direct link to StandardLoggingMetadata")
...
## StandardLoggingVectorStoreRequest[​](#standardloggingvectorstorerequest "Direct link to StandardLoggingVectorStoreRequest")

| Field | Type | Description |
| --- | --- | --- |
| vector\_store\_id | Optional[str] | ID of the vector store |
| custom\_llm\_provider | Optional[str] | Custom LLM provider the vector store is associated with (e.g., bedrock, openai, anthropic) |
| query | Optional[str] | Query to the vector store |
| vector\_store\_search\_response | Optional[VectorStoreSearchResponse] | OpenAI format vector store search response |
| start\_time | Optional[float] | Start time of the vector store request |
| end\_time | Optional[float] | End time of the vector store request |

## StandardLoggingAdditionalHeaders[​](#standardloggingadditionalheaders "Direct link to StandardLoggingAdditionalHeaders")
...
## StandardLoggingHiddenParams[​](#standardlogginghiddenparams "Direct link to StandardLoggingHiddenParams")
...
## StandardLoggingModelInformation[​](#standardloggingmodelinformation "Direct link to StandardLoggingModelInformation")
...
## StandardLoggingModelCostFailureDebugInformation[​](#standardloggingmodelcostfailuredebuginformation "Direct link to StandardLoggingModelCostFailureDebugInformation")
...
## StandardLoggingPayloadErrorInformation[​](#standardloggingpayloaderrorinformation "Direct link to StandardLoggingPayloadErrorInformation")
...
## StandardLoggingPayloadStatus[​](#standardloggingpayloadstatus "Direct link to StandardLoggingPayloadStatus")
...
## StandardLoggingGuardrailInformation[​](#standardloggingguardrailinformation "Direct link to StandardLoggingGuardrailInformation")
...
## StandardLoggingPayloadStatusFields[​](#standardloggingpayloadstatusfields "Direct link to StandardLoggingPayloadStatusFields")
...
### StandardLoggingPayloadStatus[​](#standardloggingpayloadstatus-1 "Direct link to StandardLoggingPayloadStatus")
...
### GuardrailStatus[​](#guardrailstatus "Direct link to GuardrailStatus")
...
## StandardLoggingPromptManagementMetadata[​](#standardloggingpromptmanagementmetadata "Direct link to StandardLoggingPromptManagementMetadata")
...
## StandardLoggingMCPToolCall[​](#standardloggingmcptoolcall "Direct link to StandardLoggingMCPToolCall")
...
### MCPServerCostInfo[​](#mcpservercostinfo "Direct link to MCPServerCostInfo")
...
* [StandardLoggingGuardrailInformation](#standardloggingguardrailinformation)
* [StandardLoggingPayloadStatusFields](#standardloggingpayloadstatusfields)
  + [StandardLoggingPayloadStatus](#standardloggingpayloadstatus-1)
  + [GuardrailStatus](#guardrailstatus)
  + [Usage Examples](#usage-examples)
* [StandardLoggingPromptManagementMetadata](#standardloggingpromptmanagementmetadata)
* [StandardLoggingMCPToolCall](#standardloggingmcptoolcall)
