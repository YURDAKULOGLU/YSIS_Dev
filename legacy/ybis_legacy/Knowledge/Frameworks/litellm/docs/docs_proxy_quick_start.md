...
* [Quick Start - LiteLLM Proxy CLI](#quick-start---litellm-proxy-cli)
  + [Test](#test)
  + [Supported LLMs](#supported-llms)
* [Quick Start - LiteLLM Proxy + Config.yaml](#quick-start---litellm-proxy--configyaml)
  + [Create a Config for LiteLLM Proxy](#create-a-config-for-litellm-proxy)
...
* [Debugging Proxy](#debugging-proxy)
  + [Set Debug Level using env variables](#set-debug-level-using-env-variables)