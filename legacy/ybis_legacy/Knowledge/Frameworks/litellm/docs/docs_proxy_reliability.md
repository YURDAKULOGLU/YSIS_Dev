...
* [Quick Start](#quick-start)
  + [1. Setup fallbacks](#1-setup-fallbacks)
  + [2. Start Proxy](#2-start-proxy)
  + [3. Test Fallbacks](#3-test-fallbacks)
  + [Explanation](#explanation)
* [Client Side Fallbacks](#client-side-fallbacks)
  + [Control Fallback Prompts](#control-fallback-prompts)
* [Content Policy Violation Fallback](#content-policy-violation-fallback)
* [Context Window Exceeded Fallback](#context-window-exceeded-fallback)
* [Advanced](#advanced)
  + [Fallbacks + Retries + Timeouts + Cooldowns](#fallbacks--retries--timeouts--cooldowns)
  + [Fallback to Specific Model ID](#fallback-to-specific-model-id)
  ...
  + [Content Policy Fallbacks](#content-policy-fallbacks-1)
  ...
  + [Disable Fallbacks (Per Request/Key)](#disable-fallbacks-per-requestkey)