...
![](/assets/ideal-img/team_logging1.d7eaa9a.640.png)
...
![](/assets/ideal-img/team_logging2.fb1a464.640.png)
...
![](/assets/ideal-img/team_logging3.4053ad6.640.png)
...
![](/assets/ideal-img/team_logging4.08c041d.640.png)
...
![](/assets/ideal-img/key_logging.7c0125f.640.png)
...
![](/assets/ideal-img/key_logging2.c48c954.640.png)
...
![](/assets/ideal-img/key_logging_arize.b41c487.640.png)
...
* [Overview](#overview)
* [Supported Logging Integrations](#supported-logging-integrations)
* [[BETA] Team Logging](#beta-team-logging)
  + [UI Usage](#ui-usage)
  + [API Usage](#api-usage)
  + [Set Callbacks Per Team](#set-callbacks-per-team)
  + [Disable Logging for a Team](#disable-logging-for-a-team)
  + [Team Logging Endpoints](#team-logging-endpoints)
* [Team Logging - `config.yaml`](#team-logging---configyaml)
* [[BETA] Key Based Logging](#beta-key-based-logging)
  + [UI Usage](#ui-usage-1)
  + [API Usage](#api-usage-1)
  + [Check if key callbacks are configured correctly `/key/health`](#check-if-key-callbacks-are-configured-correctly-keyhealth)
  + [Disable/Enable Message redaction](#disableenable-message-redaction)