...
To drop unsupported params (E.g. frequency\_penalty for bedrock with librechat), [go here](https://docs.litellm.ai/docs/completion/drop_params#openai-proxy-usage)
...
[**👉 Go Here**](/docs/providers/litellm_proxy#send-all-sdk-requests-to-litellm-proxy)
...
## Using Tags for Categorization and Tracking[​](#using-tags-for-categorization-and-tracking "Direct link to Using Tags for Categorization and Tracking")
...
### Tag Benefits[​](#tag-benefits "Direct link to Tag Benefits")
...
## `/moderations`[​](#moderations "Direct link to moderations")
...
### Response Format[​](#response-format-2 "Direct link to Response Format")
...
## Using with OpenAI compatible projects[​](#using-with-openai-compatible-projects "Direct link to Using with OpenAI compatible projects")
...
#### Start the LiteLLM proxy[​](#start-the-litellm-proxy "Direct link to Start the LiteLLM proxy")
...
#### 2. Modify Librechat's `docker-compose.yml`[​](#2-modify-librechats-docker-composeyml "Direct link to 2-modify-librechats-docker-composeyml")
...
#### 3. Save fake OpenAI key in Librechat's `.env`[​](#3-save-fake-openai-key-in-librechats-env "Direct link to 3-save-fake-openai-key-in-librechats-env")

Copy Librechat's `.env.example` to `.env` and overwrite the default OPENAI\_API\_KEY (by default it requires the user to pass a key).

```
OPENAI_API_KEY=sk-1234
```

#### 4. Run LibreChat:[​](#4-run-librechat "Direct link to 4. Run LibreChat:")
...
## Using with Vertex, Boto3, Anthropic SDK (Native format)[​](#using-with-vertex-boto3-anthropic-sdk-native-format "Direct link to Using with Vertex, Boto3, Anthropic SDK (Native format)")

👉 **[Here's how to use litellm proxy with Vertex, boto3, Anthropic SDK - in the native format](/docs/pass_through/vertex_ai)**

## Advanced[​](#advanced "Direct link to Advanced")

### (BETA) Batch Completions - pass multiple models[​](#beta-batch-completions---pass-multiple-models "Direct link to (BETA) Batch Completions - pass multiple models")

Use this when you want to send 1 request to N Models

#### Expected Request Format[​](#expected-request-format "Direct link to Expected Request Format")
...
#### Expected Response Format[​](#expected-response-format "Direct link to Expected Response Format")
...
#### Expected Response Format[​](#expected-response-format-1 "Direct link to Expected Response Format")
...
* [Using Tags for Categorization and Tracking](#using-tags-for-categorization-and-tracking)
...
* [Using with Vertex, Boto3, Anthropic SDK (Native format)](#using-with-vertex-boto3-anthropic-sdk-native-format)
* [Advanced](#advanced)
