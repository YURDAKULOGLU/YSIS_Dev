...
#### Step 1. Create Budget[​](#step-1-create-budget "Direct link to Step 1. Create Budget")
...
#### Step 2. Create `Customer` with Budget[​](#step-2-create-customer-with-budget "Direct link to step-2-create-customer-with-budget")
...
#### Step 3. Pass `user_id` id in `/chat/completions` requests[​](#step-3-pass-user_id-id-in-chatcompletions-requests "Direct link to step-3-pass-user_id-id-in-chatcompletions-requests")
...
* [Set Budgets](#set-budgets)
  ...
  + [✨ Virtual Key (Model Specific)](#-virtual-key-model-specific)
  + [Customers](#customers)
* [Reset Budgets](#reset-budgets)
* [Set Rate Limits](#set-rate-limits)
* [Set default budget for ALL internal users](#set-default-budget-for-all-internal-users)
  + [[BETA] Multi-instance rate limiting](#beta-multi-instance-rate-limiting)
* [Grant Access to new model](#grant-access-to-new-model)
* [Create new keys for existing internal user](#create-new-keys-for-existing-internal-user)
