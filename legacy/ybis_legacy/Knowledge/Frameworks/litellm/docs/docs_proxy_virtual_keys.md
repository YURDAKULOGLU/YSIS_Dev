...
## **Quick Start - Generate a Key**[​](#quick-start---generate-a-key "Direct link to quick-start---generate-a-key")
...
## Model Aliases[​](#model-aliases "Direct link to Model Aliases")
...
### Pass LiteLLM Key in custom header[​](#pass-litellm-key-in-custom-header "Direct link to Pass LiteLLM Key in custom header")
...
### Enable/Disable Virtual Keys[​](#enabledisable-virtual-keys "Direct link to Enable/Disable Virtual Keys")
...
### Custom /key/generate[​](#custom-keygenerate "Direct link to Custom /key/generate")

If you need to add custom logic before generating a Proxy API Key (Example Validating `team_id`)

#### 1. Write a custom `custom_generate_key_fn`[​](#1-write-a-custom-custom_generate_key_fn "Direct link to 1-write-a-custom-custom_generate_key_fn")
...
#### 2. Pass the filepath (relative to the config.yaml)[​](#2-pass-the-filepath-relative-to-the-configyaml "Direct link to 2. Pass the filepath (relative to the config.yaml)")
...
### Upperbound /key/generate params[​](#upperbound-keygenerate-params "Direct link to Upperbound /key/generate params")
...
### Default /key/generate params[​](#default-keygenerate-params "Direct link to Default /key/generate params")
...
### ✨ Key Rotations[​](#-key-rotations "Direct link to ✨ Key Rotations")
...
#### Create a key with auto rotation[​](#create-a-key-with-auto-rotation "Direct link to Create a key with auto rotation")
...
![](/assets/ideal-img/key_r.f73ae9f.640.png)
...
#### Update existing key to enable rotation[​](#update-existing-key-to-enable-rotation "Direct link to Update existing key to enable rotation")
...
![](/assets/ideal-img/key_u.052a771.640.png)
...
### Temporary Budget Increase[​](#temporary-budget-increase "Direct link to Temporary Budget Increase")
...
### Restricting Key Generation[​](#restricting-key-generation "Direct link to Restricting Key Generation")
...
## **Next Steps - Set Budgets, Rate Limits per Virtual Key**[​](#next-steps---set-budgets-rate-limits-per-virtual-key "Direct link to next-steps---set-budgets-rate-limits-per-virtual-key")

[Follow this doc to set budgets, rate limiters per virtual key with LiteLLM](/docs/proxy/users)

## Endpoint Reference (Spec)[​](#endpoint-reference-spec "Direct link to Endpoint Reference (Spec)")

### Keys[​](#keys "Direct link to Keys")

#### [**👉 API REFERENCE DOCS**](https://litellm-api.up.railway.app/#/key%20management/)[​](#-api-reference-docs "Direct link to -api-reference-docs")

### Users[​](#users "Direct link to Users")

#### [**👉 API REFERENCE DOCS**](https://litellm-api.up.railway.app/#/user%20management/)[​](#-api-reference-docs-1 "Direct link to -api-reference-docs-1")

### Teams[​](#teams "Direct link to Teams")

#### [**👉 API REFERENCE DOCS**](https://litellm-api.up.railway.app/#/team%20management)[​](#-api-reference-docs-2 "Direct link to -api-reference-docs-2")

* [Setup](#setup)
* [**Quick Start - Generate a Key**](#quick-start---generate-a-key)
* [Spend Tracking](#spend-tracking)
* [Model Aliases](#model-aliases)
* [Advanced](#advanced)
  + [Pass LiteLLM Key in custom header](#pass-litellm-key-in-custom-header)
  + [Enable/Disable Virtual Keys](#enabledisable-virtual-keys)
  + [Custom /key/generate](#custom-keygenerate)
  + [Upperbound /key/generate params](#upperbound-keygenerate-params)
  + [Default /key/generate params](#default-keygenerate-params)
  + [✨ Key Rotations](#-key-rotations)
  + [Scheduled Key Rotations](#scheduled-key-rotations)
  + [Temporary Budget Increase](#temporary-budget-increase)
  + [Restricting Key Generation](#restricting-key-generation)
* [**Next Steps - Set Budgets, Rate Limits per Virtual Key**](#next-steps---set-budgets-rate-limits-per-virtual-key)
* [Endpoint Reference (Spec)](#endpoint-reference-spec)
  + [Keys](#keys)
  + [Users](#users)
  + [Teams](#teams)