...
## Advanced - Routing Strategies ⭐️[​](#advanced---routing-strategies-️ "Direct link to Advanced - Routing Strategies ⭐️")
...
##### **LiteLLM Proxy Config.yaml**[​](#litellm-proxy-configyaml-1 "Direct link to litellm-proxy-configyaml-1")
...
##### **Python SDK**[​](#python-sdk-1 "Direct link to python-sdk-1")
...
#### Set Time Window[​](#set-time-window "Direct link to Set Time Window")
...
#### Set Lowest Latency Buffer[​](#set-lowest-latency-buffer "Direct link to Set Lowest Latency Buffer")
...
#### Using Custom Input/Output pricing[​](#using-custom-inputoutput-pricing "Direct link to Using Custom Input/Output pricing")
...
* [Advanced - Routing Strategies ⭐️](#advanced---routing-strategies-️)
* [Basic Reliability](#basic-reliability)
  + [Deployment Ordering (Priority)](#deployment-ordering-priority)
  + [Weighted Deployments](#weighted-deployments)
  + [Max Parallel Requests (ASYNC)](#max-parallel-requests-async)
  + [Cooldowns](#cooldowns)
  + [How Cooldowns Work](#how-cooldowns-work)
  + [Retries](#retries)
  + [[Advanced]: Custom Retries, Cooldowns based on Error Type](#advanced-custom-retries-cooldowns-based-on-error-type)
  + [Caching](#caching)
* [Pre-Call Checks (Context Window, EU-Regions)](#pre-call-checks-context-window-eu-regions)
* [Caching across model groups](#caching-across-model-groups)
* [Alerting 🚨](#alerting-)
* [Track cost for Azure Deployments](#track-cost-for-azure-deployments)
* [Custom Callbacks - Track API Key, API Endpoint, Model Used](#custom-callbacks---track-api-key-api-endpoint-model-used)
  + [Usage](#usage-1)
...
* [Debugging Router](#debugging-router)
  ...
  + [Very Detailed Debugging](#very-detailed-debugging)
* [Router General Settings](#router-general-settings)
  + [Usage](#usage-2)
  + [Spec](#spec)