 Advanced Parsing Modes | LlamaIndex Python Documentation
...
[Section titled “Parse without AI”](#parse-without-ai)
...
[Section titled “Parse with LLM”](#parse-with-llm)

Documents with tables and images (aka Balanced Mode)

#### Overview

[Section titled “Overview”](#overview-1)
...
[Section titled “Under the Hood”](#under-the-hood-1)
...
[Section titled “Parse with LVM”](#parse-with-lvm)

Best for rich visual content

#### Overview

[Section titled “Overview”](#overview-2)
...
[Section titled “Under the Hood”](#under-the-hood-2)
...
See [Multimodal](/python/cloud/llamaparse/features/multimodal/) for more info.
...
[Section titled “Parse with Agent”](#parse-with-agent)

Complex documents with tables and images (aka Premium Mode)

#### Overview

[Section titled “Overview”](#overview-3)
...
[Section titled “Under the Hood”](#under-the-hood-3)
...
[Section titled “Parse with Layout Agent”](#parse-with-layout-agent)

Best for precise visual citations

#### Overview

[Section titled “Overview”](#overview-4)
...
[Section titled “Under the Hood”](#under-the-hood-4)
...
[Section titled “Parse Document with LLM”](#parse-document-with-llm)

Best for continuity between pages

#### Overview

[Section titled “Overview”](#overview-5)
...
[Section titled “Under the Hood”](#under-the-hood-5)
...
[Section titled “Parse Document with Agent”](#parse-document-with-agent)

Best for complex continuity between pages

#### Overview

[Section titled “Overview”](#overview-6)
...
[Section titled “Under the Hood”](#under-the-hood-6)
...
[Section titled “Deprecated Modes”](#deprecated-modes)

Depecrated modes - no longer maintained

#### Continuous Mode (Deprecated)

[Section titled “Continuous Mode (Deprecated)”](#continuous-mode-deprecated)
