 Modes and Presets | LlamaIndex Python Documentation
...
[Section titled “Cost-effective”](#cost-effective)
...
[Section titled “Agentic”](#agentic)
...
[Section titled “Agentic Plus”](#agentic-plus)
...
[Section titled “Use Case Specific Presets”](#use-case-specific-presets)
...
[Section titled “Scientific Paper”](#scientific-paper)

For Scientific papers. Set `preset="scientific"` on API. Current version is `scientific-v-1`.

### Technical Documentation

[Section titled “Technical Documentation”](#technical-documentation)
