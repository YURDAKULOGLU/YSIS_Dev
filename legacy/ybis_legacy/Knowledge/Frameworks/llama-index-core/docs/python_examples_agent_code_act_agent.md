...
[Section titled “Create a Code Executor”](#create-a-code-executor)
...
[Section titled “Setup the CodeAct Agent”](#setup-the-codeact-agent)
...
[Section titled “Use the Agent”](#use-the-agent)
