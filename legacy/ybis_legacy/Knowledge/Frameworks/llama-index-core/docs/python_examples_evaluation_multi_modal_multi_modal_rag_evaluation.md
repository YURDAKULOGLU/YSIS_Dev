...
[Section titled “Use Case: Spelling In ASL”](#use-case-spelling-in-asl)
...
[Section titled “The Query”](#the-query)
...
[Section titled “Another RAG System For Consideration (GPT-4V Image Descriptions For Retrieval)”](#another-rag-system-for-consideration-gpt-4v-image-descriptions-for-retrieval)
...
[Section titled “Build Our Multi-Modal RAG Systems”](#build-our-multi-modal-rag-systems)
...
[Section titled “Test drive our Multi-Modal RAG”](#test-drive-our-multi-modal-rag)
...
![png](/python/_astro/output_23_1.eFhSSLnv_ZrTBLl.webp)
...
[Section titled “Retriever Evaluation”](#retriever-evaluation)
...
![png](/python/_astro/output_27_0.B2vE3ls6_Z1aouwo.webp)
...
[Section titled “Quantitative: Hit Rate and MRR”](#quantitative-hit-rate-and-mrr)
...
| --- | --- | --- | --- |
| 0 | asl\_index-image | 0.814815 | 0.814815 |
| 1 | asl\_index-text | 1.000000 | 1.000000 |
| 2 | asl\_text\_desc\_index | 0.925926 | 0.925926 |
...
[Section titled “Generation Evaluation”](#generation-evaluation)
...
[Section titled “Reference (Ground-Truth) Data”](#reference-ground-truth-data)
...
[Section titled “Generate Responses To ALL Queries For Each System”](#generate-responses-to-all-queries-for-each-system)
...
[Section titled “Correctness, Faithfulness, Relevancy”](#correctness-faithfulness-relevancy)
...
| rag | mm\_clip\_gpt4v | mm\_clip\_llava | mm\_text\_desc\_gpt4v | mm\_text\_desc\_llava |
| --- | --- | --- | --- | --- |
| metrics |  |  |  |  |
| mean\_correctness\_score | 3.685185 | 4.092593 | 3.722222 | 3.870370 |
| mean\_relevancy\_score | 0.777778 | 0.851852 | 0.703704 | 0.740741 |
| mean\_faithfulness\_score | 0.777778 | 0.888889 | 0.851852 | 0.851852 |

#### Observations

[Section titled “Observations”](#observations-1)
...
[Section titled “In Conclusion”](#in-conclusion)
