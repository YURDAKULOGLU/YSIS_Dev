...
[Section titled “Load the Dataset”](#load-the-dataset)
...
[Section titled “QASPER Dataset”](#qasper-dataset)
...
[Section titled “Generate RAG Eval test data”](#generate-rag-eval-test-data)
...
[Section titled “Generate Finetuning Dataset”](#generate-finetuning-dataset)
...
[Section titled “Generate Reranking Eval test data”](#generate-reranking-eval-test-data)
...
[Section titled “Finetune Cross-Encoder”](#finetune-cross-encoder)
...
[Section titled “Reranking Evaluation”](#reranking-evaluation)
...
[Section titled “RAG Evaluation”](#rag-evaluation)
...
[Section titled “Baseline Evaluation”](#baseline-evaluation)

Just using OpenAI Embeddings for retrieval without any re-ranker

#### Eval Method:-

[Section titled “Eval Method:-”](#eval-method)
...
[Section titled “Evaluate with base reranker”](#evaluate-with-base-reranker)

OpenAI Embeddings + `cross-encoder/ms-marco-MiniLM-L-12-v2` as reranker

#### Eval Method:-

[Section titled “Eval Method:-”](#eval-method--1)
...
[Section titled “Evaluate with Fine-Tuned re-ranker”](#evaluate-with-fine-tuned-re-ranker)

OpenAI Embeddings + `bpHigh/Cross-Encoder-LLamaIndex-Demo-v2` as reranker

#### Eval Method:-

[Section titled “Eval Method:-”](#eval-method--2)
...
[Section titled “Results”](#results-1)
