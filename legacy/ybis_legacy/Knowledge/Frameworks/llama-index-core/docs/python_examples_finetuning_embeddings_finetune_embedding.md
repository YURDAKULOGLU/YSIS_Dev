...
[Section titled “Generate Corpus”](#generate-corpus)
...
[Section titled “Generate synthetic queries”](#generate-synthetic-queries)
...
[Section titled “Run Embedding Finetuning”](#run-embedding-finetuning)
...
[Section titled “Evaluate Finetuned Model”](#evaluate-finetuned-model)
...
[Section titled “Define eval function”](#define-eval-function)
...
[Section titled “Run Evals”](#run-evals)
...
[Section titled “BAAI/bge-small-en”](#baaibge-small-en)
...
[Section titled “Finetuned”](#finetuned)
...
[Section titled “Summary of Results”](#summary-of-results)

#### Hit rate

[Section titled “Hit rate”](#hit-rate)
...
[Section titled “InformationRetrievalEvaluator”](#informationretrievalevaluator)
