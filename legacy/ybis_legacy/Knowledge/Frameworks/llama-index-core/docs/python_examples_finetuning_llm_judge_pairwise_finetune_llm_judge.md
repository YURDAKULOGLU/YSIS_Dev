...
[Section titled “Step 1 Generate datasets: train\_dataset and test\_dataset”](#step-1-generate-datasets-train_dataset-and-test_dataset)
...
[Section titled “Use a DatasetGenerator to build train\_dataset and test\_dataset”](#use-a-datasetgenerator-to-build-train_dataset-and-test_dataset)
...
[Section titled “Generate Questions”](#generate-questions)
...
[Section titled “Generate Answers To The Questions”](#generate-answers-to-the-questions)
...
[Section titled “Get GPT-4 Evaluations On The Mistral and LLama-2 Answers”](#get-gpt-4-evaluations-on-the-mistral-and-llama-2-answers)
...
[Section titled “Special Care To The Fine-Tuning JSONL”](#special-care-to-the-fine-tuning-jsonl)
...
[Section titled “Step 2 Perform knowledge distillation”](#step-2-perform-knowledge-distillation)
...
[Section titled “3 Evaluate The Fine-Tuned GPT-3.5 Judge On The Test Dataset”](#3-evaluate-the-fine-tuned-gpt-35-judge-on-the-test-dataset)
...
[Section titled “The Metrics”](#the-metrics)
