...
[Section titled “Fine-tuning Using GPT-4 Pydantic Programs”](#fine-tuning-using-gpt-4-pydantic-programs)
...
[Section titled “Defining Pydantic Model + Program”](#defining-pydantic-model--program)
...
[Section titled “Log Inputs/Outputs”](#log-inputsoutputs)
...
[Section titled “Fine-tune on the Dataset”](#fine-tune-on-the-dataset)
...
[Section titled “Fine-tuning Structured Outputs through a RAG System”](#fine-tuning-structured-outputs-through-a-rag-system)
...
[Section titled “Load Data + Setup”](#load-data--setup)
...
[Section titled “Generate Dataset”](#generate-dataset)
...
[Section titled “Setup Fine-tuning”](#setup-fine-tuning)
...
[Section titled “Use within RAG Pipeline”](#use-within-rag-pipeline)
