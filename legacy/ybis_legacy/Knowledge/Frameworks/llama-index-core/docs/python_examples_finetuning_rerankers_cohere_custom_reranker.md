...
[Section titled “Initialize the api keys.”](#initialize-the-api-keys)
...
[Section titled “Data Curation”](#data-curation)

### Create Nodes.

[Section titled “Create Nodes.”](#create-nodes)

The documentation mentions that Query + Relevant Passage/ Query + Hard Negatives should be less than 510 tokens. To accomidate that we limit chunk\_size to 400 tokens. (Each chunk will eventually be treated as a Relevant Passage/ Hard Negative)
...
[Section titled “Data Format and Requirements”](#data-format-and-requirements)
...
**hard\_negatives:** this represents chunks or passages that don’t contain answer for the query. It should be notes that Hard negatives are optional but providing atleast ~5 hard negatives will lead to meaningful improvement.
...
[Section titled “Training Custom Reranker.”](#training-custom-reranker)
...
[Section titled “Check Results.”](#check-results)
