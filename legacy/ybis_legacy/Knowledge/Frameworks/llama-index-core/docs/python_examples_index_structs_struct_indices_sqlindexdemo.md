...
[Section titled “Create Database Schema”](#create-database-schema)
...
[Section titled “Define SQL Database”](#define-sql-database)
...
[Section titled “Query Index”](#query-index)
...
[Section titled “Part 1: Text-to-SQL Query Engine”](#part-1-text-to-sql-query-engine)
...
[Section titled “Part 2: Query-Time Retrieval of Tables for Text-to-SQL”](#part-2-query-time-retrieval-of-tables-for-text-to-sql)
...
[Section titled “Part 3: Query-Time Retrieval of Rows and Columns for Text-to-SQL”](#part-3-query-time-retrieval-of-rows-and-columns-for-text-to-sql)
...
[Section titled “Query-Time Rows Retrieval”](#query-time-rows-retrieval)
...
**There are 2 cities in the United States according to the data in the city\_stats table.**

### Query-Time Columns Retrieval

[Section titled “Query-Time Columns Retrieval”](#query-time-columns-retrieval)
...
[Section titled “Part 4: Text-to-SQL Retriever”](#part-4-text-to-sql-retriever)
...
**Similarity:** None  
**Text:**   
**Metadata:** {‘city\_name’: ‘New York’, ‘population’: 8258000}

**Node ID:** ee911f7f-8aae-4bad-a52d-c0bdfab63942  
**Similarity:** None  
**Text:**   
**Metadata:** {‘city\_name’: ‘Busan’, ‘population’: 3334000}
...
[Section titled “Plug into our RetrieverQueryEngine”](#plug-into-our-retrieverqueryengine)
