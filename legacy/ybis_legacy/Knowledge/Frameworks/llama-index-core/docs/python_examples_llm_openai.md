...
[Section titled “Call complete with a prompt”](#call-complete-with-a-prompt)
...
[Section titled “Call chat with a list of messages”](#call-chat-with-a-list-of-messages)
...
[Section titled “Configure Model”](#configure-model)
...
[Section titled “Image Support”](#image-support)
...
[Section titled “Using Function/Tool Calling”](#using-functiontool-calling)
...
[Section titled “Manual Tool Calling”](#manual-tool-calling)
...
[Section titled “Structured Prediction”](#structured-prediction)
...
[Section titled “Structured Prediction with Streaming”](#structured-prediction-with-streaming)
...
[Section titled “Set API Key at a per-instance level”](#set-api-key-at-a-per-instance-level)
...
[Section titled “Additional kwargs”](#additional-kwargs)
...
[Section titled “RAG with LlamaCloud”](#rag-with-llamacloud)
...
[Section titled “Setup OpenAI and LlamaCloud API Keys”](#setup-openai-and-llamacloud-api-keys)
...
[Section titled “Create a Pipeline.”](#create-a-pipeline)
...
[Section titled “File Upload”](#file-upload)
...
[Section titled “Check the Ingestion job status”](#check-the-ingestion-job-status)
...
[Section titled “Connect to Index.”](#connect-to-index)
...
[Section titled “Test on Sample Query”](#test-on-sample-query)
...
[Section titled “Display the retrieved nodes”](#display-the-retrieved-nodes)
...
[Section titled “Query Engine”](#query-engine)
