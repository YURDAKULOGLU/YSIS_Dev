...
![Integration Tests](https://github.com/chroma-core/chroma/actions/workflows/chroma-integration-test.yml/badge.svg?branch=main)
...
[Section titled “Creating a Chroma Index”](#creating-a-chroma-index)
...
[Section titled “Set the embedding model”](#set-the-embedding-model)
...
[Section titled “Build Chroma Multi-Modal Index with LlamaIndex”](#build-chroma-multi-modal-index-with-llamaindex)
...
[Section titled “Retrieve results from Multi-Modal Index”](#retrieve-results-from-multi-modal-index)
...
![png](/python/_astro/output_19_5.BgXVpNU6_Z7r2SB.webp)