...
[Section titled “Download images from Tesla website for GPT4V image reasoning”](#download-images-from-tesla-website-for-gpt4v-image-reasoning)
...
[Section titled “Generate image reasoning from GPT4V Multi-Modal LLM”](#generate-image-reasoning-from-gpt4v-multi-modal-llm)

### Plot input images

[Section titled “Plot input images”](#plot-input-images)
...
![png](/python/_astro/output_9_0.Bl94S9Zw_ZcbHq6.webp)

### Using GPT4V to understand those input images

[Section titled “Using GPT4V to understand those input images”](#using-gpt4v-to-understand-those-input-images)
...
[Section titled “Generating text, pdf, images data from raw files [Wikipedia, SEC files] for Multi Modal Index/Retrieval”](#generating-text-pdf-images-data-from-raw-files-wikipedia-sec-files-for-multi-modal-indexretrieval)
...
[Section titled “Build Multi-modal index and vector store to index both text and images”](#build-multi-modal-index-and-vector-store-to-index-both-text-and-images)
...
[Section titled “Retrieve and query texts and images from our Multi-Modal Index”](#retrieve-and-query-texts-and-images-from-our-multi-modal-index)
...
[Section titled “1. Retrieval-Augmented Captioning”](#1-retrieval-augmented-captioning)
...
![png](/python/_astro/output_23_3.BYvBtkuC_ZaLSG9.webp)
...
[Section titled “2. Multi-Modal RAG Querying”](#2-multi-modal-rag-querying)
...
![png](/python/_astro/output_28_2.BMhkMp6j_Z21WmpV.webp)