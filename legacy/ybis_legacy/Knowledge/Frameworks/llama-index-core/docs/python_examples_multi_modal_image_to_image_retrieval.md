...
[Section titled “Download images and texts from Wikipedia”](#download-images-and-texts-from-wikipedia)
...
[Section titled “Plot images from Wikipedia”](#plot-images-from-wikipedia)
...
![png](/python/_astro/output_7_1.ySGRCfla_iYosW.webp)

## Build Multi-Modal index and Vector Store to index both text and images from Wikipedia

[Section titled “Build Multi-Modal index and Vector Store to index both text and images from Wikipedia”](#build-multi-modal-index-and-vector-store-to-index-both-text-and-images-from-wikipedia)
...
[Section titled “Plot input query image”](#plot-input-query-image)
...
[Section titled “Retrieve images from Multi-Modal Index given the image query”](#retrieve-images-from-multi-modal-index-given-the-image-query)

### 1. Image to Image Retrieval Results

[Section titled “1. Image to Image Retrieval Results”](#1-image-to-image-retrieval-results)
...
![png](/python/_astro/output_14_0.DJbIFMgC_ZWU5mA.webp)

### 2. GPT4V Reasoning Retrieved Images based on Input Image

[Section titled “2. GPT4V Reasoning Retrieved Images based on Input Image”](#2-gpt4v-reasoning-retrieved-images-based-on-input-image)
...
[Section titled “Using Image Query Engine”](#using-image-query-engine)
