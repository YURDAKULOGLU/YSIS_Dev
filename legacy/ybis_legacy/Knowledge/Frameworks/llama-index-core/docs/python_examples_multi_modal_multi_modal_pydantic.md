...
[Section titled “Download Image Locally”](#download-image-locally)
...
[Section titled “Initialize Pydantic Class for Restaurant”](#initialize-pydantic-class-for-restaurant)
...
[Section titled “Load OpenAI GPT4V Multi-Modal LLM Model”](#load-openai-gpt4v-multi-modal-llm-model)
...
[Section titled “Plot the image”](#plot-the-image)
...
![png](/python/_astro/output_12_1.wpcoBLnY_o2uYj.webp)

## Using Multi-Modal Pydantic Program to generate structured data from GPT4V Output for Restaurant Image

[Section titled “Using Multi-Modal Pydantic Program to generate structured data from GPT4V Output for Restaurant Image”](#using-multi-modal-pydantic-program-to-generate-structured-data-from-gpt4v-output-for-restaurant-image)
...
[Section titled “Test Pydantic for MiniGPT-4, Fuyu-8B, LLaVa-13B, CogVLM models”](#test-pydantic-for-minigpt-4-fuyu-8b-llava-13b-cogvlm-models)
...
[Section titled “Using Fuyu-8B for Pydantic Strucured Output”](#using-fuyu-8b-for-pydantic-strucured-output)
...
[Section titled “Using LLaVa-13B for Pydantic Strucured Output”](#using-llava-13b-for-pydantic-strucured-output)
...
[Section titled “Using MiniGPT-4 for Pydantic Strucured Output”](#using-minigpt-4-for-pydantic-strucured-output)
...
[Section titled “Using CogVLM for Pydantic Strucured Output”](#using-cogvlm-for-pydantic-strucured-output)
...
[Section titled “Change to Amazon Product Example”](#change-to-amazon-product-example)

### Download the Amazon Product Image Screenshot

[Section titled “Download the Amazon Product Image Screenshot”](#download-the-amazon-product-image-screenshot)
...
[Section titled “Initialize the Amazon Product Pydantic Class”](#initialize-the-amazon-product-pydantic-class)
...
[Section titled “Plot the Image”](#plot-the-image-1)
...
![png](/python/_astro/output_33_1.w37sa1MP_UF7wN.webp)

## Using Multi-Modal Pydantic Program to generate structured data from GPT4V Output for Amazon Product Image

[Section titled “Using Multi-Modal Pydantic Program to generate structured data from GPT4V Output for Amazon Product Image”](#using-multi-modal-pydantic-program-to-generate-structured-data-from-gpt4v-output-for-amazon-product-image)
...
[Section titled “Test Pydantic for MiniGPT-4, Fuyu-8B, LLaVa-13B, CogVLM models”](#test-pydantic-for-minigpt-4-fuyu-8b-llava-13b-cogvlm-models-1)

### Using Fuyu-8B for Pydantic Strucured Output

[Section titled “Using Fuyu-8B for Pydantic Strucured Output”](#using-fuyu-8b-for-pydantic-strucured-output-1)
...
[Section titled “Using MiniGPT-4 for Pydantic Strucured Output”](#using-minigpt-4-for-pydantic-strucured-output-1)
...
[Section titled “Using CogVLM-4 for Pydantic Strucured Output”](#using-cogvlm-4-for-pydantic-strucured-output)
...
[Section titled “Using LlaVa-13B for Pydantic Strucured Output”](#using-llava-13b-for-pydantic-strucured-output-1)
...
[Section titled “Initialize the Instagram Ads Pydantic Class and compare performance of different Multi-Modal LLMs”](#initialize-the-instagram-ads-pydantic-class-and-compare-performance-of-different-multi-modal-llms)
...
![png](/python/_astro/output_51_1.C4L0z0_O_1JQY9J.webp)
