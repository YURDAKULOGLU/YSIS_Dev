...
[Section titled “Load and Download Multi-Modal datasets including texts and images from Wikipedia”](#load-and-download-multi-modal-datasets-including-texts-and-images-from-wikipedia)
...
[Section titled “Parse Wikipedia Images and texts. Load into local folder”](#parse-wikipedia-images-and-texts-load-into-local-folder)
...
[Section titled “Build Multi Modal Vector Store using Text and Image embeddings under different collections”](#build-multi-modal-vector-store-using-text-and-image-embeddings-under-different-collections)
...
[Section titled “Plot downloaded Images from Wikipedia”](#plot-downloaded-images-from-wikipedia)
...
![png](/python/_astro/output_11_0.CB0eEE48_Z2wBkWm.webp)

### Build a separate CLIP image embedding index under a differnt collection `wikipedia_img`

[Section titled “Build a separate CLIP image embedding index under a differnt collection wikipedia\_img”](#build-a-separate-clip-image-embedding-index-under-a-differnt-collection-wikipedia_img)
...
[Section titled “Get Multi-Modal retrieval results for some example queries”](#get-multi-modal-retrieval-results-for-some-example-queries)
...
![png](/python/_astro/output_16_3.XB3H7Byo_ZmmY4.webp)
...
![png](/python/_astro/output_17_3.CYBVrgkx_1vVFVm.webp)
...
![png](/python/_astro/output_18_3.BV52bqiq_CHsRo.webp)
...
![png](/python/_astro/output_19_3.s2UsrV_C_oRvnh.webp)
...
![png](/python/_astro/output_20_3.rsrFNlpX_ZOl6hx.webp)