...
[Section titled “Use GPT4V to understand Images from URLs”](#use-gpt4v-to-understand-images-from-urls)
...
[Section titled “Initialize OpenAIMultiModal and Load Images from URLs”](#initialize-openaimultimodal-and-load-images-from-urls)
...
![png](/python/_astro/output_7_2.k6qQDhs6_Z19QJ2K.webp)

### Ask the model to describe what it sees

[Section titled “Ask the model to describe what it sees”](#ask-the-model-to-describe-what-it-sees)
...
[Section titled “Use GPT4V to understand images from local files”](#use-gpt4v-to-understand-images-from-local-files)
