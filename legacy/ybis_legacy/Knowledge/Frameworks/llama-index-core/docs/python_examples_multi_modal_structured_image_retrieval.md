...
[Section titled “Get Google API Key”](#get-google-api-key)
...
[Section titled “Download Images”](#download-images)
...
[Section titled “Get Image Files”](#get-image-files)
...
[Section titled “Use Gemini to extract structured outputs”](#use-gemini-to-extract-structured-outputs)
...
[Section titled “Define a ReceiptInfo pydantic class”](#define-a-receiptinfo-pydantic-class)
...
[Section titled “Define a pydantic\_gemini function”](#define-a-pydantic_gemini-function)
...
[Section titled “Run over images”](#run-over-images)
...
[Section titled “Convert Structured Representation to TextNode objects”](#convert-structured-representation-to-textnode-objects)
...
[Section titled “Index these nodes in vector stores”](#index-these-nodes-in-vector-stores)
...
[Section titled “Define Auto-Retriever”](#define-auto-retriever)
...
![jpeg](/python/_astro/output_31_1.IupOTN3m_2ptY2a.webp)
...
![jpeg](/python/_astro/output_31_3.DLAtHN2g_xk9vl.webp)
...
![jpeg](/python/_astro/output_32_1.DUaNQ0jz_ZjJQSe.webp)
...
![jpeg](/python/_astro/output_32_3.B9kS3sct_ZERUNw.webp)