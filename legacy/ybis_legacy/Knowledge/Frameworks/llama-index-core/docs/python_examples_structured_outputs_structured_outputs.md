...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/examples/structured_outputs/structured_outputs.ipynb)
...
[Section titled “1. Simple Structured Extraction”](#1-simple-structured-extraction)
...
[Section titled “Async Streaming”](#async-streaming)
...
[Section titled “1.b Use the structured\_predict Function”](#1b-use-the-structured_predict-function)
...
[Section titled “2. Plug into RAG Pipeline”](#2-plug-into-rag-pipeline)
...
[Section titled “Option 1: Use LlamaParse”](#option-1-use-llamaparse)
...
[Section titled “Option 2: Use SimpleDirectoryReader”](#option-2-use-simpledirectoryreader)
...
[Section titled “Build RAG Pipeline, Define Structured Output Schema”](#build-rag-pipeline-define-structured-output-schema)
...
[Section titled “Run Queries”](#run-queries)
