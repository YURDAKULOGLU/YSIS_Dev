...
![Ark Daily Trades](/python/_astro/ark_email_sample.C8sozTaF_Z2l3kQP.webp "Sample Email of ARK Investment Daily trading")

### Add required packages

[Section titled “Add required packages”](#add-required-packages)
...
[Section titled “Enable Logging and Set up OpenAI API Key”](#enable-logging-and-set-up-openai-api-key)
...
[Section titled “Set Up Expected JSON Output Definition (JSON Schema)”](#set-up-expected-json-output-definition-json-schema)
...
[Section titled “Load content from .eml / .msg file”](#load-content-from-eml--msg-file)
...
[Section titled “Use LLM function to extract content in JSON format”](#use-llm-function-to-extract-content-in-json-format)
...
[Section titled “For outlook message”](#for-outlook-message)
