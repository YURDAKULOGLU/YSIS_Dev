...
[Section titled “Define a Workflow”](#define-a-workflow)
...
[Section titled “Define a WorkflowCheckpointer Object”](#define-a-workflowcheckpointer-object)
...
[Section titled “Run the Workflow from the WorkflowCheckpointer”](#run-the-workflow-from-the-workflowcheckpointer)
...
[Section titled “Filtering the Checkpoints”](#filtering-the-checkpoints)
...
[Section titled “Re-Run Workflow from a specific checkpoint”](#re-run-workflow-from-a-specific-checkpoint)
...
Since we’ve executed from the checkpoint that represents the end of “generate\_joke” step, there is only one additional checkpoint (i.e., that for the completion of step “critique\_joke”) that gets stored in the last partial run.

## Specifying Which Steps To Checkpoint

[Section titled “Specifying Which Steps To Checkpoint”](#specifying-which-steps-to-checkpoint)
