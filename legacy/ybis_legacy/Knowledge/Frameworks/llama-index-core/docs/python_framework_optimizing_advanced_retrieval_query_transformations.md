 Query Transformations | LlamaIndex Python Documentation
...
[Section titled “HyDE (Hypothetical Document Embeddings)”](#hyde-hypothetical-document-embeddings)
...
[Section titled “Multi-Step Query Transformations”](#multi-step-query-transformations)
...
![](/python/_astro/multi_step_diagram.LRFzyjJW_ZqhmeQ.webp)
