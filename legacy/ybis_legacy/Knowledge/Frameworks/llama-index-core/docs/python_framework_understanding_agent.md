 Building an agent | LlamaIndex Python Documentation
...
In LlamaIndex, you can either [build your own agentic workflows from scratch](/python/llamaagents/workflows), covered in the “Building Workflows” section, or you can use our pre-built agentic workflows like `FunctionAgent` (a simple function/tool calling agent) or `AgentWorkflow` (an agent capable of managing multiple agents). This tutorial covers building a function calling agent using `FunctionAgent`.
...
![agent flow](/python/_astro/agent_flow.CYyT8PAN_ZtSxHJ.webp)
...
[Section titled “OpenAI Key”](#openai-key)
...
[Section titled “Bring in dependencies”](#bring-in-dependencies)
...
[Section titled “Create basic tools”](#create-basic-tools)
...
[Section titled “Initialize the LLM”](#initialize-the-llm)
