 How to Build a Chatbot | LlamaIndex Python Documentation
...
[Section titled “Ingest Data”](#ingest-data)
...
[Section titled “Setting up Vector Indices for each year”](#setting-up-vector-indices-for-each-year)
...
[Section titled “Setting up a Sub Question Query Engine to Synthesize Answers Across 10-K Filings”](#setting-up-a-sub-question-query-engine-to-synthesize-answers-across-10-k-filings)
...
[Section titled “Setting up the Chatbot Agent”](#setting-up-the-chatbot-agent)
...
[Section titled “Testing the Agent”](#testing-the-agent)
...
[Section titled “Setting up the Chatbot Loop”](#setting-up-the-chatbot-loop)
