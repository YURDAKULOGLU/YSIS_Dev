 Fine-tuning | LlamaIndex Python Documentation
...
[Section titled “Embedding Finetuning Benefits”](#embedding-finetuning-benefits)
...
[Section titled “LLM Finetuning Benefits”](#llm-finetuning-benefits)
...
[Section titled “Integrations with LlamaIndex”](#integrations-with-llamaindex)
...
[Section titled “Finetuning Embeddings”](#finetuning-embeddings)
...
[Section titled “Fine-tuning LLMs”](#fine-tuning-llms)

### Fine-tuning GPT-3.5 to distill GPT-4

[Section titled “Fine-tuning GPT-3.5 to distill GPT-4”](#fine-tuning-gpt-35-to-distill-gpt-4)
...
[Section titled “Fine-tuning for Better Structured Outputs”](#fine-tuning-for-better-structured-outputs)
...
[Section titled “Fine-tuning Llama 2 for Better Text-to-SQL”](#fine-tuning-llama-2-for-better-text-to-sql)
...
[Section titled “Fine-tuning An Evaluator”](#fine-tuning-an-evaluator)
...
[Section titled “Fine-tuning Cross-Encoders for Re-Ranking”](#fine-tuning-cross-encoders-for-re-ranking)
...
[Section titled “Cohere Custom Reranker”](#cohere-custom-reranker)
