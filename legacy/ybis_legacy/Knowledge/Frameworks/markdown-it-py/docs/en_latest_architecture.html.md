Design principles — markdown-it-py
...
* [Suggest edit](https://github.com/executablebooks/markdown-it-py/edit/master/docs/architecture.md "Suggest edit")

* [.md](_sources/architecture.md "Download source file")
* .pdf
...
## Token stream[#](#token-stream "Link to this heading")
...
## Renderer[#](#renderer "Link to this heading")
...
[parser\_core.py](https://github.com/executablebooks/markdown-it-py/tree/master/markdown_it/parser_core.py),
[parser\_block.py](https://github.com/executablebooks/markdown-it-py/tree/master/markdown_it/parser_block.py) and
[parser\_inline.py](https://github.com/executablebooks/markdown-it-py/tree/master/markdown_it/parser_inline.py)
files.
