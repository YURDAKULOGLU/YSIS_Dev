...
* [Suggest edit](https://github.com/executablebooks/markdown-it-py/edit/master/docs/contributing.md "Suggest edit")
...
1. [Architecture description](architecture.html#md-architecture)
2. [Security considerations](security.html#md-security)
3. [API documentation](api/markdown_it.html)

## Development guidance[#](#development-guidance "Link to this heading")
...
### Updating the commonmark specification[#](#updating-the-commonmark-specification "Link to this heading")
...
## Contributing a plugin[#](#contributing-a-plugin "Link to this heading")
...
### I need async rule, how to do it?[#](#i-need-async-rule-how-to-do-it "Link to this heading")
...
### How to replace part of text token with link?[#](#how-to-replace-part-of-text-token-with-link "Link to this heading")
...
### Why is my inline rule not executed?[#](#why-is-my-inline-rule-not-executed "Link to this heading")
