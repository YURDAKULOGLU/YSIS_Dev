...
* [Suggest edit](https://github.com/executablebooks/markdown-it-py/edit/master/docs/performance.md "Suggest edit")

* [.md](_sources/performance.md "Download source file")
* .pdf
...
| --- | --- | --- | --- |
| markdown-it-pyrs[[1]](#id3) | 0.2.1 | 6.410 | 0.426 |
| mistune[[2]](#id4) | 3.0.1 | 80.409 | 2.335 |
...
`markdown-it-pyrs` is a Rust implementation of `markdown-it-py`’s parser, in beta development, check it out at: [chrisjsewell/markdown-it-pyrs](https://github.com/chrisjsewell/markdown-it-pyrs)
