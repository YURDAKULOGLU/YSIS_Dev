...
>>> values = Reference(ws, min\_col=1, min\_row=1, max\_col=1, max\_row=10)
>>> chart = BarChart()
>>> chart.add\_data(values)
>>> ws.add\_chart(chart, "E15")
...
possible; see :mod:`openpyxl.drawing.spreadsheet\_drawing` for further information.
Working with axes
-----------------
.. toctree::
limits\_and\_scaling
secondary
