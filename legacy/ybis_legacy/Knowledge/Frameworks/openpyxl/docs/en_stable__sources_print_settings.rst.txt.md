...
>>> ws = wb.active
>>>
>>> ws.print\_options.horizontalCentered = True
>>> ws.print\_options.verticalCentered = True
Headers and Footers
-------------------
...
>>> ws = wb.active
>>>
>>> ws.print\_title\_cols = 'A:B' # the first two cols
>>> ws.print\_title\_rows = '1:1' # the first row
Add a Print Area
----------------
...
>>> ws.page\_setup.paperSize = ws.PAPERSIZE\_A5
The table size is stored internally as an integer, a number of alias variables are
also available for common sizes (refer to PAPERSIZE\_\* in :mod:`openpyxl.worksheet.worksheet` ).
