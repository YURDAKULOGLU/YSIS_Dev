...
>>> from openpyxl.cell.rich\_text import TextBlock, CellRichText
>>> rich\_string1 = CellRichText(
... 'This is a test ',
...
.. :: doctest
>>> inline\_font = InlineFont(rFont='Calibri', # Font name
...
>>> rich\_string1 = CellRichText(['When the color ', TextBlock(red, 'red'), ' is used, you can expect ', TextBlock(red, 'danger')])
...
.. :: doctest
>>> l = rich\_string1.as\_list()
>>> l
['When the color ', 'red', ' is used, you can expect ', 'danger']
>>> l.index("danger")
3
>>> rich\_string1[3].text = "fun"
>>> str(rich\_string1)
