...
Special formulae
++++++++++++++++
Openpyxl also supports two special kinds of formulae: `Array Formulae `\_ and `Data Table Formulae `\_. Given the frequent use of "data tables" within OOXML the latter are particularly confusing.
