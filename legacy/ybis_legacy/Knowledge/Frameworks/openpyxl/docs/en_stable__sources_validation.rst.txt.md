...
>>> dv = DataValidation(type="list", formula1='"Dog,Cat,Bat"', allow\_blank=True)
>>>
...
::
from openpyxl.utils import quote\_sheetname
dv = DataValidation(type="list",
formula1="{0}!$B$1:$B$10".format(quote\_sheetname(sheetname))
)
Custom rule:
::
