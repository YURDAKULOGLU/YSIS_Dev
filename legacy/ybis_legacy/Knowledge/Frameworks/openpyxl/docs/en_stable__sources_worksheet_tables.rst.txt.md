...
>>> wb = load\_workbook("QueryTable.xlsx")
>>> ws = wb.active
>>> table\_range = ws.tables["InvoiceData"]
>>> ws.print\_area = table\_range.ref # Ref is the cell range the table currently covers