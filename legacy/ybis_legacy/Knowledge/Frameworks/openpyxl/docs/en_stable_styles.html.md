Working with styles — openpyxl 3.1.3 documentation

### Navigation

* [index](genindex.html "General Index")
* [modules](py-modindex.html "Python Module Index") |
* [next](rich_text.html "Working with Rich Text") |
* [previous](usage.html "Simple usage") |
* [openpyxl 3.1.3 documentation](index.html) »
* Working with styles

# Working with styles[](#working-with-styles "Link to this heading")
...
## Cell Styles and Named Styles[](#cell-styles-and-named-styles "Link to this heading")

There are two types of styles: cell styles and named styles, also known as style templates.

### Cell Styles[](#cell-styles "Link to this heading")
...
## Copying styles[](#copying-styles "Link to this heading")
...
## Colours[](#colours "Link to this heading")
...
### aRGB colours[](#argb-colours "Link to this heading")
...
### Indexed Colours[](#indexed-colours "Link to this heading")
...
## Applying Styles[](#applying-styles "Link to this heading")
...
## Columns and Rows[](#columns-and-rows "Link to this heading")
...
Use ws.column\_groups to check.

## Styling Merged Cells[](#styling-merged-cells "Link to this heading")
...
## Using number formats[](#using-number-formats "Link to this heading")
...
## Edit Page Setup[](#edit-page-setup "Link to this heading")
...
### Named Styles[](#named-styles "Link to this heading")
...
## Creating a Named Style[](#creating-a-named-style "Link to this heading")
...
## Using builtin styles[](#using-builtin-styles "Link to this heading")
...
### Number formats[](#number-formats "Link to this heading")
...
### Informative[](#informative "Link to this heading")
...
### Text styles[](#text-styles "Link to this heading")
...
For more information about the builtin styles please refer to the [`openpyxl.styles.builtins`](api/openpyxl.styles.builtins.html#module-openpyxl.styles.builtins "openpyxl.styles.builtins")
...
* [Working with styles](#)
  ...
  + [Cell Styles and Named Styles](#cell-styles-and-named-styles)
    - [Cell Styles](#cell-styles)
  + [Copying styles](#copying-styles)
  + [Colours](#colours)
    - [aRGB colours](#argb-colours)
    - [Indexed Colours](#indexed-colours)
  ...
  + [Edit Page Setup](#edit-page-setup)
    - [Named Styles](#named-styles)
  + [Creating a Named Style](#creating-a-named-style)
  + [Using builtin styles](#using-builtin-styles)
...
[Simple usage](usage.html "previous chapter")

#### Next topic

[Working with Rich Text](rich_text.html "next chapter")

### This Page

* [Show Source](_sources/styles.rst.txt)
