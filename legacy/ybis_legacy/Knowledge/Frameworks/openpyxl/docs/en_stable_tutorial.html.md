...
* [next](usage.html "Simple usage") |
* [previous](index.html "openpyxl - A Python library to read/write Excel 2010 xlsx/xlsm files") |
...
There is support for the popular [lxml](http://lxml.de) library which will be used if it
...
### Working with a checkout[](#working-with-a-checkout "Link to this heading")
...
## Create a workbook[](#create-a-workbook "Link to this heading")
...
## Playing with data[](#playing-with-data "Link to this heading")

### Accessing one cell[](#accessing-one-cell "Link to this heading")
...
### Accessing many cells[](#accessing-many-cells "Link to this heading")
...
### Values only[](#values-only "Link to this heading")
...
### Saving to a file[](#saving-to-a-file "Link to this heading")
...
### Saving as a stream[](#saving-as-a-stream "Link to this heading")
...
## Loading from a file[](#loading-from-a-file "Link to this heading")
...
## Errors loading workbooks[](#errors-loading-workbooks "Link to this heading")
...
This ends the tutorial for now, you can proceed to the [Simple usage](usage.html) section
...
* [Tutorial](#)
  + [Installation](#installation)
    - [Working with a checkout](#working-with-a-checkout)
  ...
  + [Data storage](#data-storage)
    ...
    - [Saving as a stream](#saving-as-a-stream)
  + [Loading from a file](#loading-from-a-file)
  + [Errors loading workbooks](#errors-loading-workbooks)

#### Previous topic

[openpyxl - A Python library to read/write Excel 2010 xlsx/xlsm files](index.html "previous chapter")

#### Next topic

[Simple usage](usage.html "next chapter")

### This Page

* [Show Source](_sources/tutorial.rst.txt)
