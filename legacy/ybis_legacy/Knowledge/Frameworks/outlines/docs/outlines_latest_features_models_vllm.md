...
If you want to use the vllm offline inference mode instead of the server mode, please refer to the [VLLMOffline](../vllm_offline/) model documentation.
