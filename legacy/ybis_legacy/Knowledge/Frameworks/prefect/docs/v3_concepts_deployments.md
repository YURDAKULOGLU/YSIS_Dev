...
* [Work pool-based deployment requirements](#work-pool-based-deployment-requirements)
* [Run a deployment](#run-a-deployment)
* [Work pools that require a worker](#work-pools-that-require-a-worker)
* [Work pools that don’t require a worker](#work-pools-that-don%E2%80%99t-require-a-worker)
* [Static vs. dynamic infrastructure](#static-vs-dynamic-infrastructure)
...
* [Required defining data](#required-defining-data)
* [Workflow scheduling and parametrization](#workflow-scheduling-and-parametrization)
* [Concurrency limiting](#concurrency-limiting)
* [Metadata for bookkeeping](#metadata-for-bookkeeping)
* [Worker-specific fields](#worker-specific-fields)
...
### [​](#work-pools-that-don’t-require-a-worker) Work pools that don’t require a worker
...
**You don’t have to commit to one approach**You can mix and match approaches based on the needs of each flow. You can also change the
...
**Deployments do not contain code definitions**Deployment metadata references code that exists in potentially diverse locations within your environment.
...
**Scheduling is asynchronous and decoupled**Pausing a schedule, updating your deployment, and other actions reset your auto-scheduled runs.
...
**Everything has a version**Deployments have a version attached; and flows and tasks also have
...
[Tag-based concurrency limits](/v3/concepts/tag-based-concurrency-limits)[Schedules](/v3/concepts/schedules)
