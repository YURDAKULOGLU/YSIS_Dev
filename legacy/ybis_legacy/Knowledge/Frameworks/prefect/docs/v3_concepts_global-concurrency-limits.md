...
* [What are global concurrency limits?](#what-are-global-concurrency-limits)
* [Concurrency limits vs rate limits](#concurrency-limits-vs-rate-limits)
* [When to use each](#when-to-use-each)
* [How global concurrency limits work](#how-global-concurrency-limits-work)
* [Slot-based system](#slot-based-system)
* [Timed leases](#timed-leases)
* [Active and inactive states](#active-and-inactive-states)
* [Slot decay](#slot-decay)
* [Comparison with other concurrency controls](#comparison-with-other-concurrency-controls)
* [Use cases](#use-cases)
...
[Task runners](/v3/concepts/task-runners)[Tag-based concurrency limits](/v3/concepts/tag-based-concurrency-limits)
