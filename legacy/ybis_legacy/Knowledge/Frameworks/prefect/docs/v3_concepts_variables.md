...
* [Through the Prefect UI](#through-the-prefect-ui)
* [Through the Python SDK](#through-the-python-sdk)
* [Through the REST API](#through-the-rest-api)
* [Through the CLI](#through-the-cli)
* [Through Terraform](#through-terraform)
...
**Variables are not Encrypted**We do not recommend using variables to store sensitive information. Instead, use
...
You can manage variables with the [Prefect API](https://app.prefect.cloud/api/docs#tag/Variables).

### [​](#through-the-cli) Through the CLI

You can manage variables with the [Prefect CLI](https://docs.prefect.io/v3/api-ref/cli/variable).
...
You can manage variables with the [Terraform provider for Prefect](https://registry.terraform.io/providers/PrefectHQ/prefect/latest/docs/resources/variable).

Was this page helpful?

YesNo

[Workers](/v3/concepts/workers)[Blocks](/v3/concepts/blocks)
