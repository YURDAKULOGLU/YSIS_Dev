...
Learn how to write and customize your Prefect workflows.](/v3/how-to-guides/workflows)[## Deployments

Learn how to deploy and manage your workflows as Prefect deployments.](/v3/how-to-guides/deployments)[## Configuration

Learn how to configure your Prefect environment.](/v3/how-to-guides/configuration)[## Automations

Learn how to work with events, triggers, and automations.](/v3/how-to-guides/automations)[## Workflow Infrastructure

Learn how to deploy your workflows to specific infrastructure.](/v3/how-to-guides/deployment_infra)[## Prefect Cloud

Learn how to set up your Prefect Cloud account.](/v3/how-to-guides/cloud)[## Prefect Self-hosted

Learn how to host your own Prefect server.](/v3/how-to-guides/self-hosted)[## AI

Learn how to integrate AI assistants with Prefect.](/v3/how-to-guides/ai)[## Migrate

Learn how to migrate from other platforms and upgrade to the latest versions of Prefect.](/v3/how-to-guides/migrate)
