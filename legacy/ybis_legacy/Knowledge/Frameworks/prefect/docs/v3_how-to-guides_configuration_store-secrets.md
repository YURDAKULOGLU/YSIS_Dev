...
* [Store secret strings](#store-secret-strings)
* [Store common configuration securely](#store-common-configuration-securely)
...
[Override Job Configuration](/v3/how-to-guides/deployments/customize-job-variables)[Share configuration between workflows](/v3/how-to-guides/configuration/variables)
