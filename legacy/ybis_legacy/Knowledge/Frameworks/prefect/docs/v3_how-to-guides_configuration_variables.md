How to share configuration between workflows - Prefect
...
* [Use variables in prefect.yaml deployment steps](#use-variables-in-prefect-yaml-deployment-steps)
...
**Contextual Behavior**In a sync context (such as an `if __name__ == "__main__"` block or simple `def` scope), these methods are used synchronously.
...
[Store secrets](/v3/how-to-guides/configuration/store-secrets)[Manage settings](/v3/how-to-guides/configuration/manage-settings)
