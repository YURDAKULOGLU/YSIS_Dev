Trigger ad-hoc deployment runs - Prefect
...
* [Run a deployment from the CLI](#run-a-deployment-from-the-cli)
* [CLI options](#cli-options)
* [Run a deployment from Python](#run-a-deployment-from-python)
...
[Create Deployments](/v3/how-to-guides/deployments/create-deployments)[Create Deployment Schedules](/v3/how-to-guides/deployments/create-schedules)
