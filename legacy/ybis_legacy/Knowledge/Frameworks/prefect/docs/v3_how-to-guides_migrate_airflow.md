How to Migrate from Airflow - Prefect
...
* [Converting DAGs to Prefect Flows](#converting-dags-to-prefect-flows)
* [Choose a DAG to convert](#choose-a-dag-to-convert)
* [Create equivalent Prefect tasks](#create-equivalent-prefect-tasks)
* [Define a Prefect flow](#define-a-prefect-flow)
* [Branching and conditional logic](#branching-and-conditional-logic)
* [Retries and error handling](#retries-and-error-handling)
* [Remove Airflow-specific code](#remove-airflow-specific-code)
* [Validate functional equivalence](#validate-functional-equivalence)
* [Infrastructure Migration Considerations](#infrastructure-migration-considerations)
* [Leveraging Prefect Managed Execution](#leveraging-prefect-managed-execution)
* [Airflow Executors](#airflow-executors)
* [Airflow LocalExecutor](#airflow-localexecutor)
* [Airflow CeleryExecutor](#airflow-celeryexecutor)
* [Airflow KubernetesExecutor](#airflow-kubernetesexecutor)
* [Airflow CeleryKubernetes](#airflow-celerykubernetes)
* [Using Serverless compute](#using-serverless-compute)
* [Airflow Sensors](#airflow-sensors)
* [Airflow Hooks and Integrations](#airflow-hooks-and-integrations)
* [Observability](#observability)
* [State and logging](#state-and-logging)
* [Monitoring](#monitoring)
* [Deployment & CI/CD Changes](#deployment-%26-ci%2Fcd-changes)
* [Prefect Deployment](#prefect-deployment)
* [Automation via CI/CD](#automation-via-ci%2Fcd)
* [Prefect in Production](#prefect-in-production)
* [Testing & Validation](#testing-%26-validation)
* [Common issues and troubleshooting](#common-issues-and-troubleshooting)
* [Post-Migration](#post-migration)
* [Optimizing & Scaling Prefect Workflows](#optimizing-%26-scaling-prefect-workflows)
...
## [​](#deployment-&-ci/cd-changes) Deployment & CI/CD Changes
...
### [​](#automation-via-ci/cd) Automation via CI/CD
...
![MarvinAI](https://mintcdn.com/prefect-bd373955/dwD6EJObIjtIzwSC/v3/img/ui/marvin-ai.png?fit=max&auto=format&n=dwD6EJObIjtIzwSC&q=85&s=fe0535a244c49db9646518e953ef0965)
...
### [​](#optimizing-&-scaling-prefect-workflows) Optimizing & Scaling Prefect Workflows
...
[Use the Prefect MCP server](/v3/how-to-guides/ai/use-prefect-mcp-server)[Upgrade to Prefect 3.0](/v3/how-to-guides/migrate/upgrade-to-prefect-3)
