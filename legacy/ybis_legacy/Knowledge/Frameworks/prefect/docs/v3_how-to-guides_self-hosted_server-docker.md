How to run the Prefect server in Docker - Prefect
...
[Run a local Prefect server](/v3/how-to-guides/self-hosted/server-cli)[Run Prefect on Windows](/v3/how-to-guides/self-hosted/server-windows)
