How to pass inputs to a workflow - Prefect
...
* [Define workflow inputs](#define-workflow-inputs)
...
[Customize workflow metadata](/v3/how-to-guides/workflows/custom-metadata)[Add logging](/v3/how-to-guides/workflows/add-logging)
