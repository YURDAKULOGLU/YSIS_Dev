How to run tasks background tasks - Prefect
...
* [Start a background task worker](#start-a-background-task-worker)
* [Trigger a background task](#trigger-a-background-task)
* [Start a worker to run background tasks for multiple functions](#start-a-worker-to-run-background-tasks-for-multiple-functions)
* [Submit multiple background tasks](#submit-multiple-background-tasks)
...
[Cache workflow step outputs](/v3/how-to-guides/workflows/cache-workflow-steps)[Respond to state changes](/v3/how-to-guides/workflows/state-change-hooks)
