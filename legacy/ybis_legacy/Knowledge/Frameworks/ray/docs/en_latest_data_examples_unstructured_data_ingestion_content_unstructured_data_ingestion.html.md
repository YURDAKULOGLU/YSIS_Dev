Unstructured Data Ingestion and Processing With Ray Data — Ray 2.53.0
...
# Unstructured Data Ingestion and Processing With Ray Data[#](#unstructured-data-ingestion-and-processing-with-ray-data "Link to this heading")

[![](https://img.shields.io/badge/🚀 Run_on-Anyscale-9hf)](https://console.anyscale.com/template-preview/unstructured_data_ingestion) 
[![](https://img.shields.io/static/v1?label=&message=View%20On%20GitHub&color=586069&logo=github&labelColor=2f363d)](https://github.com/ray-project/ray/tree/master/doc/source/data/examples/unstructured_data_ingestion/content)
...
## Prerequisites checklist[#](#prerequisites-checklist "Link to this heading")
...
### Install system dependencies[#](#install-system-dependencies "Link to this heading")
...
### Install Python dependencies[#](#install-python-dependencies "Link to this heading")
...
## Step 1: Data Lake Document Discovery[#](#step-1-data-lake-document-discovery "Link to this heading")

### Discover document collections in data lake[#](#discover-document-collections-in-data-lake "Link to this heading")
...
### Document metadata extraction[#](#document-metadata-extraction "Link to this heading")
...
## Step 2: Document processing and classification[#](#step-2-document-processing-and-classification "Link to this heading")

### Text extraction and quality assessment[#](#text-extraction-and-quality-assessment "Link to this heading")
...
## Step 3: Text chunking and enrichment[#](#step-3-text-chunking-and-enrichment "Link to this heading")
...
## Step 4: Data warehouse schema and output[#](#step-4-data-warehouse-schema-and-output "Link to this heading")

### Create data warehouse schema[#](#create-data-warehouse-schema "Link to this heading")
...
### Write to data warehouse with partitioning[#](#write-to-data-warehouse-with-partitioning "Link to this heading")
...
### Create analytics summary tables[#](#create-analytics-summary-tables "Link to this heading")
...
### Verify data warehouse outputs[#](#verify-data-warehouse-outputs "Link to this heading")
...
### Ray Data operations you used[#](#ray-data-operations-you-used "Link to this heading")
...
### Key concepts for beginners[#](#key-concepts-for-beginners "Link to this heading")

**1. Distributed processing**

* Your code runs on a cluster of machines (not just one)
* Ray Data automatically distributes work across workers
* Each function (process\_file, assess\_quality) runs in parallel
...
### Implementation patterns applied[#](#implementation-patterns-applied "Link to this heading")
...
### What you learned[#](#what-you-learned "Link to this heading")
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/data/examples/unstructured_data_ingestion/content/unstructured_data_ingestion.ipynb)