Batch Inference with LoRA Adapters — Ray 2.53.0
...
# Batch Inference with LoRA Adapters[#](#batch-inference-with-lora-adapters "Link to this heading")
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/llm/examples/batch/vllm-with-lora.ipynb)