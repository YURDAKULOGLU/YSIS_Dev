Building Ray from Source — Ray 2.53.0
...
If you are only editing Python files, follow instructions for [Building Ray (Python Only)](#python-develop) to avoid long build times.

If you already followed the instructions in [Building Ray (Python Only)](#python-develop) and want to switch to the Full build in this section, you will need to first uninstall.

## [Fork the Ray repository](#id1)[#](#fork-the-ray-repository "Link to this heading")
...
## [Prepare a Python virtual environment](#id2)[#](#prepare-a-python-virtual-environment "Link to this heading")
...
## [Building Ray (Python Only)](#id3)[#](#building-ray-python-only "Link to this heading")
...
3. Pip install the **latest Ray wheels.** See [Daily Releases (Nightlies)](../ray-overview/installation.html#install-nightlies) for instructions.
...
## [Preparing to build Ray on Linux](#id4)[#](#preparing-to-build-ray-on-linux "Link to this heading")

Tip

If you are only editing Tune/RLlib/Autoscaler files, follow instructions for [Building Ray (Python Only)](#python-develop) to avoid long build times.
...
## [Preparing to build Ray on MacOS](#id5)[#](#preparing-to-build-ray-on-macos "Link to this heading")
...
## [Building Ray on Linux & MacOS (full)](#id6)[#](#building-ray-on-linux-macos-full "Link to this heading")

Make sure you have a local clone of Ray’s git repository as explained above. You will also need to install [NodeJS](https://nodejs.org) to build the dashboard.
...
## [Building Ray on Windows (full)](#id7)[#](#building-ray-on-windows-full "Link to this heading")
...
* Bazel 6.5.0 ([bazelbuild/bazel](https://github.com/bazelbuild/bazel/releases/tag/6.5.0))
...
* Miniforge 3 ([conda-forge/miniforge](https://github.com/conda-forge/miniforge/blob/main/README.md))
...
bazel-4.2.1-windows-x86\_64.exe. Copy the exe into the directory of your choice.
Define an environment variable BAZEL\_PATH to full exe path (example:
...
## [Environment variables that influence builds](#id8)[#](#environment-variables-that-influence-builds "Link to this heading")
...
## [Installing additional dependencies for development](#id9)[#](#installing-additional-dependencies-for-development "Link to this heading")
...
## [Pre-commit Hooks](#id10)[#](#pre-commit-hooks "Link to this heading")
...
If you encounter any issues with `pre-commit`, please [report an issue here](https://github.com/ray-project/ray/issues/new?template=bug-report.yml).

## [Fast, Debug, and Optimized Builds](#id11)[#](#fast-debug-and-optimized-builds "Link to this heading")
...
## [Building the Docs](#id12)[#](#building-the-docs "Link to this heading")

To learn more about building the docs refer to [Contributing to the Ray Documentation](https://docs.ray.io/en/master/ray-contribute/docs.html).

## [Using a local repository for dependencies](#id13)[#](#using-a-local-repository-for-dependencies "Link to this heading")
...
## [Troubleshooting](#id14)[#](#troubleshooting "Link to this heading")
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/ray-contribute/development.rst)