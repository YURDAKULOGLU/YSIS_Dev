Monitoring with the CLI or SDK — Ray 2.53.0
...
# Monitoring with the CLI or SDK[#](#monitoring-with-the-cli-or-sdk "Link to this heading")

Monitoring and debugging capabilities in Ray are available through a CLI or SDK.

## CLI command `ray status`[#](#cli-command-ray-status "Link to this heading")
...
## Ray State CLI and SDK[#](#ray-state-cli-and-sdk "Link to this heading")

Tip

Provide feedback on using Ray state APIs - [feedback form](https://forms.gle/gh77mwjEskjhN8G46)!
...
State API CLI commands are [stable](../../ray-contribute/stability.html#api-stability-stable), while Python SDKs are [DeveloperAPI](../../ray-contribute/stability.html#developer-api-def). CLI usage is recommended over Python SDKs.
...
#### Getting a summary of states of entities by type[#](#getting-a-summary-of-states-of-entities-by-type "Link to this heading")
...
See [state CLI reference](../reference/cli.html#state-api-cli-ref) for more details about `ray summary` command.

#### List the states of all entities of certain type[#](#list-the-states-of-all-entities-of-certain-type "Link to this heading")

Get a list of resources. Possible resources include:

* [Actors](../../ray-core/actors.html#actor-guide), e.g., Actor ID, State, PID, death\_cause ([`output schema`](../reference/doc/ray.util.state.common.ActorState.html#ray.util.state.common.ActorState "ray.util.state.common.ActorState"))
* [Tasks](../../ray-core/tasks.html#ray-remote-functions), e.g., name, scheduling state, type, runtime env info ([`output schema`](../reference/doc/ray.util.state.common.TaskState.html#ray.util.state.common.TaskState "ray.util.state.common.TaskState"))
* [Objects](../../ray-core/objects.html#objects-in-ray), e.g., object ID, callsites, reference types ([`output schema`](../reference/doc/ray.util.state.common.ObjectState.html#ray.util.state.common.ObjectState "ray.util.state.common.ObjectState"))
* [Jobs](../../cluster/running-applications/job-submission/index.html#jobs-overview), e.g., start/end time, entrypoint, status ([`output schema`](../reference/doc/ray.util.state.common.JobState.html#ray.util.state.common.JobState "ray.util.state.common.JobState"))
* [Placement Groups](../../ray-core/scheduling/placement-group.html#ray-placement-group-doc-ref), e.g., name, bundles, stats ([`output schema`](../reference/doc/ray.util.state.common.PlacementGroupState.html#ray.util.state.common.PlacementGroupState "ray.util.state.common.PlacementGroupState"))
* Nodes (Ray worker nodes), e.g., node ID, node IP, node state ([`output schema`](../reference/doc/ray.util.state.common.NodeState.html#ray.util.state.common.NodeState "ray.util.state.common.NodeState"))
* Workers (Ray worker processes), e.g., worker ID, type, exit type and details ([`output schema`](../reference/doc/ray.util.state.common.WorkerState.html#ray.util.state.common.WorkerState "ray.util.state.common.WorkerState"))
* [Runtime environments](../../ray-core/handling-dependencies.html#runtime-environments), e.g., runtime envs, creation time, nodes ([`output schema`](../reference/doc/ray.util.state.common.RuntimeEnvState.html#ray.util.state.common.RuntimeEnvState "ray.util.state.common.RuntimeEnvState"))
...
See [state CLI reference](../reference/cli.html#state-api-cli-ref) for more details about `ray list` command.

#### Get the states of a particular entity (task, actor, etc.)[#](#get-the-states-of-a-particular-entity-task-actor-etc "Link to this heading")
...
See [state CLI reference](../reference/cli.html#state-api-cli-ref) for more details about `ray get` command.

#### Fetch the logs of a particular entity (task, actor, etc.)[#](#fetch-the-logs-of-a-particular-entity-task-actor-etc "Link to this heading")
...
See [state CLI reference](../reference/cli.html#state-api-cli-ref) for more details about `ray logs` command.

#### Failure Semantics[#](#failure-semantics "Link to this heading")
...
* For the CLI Reference, see [State CLI Reference](../reference/cli.html#state-api-cli-ref).
* For the SDK Reference, see [State API Reference](../reference/api.html#state-api-ref).
* For the Log CLI Reference, see [Log CLI Reference](../reference/cli.html#ray-logs-api-cli-ref).

## Using Ray CLI tools from outside the cluster[#](#using-ray-cli-tools-from-outside-the-cluster "Link to this heading")
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/ray-observability/user-guides/cli-sdk.rst)