Audio batch inference — Ray 2.53.0
...
# Audio batch inference[#](#audio-batch-inference "Link to this heading")

[![](https://img.shields.io/badge/🚀 Run_on-Anyscale-9hf)](https://console.anyscale.com/) 
[![](https://img.shields.io/static/v1?label=&message=View%20On%20GitHub&color=586069&logo=github&labelColor=2f363d)](https://github.com/anyscale/e2e-audio)
...
## Streaming data ingestion[#](#streaming-data-ingestion "Link to this heading")
...
## Audio preprocessing[#](#audio-preprocessing "Link to this heading")
...
## GPU inference with Whisper[#](#gpu-inference-with-whisper "Link to this heading")
...
## LLM-based quality filter[#](#llm-based-quality-filter "Link to this heading")
...
## Persist the curated subset[#](#persist-the-curated-subset "Link to this heading")
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/ray-overview/examples/e2e-audio/README.ipynb)