...
## What’s Ray?[#](#whats-ray "Link to this heading")
...
## Choose Your Path[#](#choose-your-path "Link to this heading")
...
![Ray Framework Architecture](../_images/map-of-ray.svg)

## Ray AI Libraries Quickstart[#](#ray-ai-libraries-quickstart "Link to this heading")
...
[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Data: Scalable Data Processing for AI Workloads

[Ray Data](../data/quickstart.html#data-quickstart) provides distributed data processing capabilities for AI workloads. It efficiently streams data through data pipelines.
...
[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Train: Distributed Model Training
...
[![Try Ray on Anyscale](../_static/img/try-ray-on-anyscale.svg)](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=ray-doc-upsell&utm_content=get-started-train-torch)
...
[![Try Ray on Anyscale](../_static/img/try-ray-on-anyscale.svg)](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=ray-doc-upsell&utm_content=get-started-train-tf)

[Learn more about Ray Train](../train/train.html)

[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Tune: Hyperparameter Tuning at Scale

[Ray Tune](../tune/index.html) is a library for hyperparameter tuning at any scale.
...
[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Serve: Scalable Model Serving

[Ray Serve](../serve/index.html) provides scalable and programmable serving for ML models and business logic. Deploy models from any framework with production-ready performance.
...
[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) RLlib: Industry-Grade Reinforcement Learning

[RLlib](../rllib/index.html) is a reinforcement learning (RL) library that offers high performance implementations of popular RL algorithms and supports various training environments. RLlib offers high scalability and unified APIs for a variety of industry- and research applications.
...
## Ray Core Quickstart[#](#ray-core-quickstart "Link to this heading")

[![try-anyscale-quickstart-ray-quickstart](../_static/img/run-on-anyscale.svg)](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=ray-core-quickstart&redirectTo=/v2/template-preview/workspace-intro)
...
[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Core: Parallelizing Functions with Ray Tasks
...
[Learn more about Ray Core](../ray-core/walkthrough.html)

[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Core: Parallelizing Classes with Ray Actors
...
## Ray Cluster Quickstart[#](#ray-cluster-quickstart "Link to this heading")

Deploy your applications on Ray clusters on AWS, GCP, Azure, and more, often with minimal code changes to your existing code.

[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Clusters: Launching a Ray Cluster on AWS
...
[Learn more about launching Ray Clusters on AWS, GCP, Azure, and more](../cluster/getting-started.html#cluster-index)

[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Clusters: Launching a Ray Cluster on Kubernetes

Ray programs can run on a single node Kubernetes cluster, or seamlessly scale to larger clusters.

[Learn more about launching Ray Clusters on Kubernetes](../cluster/kubernetes/index.html#kuberay-index)

[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Clusters: Launching a Ray Cluster on Anyscale
...
[Try Ray on Anyscale](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=ray-doc-upsell&utm_content=get-started-launch-ray-cluster)

## Debugging and Monitoring Quickstart[#](#debugging-and-monitoring-quickstart "Link to this heading")
...
[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Ray Dashboard: Web GUI to monitor and debug Ray
...
![https://raw.githubusercontent.com/ray-project/Images/master/docs/new-dashboard/Dashboard-overview.png](https://raw.githubusercontent.com/ray-project/Images/master/docs/new-dashboard/Dashboard-overview.png)
...
[Learn more about Ray Dashboard](../ray-observability/getting-started.html#observability-getting-started)

[![ray](../_images/ray_svg_logo.svg)](../_images/ray_svg_logo.svg) Ray State APIs: CLI to access cluster states
...
[Learn more about Ray State APIs](../ray-observability/user-guides/cli-sdk.html#observability-programmatic)
...
### Blog and Press[#](#blog-and-press "Link to this heading")
...
### Slides[#](#slides "Link to this heading")
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/ray-overview/getting-started.md)