Ray Serve: Scalable and Programmable Serving — Ray 2.53.0
...
# Ray Serve: Scalable and Programmable Serving[#](#ray-serve-scalable-and-programmable-serving "Link to this heading")

[![../_images/logo.svg](../_images/logo.svg)](../_images/logo.svg)
...
Ray Serve is particularly well suited for [model composition](model_composition.html#serve-model-composition) and multi-model serving, enabling you to build a complex inference service consisting of multiple ML models and business logic all in Python code.
...
## Why choose Serve?[#](#why-choose-serve "Link to this heading")
...
You can combine multiple ML models, business logic, and expressive HTTP handling using Serve’s FastAPI integration (see [FastAPI HTTP Deployments](http-guide.html#serve-fastapi-http)) to build your entire application as one Python program.
...
The models can use different resources and run across different machines in the cluster, but you can write it like a regular program. See [Deploy Compositions of Models](model_composition.html#serve-model-composition) for more details.
...
## How can Serve help me as a…[#](#how-can-serve-help-me-as-a "Link to this heading")
...
## How does Serve compare to …[#](#how-does-serve-compare-to "Link to this heading")
...
You can use the Ray [cluster launcher](../cluster/getting-started.html#cluster-index) to deploy Ray Serve to all major public clouds, K8s, as well as on bare-metal, on-premise machines.
...
When it’s time to deploy, you can use our [Kubernetes Operator](../cluster/kubernetes/getting-started.html#kuberay-quickstart)
...
Check out [Getting Started](getting_started.html#serve-getting-started) and [Key Concepts](key-concepts.html#serve-key-concepts),
or head over to the [Examples](examples.html) to get started building your Ray Serve applications.

**Getting Started**

Start with our quick start tutorials for [deploying a single model locally](getting_started.html#serve-getting-started) and how to [convert an existing model into a Ray Serve deployment](getting_started.html#converting-to-ray-serve-application).

[Get Started with Ray Serve](getting_started.html#serve-getting-started)

**Key Concepts**

Understand the key concepts behind Ray Serve.
Learn about [Deployments](key-concepts.html#serve-key-concepts-deployment), [how to query them](key-concepts.html#serve-key-concepts-ingress-deployment), and using [DeploymentHandles](key-concepts.html#serve-key-concepts-deployment-handle) to compose multiple models and business logic together.

[Learn Key Concepts](key-concepts.html#serve-key-concepts)

**Examples**

Follow the tutorials to learn how to integrate Ray Serve with [TensorFlow](tutorials/serve-ml-models.html#serve-ml-models-tutorial), and [Scikit-Learn](tutorials/serve-ml-models.html#serve-ml-models-tutorial).

[Serve Examples](examples.html)

**API Reference**

Get more in-depth information about the Ray Serve API.

[Read the API Reference](api/index.html#serve-api)
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/serve/index.md)