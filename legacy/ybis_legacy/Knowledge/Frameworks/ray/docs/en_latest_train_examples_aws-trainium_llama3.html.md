Distributed fine-tuning of Llama 3.1 8B on AWS Trainium with Ray and PyTorch Lightning — Ray 2.53.0
...
# Distributed fine-tuning of Llama 3.1 8B on AWS Trainium with Ray and PyTorch Lightning[#](#distributed-fine-tuning-of-llama-3-1-8b-on-aws-trainium-with-ray-and-pytorch-lightning "Link to this heading")

[![Run on Anyscale](../../../_static/img/run-on-anyscale.svg)](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=aws-trainium-llama3)
...
## Prepare the environment[#](#prepare-the-environment "Link to this heading")

See [Setup EKS cluster and tools](https://github.com/aws-neuron/aws-neuron-eks-samples/tree/master/llama3.1_8B_finetune_ray_ptl_neuron#setupeksclusterandtools) for setting up an Amazon EKS cluster leveraging AWS Trainium instances.

## Create a Docker image[#](#create-a-docker-image "Link to this heading")
...
Replace the <AWS\_ACCOUNT\_ID> and <REGION> placeholders with actual values in the `1-llama3-finetune-trn1-create-raycluster.yaml` file using commands below to reflect the ECR image ARN created above:
...
## Configuring Ray Cluster[#](#configuring-ray-cluster "Link to this heading")
...
## Accessing Ray Dashboard[#](#accessing-ray-dashboard "Link to this heading")
...
## Launching Ray Jobs[#](#launching-ray-jobs "Link to this heading")
...
For detailed information on each of the steps above, see the [AWS documentation link](https://github.com/aws-neuron/aws-neuron-eks-samples/blob/master/llama3.1_8B_finetune_ray_ptl_neuron/README.md/).

On this page

[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/train/examples/aws-trainium/llama3.rst)