Get started with PyTorch Fully Sharded Data Parallel (FSDP2) and Ray Train — Ray 2.53.0
...
# Get started with PyTorch Fully Sharded Data Parallel (FSDP2) and Ray Train[#](#get-started-with-pytorch-fully-sharded-data-parallel-fsdp2-and-ray-train "Link to this heading")
...
## Example overview[#](#example-overview "Link to this heading")
...
## 1. Package and model setup[#](#package-and-model-setup "Link to this heading")
...
## 2. Define the training function[#](#define-the-training-function "Link to this heading")
...
## 3. Model sharding with FSDP2[#](#model-sharding-with-fsdp2 "Link to this heading")
...
### Device mesh configuration[#](#device-mesh-configuration "Link to this heading")
...
### `reshard_after_forward` flag[#](#reshard-after-forward-flag "Link to this heading")
...
### Combining Memory Strategies[#](#combining-memory-strategies "Link to this heading")
...
## 4. Distributed Checkpointing[#](#distributed-checkpointing "Link to this heading")
...
### Distributed checkpoint wrapper setup[#](#distributed-checkpoint-wrapper-setup "Link to this heading")
...
### Load distributed model from checkpoint[#](#load-distributed-model-from-checkpoint "Link to this heading")
...
### Save model checkpoints[#](#save-model-checkpoints "Link to this heading")
...
### Save the model for inference[#](#save-the-model-for-inference "Link to this heading")
...
## Launching the distributed training job[#](#launching-the-distributed-training-job "Link to this heading")
...
## GPU memory profiling[#](#gpu-memory-profiling "Link to this heading")
...
### Post training directory view[#](#post-training-directory-view "Link to this heading")
...
## Loading the trained model for inference[#](#loading-the-trained-model-for-inference "Link to this heading")
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/train/examples/pytorch/pytorch-fsdp/README.ipynb)