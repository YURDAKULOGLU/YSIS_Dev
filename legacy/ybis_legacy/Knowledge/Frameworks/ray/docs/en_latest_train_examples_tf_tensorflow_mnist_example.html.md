Training with TensorFlow and Ray Train — Ray 2.53.0
...
# Training with TensorFlow and Ray Train[#](#training-with-tensorflow-and-ray-train "Link to this heading")

[![Run on Anyscale](../../../_static/img/run-on-anyscale.svg)](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=tensorflow_mnist_example)
...
* [Distributed Tensorflow & Keras](../../distributed-tensorflow-keras.html#train-tensorflow-overview) for a tutorial.

On this page

[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/train/examples/tf/tensorflow_mnist_example.rst)