Using RLlib with Tune — Ray 2.53.0
...
# Using RLlib with Tune[#](#using-rllib-with-tune "Link to this heading")

[![try-anyscale-quickstart](../../_static/img/run-on-anyscale.svg)](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=ray-tune-pbt_ppo_example)
  
[![RLlib Logo](../../_images/rllib-logo.png)](https://docs.ray.io)

## Example[#](#example "Link to this heading")

Example of using a Tune scheduler ([Population Based Training](../api/schedulers.html#tune-scheduler-pbt)) with RLlib.
...
## More RLlib Examples[#](#more-rllib-examples "Link to this heading")

* [PB2 PPO Example](includes/pb2_ppo_example.html):
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/tune/examples/pbt_ppo_example.ipynb)