Using Huggingface Transformers with Tune — Ray 2.53.0
...
# Using Huggingface Transformers with Tune[#](#using-huggingface-transformers-with-tune "Link to this heading")

[![try-anyscale-quickstart](../../_static/img/run-on-anyscale.svg)](https://console.anyscale.com/register/ha?render_flow=ray&utm_source=ray_docs&utm_medium=docs&utm_campaign=ray-tune-pbt_transformers)
  
[![Huggingface Logo](../../_images/hugging.png)](https://huggingface.com)
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/tune/examples/pbt_transformers.ipynb)