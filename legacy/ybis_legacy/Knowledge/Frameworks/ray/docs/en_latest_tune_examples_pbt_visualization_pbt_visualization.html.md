Visualizing Population Based Training (PBT) Hyperparameter Optimization — Ray 2.53.0
...
# Visualizing Population Based Training (PBT) Hyperparameter Optimization[#](#visualizing-population-based-training-pbt-hyperparameter-optimization "Link to this heading")

**Assumptions:** The reader has a basic understanding of the [PBT algorithm](https://www.deepmind.com/blog/population-based-training-of-neural-networks) and wants to dive deeper and verify the underlying algorithm behavior with [Ray’s PBT implementation](../../api/schedulers.html#tune-scheduler-pbt). [This guide](../pbt_guide.html#pbt-guide-ref) provides resources for gaining some context.
...
## Set up Toy the Example[#](#set-up-toy-the-example "Link to this heading")
...
Note: this tutorial imports functions from [this helper file](pbt_visualization_utils.html) named `pbt_visualization_utils.py`. These define plotting functions for the PBT training progress.
...
## Defining the Function Trainable[#](#defining-the-function-trainable "Link to this heading")
...
## Configure PBT and Tuner[#](#configure-pbt-and-tuner "Link to this heading")
...
### Create the PBT scheduler[#](#create-the-pbt-scheduler "Link to this heading")
...
### Create the Tuner[#](#create-the-tuner "Link to this heading")
...
## Run the experiment[#](#run-the-experiment "Link to this heading")
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| train\_func\_74757\_00000 | TERMINATED | 127.0.0.1:23555 | 0.89156 | 100 | 0.0432718 | 1.19993 | 0.00573655 | 0.00685687 |
| train\_func\_74757\_00001 | TERMINATED | 127.0.0.1:23556 | 1.11445 | 100 | 0.0430496 | 1.19995 | 0.0038124 | 0.00615009 |
...
## Visualize results[#](#visualize-results "Link to this heading")

Using some helper functions [from here](pbt_visualization_utils.html), we can create some visuals to help us understand the training progression of PBT.
...
![../../../_images/c59f1361baaaeb15a318864bea3939459e61fb1f46e6bc9f08f247f6ed156189.png](../../../_images/c59f1361baaaeb15a318864bea3939459e61fb1f46e6bc9f08f247f6ed156189.png)
...
### Animate the training progress[#](#animate-the-training-progress "Link to this heading")
...
![PBT Visualization GIF](../../../_images/pbt.gif)

## Grid Search Comparison[#](#grid-search-comparison "Link to this heading")
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| train\_func\_91d06\_00000 | TERMINATED | 127.0.0.1:23610 | 0 | 0.015 | 100 | 0.068691 | 0.590668 | 0.9 | 0.0427973 |
| train\_func\_91d06\_00001 | TERMINATED | 127.0.0.1:23609 | 1 | 0.045 | 100 | 0.0659969 | 0.389999 | 0.000830093 | 0.9 |
...
![../../../_images/45a657ab26016ddca7a6ed8618b3d7238913bccbf302166816c2b35c94c66d70.png](../../../_images/45a657ab26016ddca7a6ed8618b3d7238913bccbf302166816c2b35c94c66d70.png)
...
![Figure 2](../../../_images/figure_from_paper.png)

## Increase PBT population size[#](#increase-pbt-population-size "Link to this heading")
...
| Trial name | status | loc | h0 | lr | iter | total time (s) | Q | theta0 | theta1 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| train\_func\_942f2\_00000 | TERMINATED | 127.0.0.1:23974 | 0.937925 | 0.1008 | 100 | 0.0464976 | 1.2 | 2.01666e-06 | 3.7014e-06 |
| train\_func\_942f2\_00001 | TERMINATED | 127.0.0.1:23979 | 1.18802 | 0.0995 | 100 | 0.0468764 | 1.2 | 1.74199e-06 | 2.48858e-06 |
| train\_func\_942f2\_00002 | TERMINATED | 127.0.0.1:23981 | 1.71075 | 0.0395 | 100 | 0.0464926 | 1.2 | 2.42464e-06 | 4.55143e-06 |
| train\_func\_942f2\_00003 | TERMINATED | 127.0.0.1:23982 | 1.42562 | 0.084 | 100 | 0.0461869 | 1.2 | 1.68403e-06 | 3.62265e-06 |
...
![../../../_images/d3b32145dc5ba2b87e9f1cc1ec6b6cd4abd1b6346be7ee27320d37db30c2a192.png](../../../_images/d3b32145dc5ba2b87e9f1cc1ec6b6cd4abd1b6346be7ee27320d37db30c2a192.png)
...
![PBT 4 Trial Visualization](../../../_images/pbt4.gif)
...
[Edit
on GitHub](https://github.com/ray-project/ray/edit/master/doc/source/tune/examples/pbt_visualization/pbt_visualization.ipynb)