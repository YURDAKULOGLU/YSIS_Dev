...
long as the [`line-length`](../settings/#line-length) setting is consistent between the two.
...
[`line-length`](../settings/#line-length), but avoids automatic line-wrapping in some cases (e.g.,
within comments). Ruff, on the other hand, will flag [`line-too-long`](../rules/line-too-long/)
(`E501`) for any line that exceeds the [`line-length`](../settings/#line-length) setting. As such, if
[`line-too-long`](../rules/line-too-long/) (`E501`) is enabled, Ruff can still trigger line-length
...
those using Ruff alongside a [type checker](./#how-does-ruff-compare-to-mypy-or-pyright-or-pyre),
...
example, Ruff's [`too-many-branches`](../rules/too-many-branches/) does not count `try` blocks as
their own branches, unlike Pylint's `R0912`. Ruff's `PL` rule group also includes a small number of
rules from Pylint *extensions* (like [`magic-value-comparison`](../rules/magic-value-comparison/)),
...
though it's also installable with `pip`, `pipx`, and a [variety of other package managers](../installation/):
...
To prevent this, you can modify the [`known-third-party`](../settings/#lint_isort_known-third-party) setting. For example, if you import
...
their location on the filesystem. For example, you can set [`known-first-party`](../settings/#lint_isort_known-first-party)
like so:
...
them. You can find the supported settings in the [API reference](../settings/#lintisort).
...
[Jupyter Notebook section](../configuration/#jupyter-notebook-discovery) for more details.
...
Yes! To enforce a docstring convention, add a [`convention`](../settings/#lint_pydocstyle_convention)
...
Alongside [`convention`](../settings/#lint_pydocstyle_convention), you'll want to
...
Enabling a [`convention`](../settings/#lint_pydocstyle_convention) will disable any rules that are not
...
[`D203`](../rules/incorrect-blank-line-before-class/),
[`D212`](../rules/multi-line-summary-first-line/),
[`D213`](../rules/multi-line-summary-second-line/),
[`D214`](../rules/overindented-section/),
[`D215`](../rules/overindented-section-underline/),
[`D404`](../rules/docstring-starts-with-this/),
[`D405`](../rules/non-capitalized-section-name/),
[`D406`](../rules/missing-new-line-after-section-name/),
[`D407`](../rules/missing-dashed-underline-after-section/),
[`D408`](../rules/missing-section-underline-after-name/),
[`D409`](../rules/mismatched-section-underline-length/),
[`D410`](../rules/no-blank-line-after-section/),
[`D411`](../rules/no-blank-line-before-section/),
[`D413`](../rules/missing-blank-line-after-last-section/),
[`D415`](../rules/missing-terminal-punctuation/),
[`D416`](../rules/missing-section-name-colon/), and
[`D417`](../rules/undocumented-param/).

The NumPy convention includes all `D` errors apart from:
[`D107`](../rules/undocumented-public-init/),
[`D203`](../rules/incorrect-blank-line-before-class/),
[`D212`](../rules/multi-line-summary-first-line/),
[`D213`](../rules/multi-line-summary-second-line/),
[`D402`](../rules/signature-in-docstring/),
[`D413`](../rules/missing-blank-line-after-last-section/),
[`D415`](../rules/missing-terminal-punctuation/),
[`D416`](../rules/missing-section-name-colon/), and
[`D417`](../rules/undocumented-param/).
...
[`D203`](../rules/incorrect-blank-line-before-class/),
[`D204`](../rules/incorrect-blank-line-after-class/),
[`D213`](../rules/multi-line-summary-second-line/),
[`D215`](../rules/overindented-section-underline/),
[`D400`](../rules/missing-trailing-period/),
[`D401`](../rules/non-imperative-mood/),
[`D404`](../rules/docstring-starts-with-this/),
[`D406`](../rules/missing-new-line-after-section-name/),
[`D407`](../rules/missing-dashed-underline-after-section/),
[`D408`](../rules/missing-section-underline-after-name/),
[`D409`](../rules/mismatched-section-underline-length/), and
[`D413`](../rules/missing-blank-line-after-last-section/).

By default, no [`convention`](../settings/#lint_pydocstyle_convention) is set, and so the enabled rules
are determined by the [`select`](../settings/#lint_select) setting alone.
...
See the [preview documentation](../preview/) for more details; or, to see which rules are currently
in preview, visit the [rules reference](../rules/).
...
fixes are available, while unsafe fixes can be enabled via the [`unsafe-fixes`](../settings/#unsafe-fixes)
setting, or passing the [`--unsafe-fixes`](../settings/#unsafe-fixes) flag to `ruff check`. For
more, see [the fix documentation](../linter/#fixes).
