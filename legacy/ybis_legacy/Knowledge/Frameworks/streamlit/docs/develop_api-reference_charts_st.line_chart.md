...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.52.0/lib/streamlit/elements/vega_charts.py#L612 "View st.line_chart source code on GitHub") | |
| --- | --- |
| st.line\_chart(data=None, \*, x=None, y=None, x\_label=None, y\_label=None, color=None, width="stretch", height="content", use\_container\_width=None) | |
| Parameters | |
...
[*arrow\_back*Previous: st.bar\_chart](/develop/api-reference/charts/st.bar_chart)[*arrow\_forward*Next: st.map](/develop/api-reference/charts/st.map)
