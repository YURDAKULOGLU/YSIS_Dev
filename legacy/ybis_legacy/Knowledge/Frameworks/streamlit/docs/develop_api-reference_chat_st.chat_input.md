...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.52.0/lib/streamlit/elements/widgets/chat.py#L596 "View st.chat_input source code on GitHub") | |
| --- | --- |
| st.chat\_input(placeholder="Your message", \*, key=None, max\_chars=None, accept\_file=False, file\_type=None, accept\_audio=False, audio\_sample\_rate=16000, disabled=False, on\_submit=None, args=None, kwargs=None, width="stretch") | |
| Parameters | |
