...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.52.0/lib/streamlit/elements/alert.py#L185 "View st.info source code on GitHub") | |
| --- | --- |
...
[*arrow\_back*Previous: st.success](/develop/api-reference/status/st.success)[*arrow\_forward*Next: st.warning](/develop/api-reference/status/st.warning)
