...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.52.0/lib/streamlit/elements/alert.py#L109 "View st.warning source code on GitHub") | |
| --- | --- |
...
[*arrow\_back*Previous: st.info](/develop/api-reference/status/st.info)[*arrow\_forward*Next: st.error](/develop/api-reference/status/st.error)
