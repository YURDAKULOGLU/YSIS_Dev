...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.52.0/lib/streamlit/elements/widgets/checkbox.py#L190 "View st.toggle source code on GitHub") | |
| --- | --- |
...
[*arrow\_back*Previous: st.select\_slider](/develop/api-reference/widgets/st.select_slider)[*arrow\_forward*Next: st.number\_input](/develop/api-reference/widgets/st.number_input)
