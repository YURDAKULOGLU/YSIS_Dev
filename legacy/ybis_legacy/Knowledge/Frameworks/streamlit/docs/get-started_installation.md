...
[*arrow\_forward*Instructions for the playground](/get-started/installation/streamlit-playground)
...
[*arrow\_forward*Instructions for the command line](/get-started/installation/command-line)
...
[*arrow\_forward*Instructions for Anaconda Distribution](/get-started/installation/anaconda-distribution)
...
[*arrow\_forward*Instructions for GitHub Codespaces](/get-started/installation/community-cloud)
...
[*arrow\_forward*Instructions for Snowflake](/get-started/installation/streamlit-in-snowflake)

[*arrow\_back*Previous: Get started](/get-started)[*arrow\_forward*Next: Use Streamlit Playground](/get-started/installation/streamlit-playground)
