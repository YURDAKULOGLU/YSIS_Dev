...
[*arrow\_back*Previous: Install via command line](/get-started/installation/command-line)[*arrow\_forward*Next: Use GitHub Codespaces](/get-started/installation/community-cloud)
