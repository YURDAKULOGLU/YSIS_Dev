Temporal CLI command reference | Temporal Platform Documentation
...
## Install the Temporal CLI[​](#install "Direct link to Install the Temporal CLI")
...
## Start a Temporal development server[​](#start-dev-server "Direct link to Start a Temporal development server")
...
## Enable auto-completion[​](#enable-auto-completion "Direct link to Enable auto-completion")

Enable auto-completion using the following commands.

### zsh auto-completion[​](#zsh-auto-completion "Direct link to zsh auto-completion")
...
### Bash auto-completion[​](#bash-auto-completion "Direct link to Bash auto-completion")
...
### Fish auto-completion[​](#fish-auto-completion "Direct link to Fish auto-completion")
...
## Command set[​](#command-set "Direct link to Command set")
...
### Namespace registration[​](#namespace-registration "Direct link to Namespace registration")
...
### Enable or disable Temporal UI[​](#enable-or-disable-temporal-ui "Direct link to Enable or disable Temporal UI")
...
#### Setting up proxy support[​](#setting-up-proxy-support "Direct link to Setting up proxy support")
...
## Common CLI operations[​](#common-operations "Direct link to Common CLI operations")

The following are some of the more common operations you can perform with the Temporal CLI.

### Start a Workflow[​](#start-a-workflow "Direct link to Start a Workflow")
...
### Customize your environment variables[​](#customize-your-environment-variables "Direct link to Customize your environment variables")
...
* [Install the Temporal CLI](#install)
  + [macOS](#macos)+ [Linux](#linux)+ [Windows](#windows)+ [Docker](#docker)* [Start a Temporal development server](#start-dev-server)* [Enable auto-completion](#enable-auto-completion)
      + [zsh auto-completion](#zsh-auto-completion)+ [Bash auto-completion](#bash-auto-completion)+ [Fish auto-completion](#fish-auto-completion)* [Command set](#command-set)* [Configuration](#configuration)
          + [Namespace registration](#namespace-registration)+ [Enable or disable Temporal UI](#enable-or-disable-temporal-ui)+ [Dynamic configuration](#dynamic-configuration)* [Environment variables](#environment-variables)* [Create and modify configuration files](#configuration-files)* [Proxy support](#proxy-support)
                + [Setting up proxy support](#setting-up-proxy-support)* [Common CLI operations](#common-operations)
                  + [Start a Workflow](#start-a-workflow)+ [Customize your environment variables](#customize-your-environment-variables)