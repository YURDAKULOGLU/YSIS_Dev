...
## Handle Cancellation in Workflow[​](#handle-cancellation-in-workflow "Direct link to Handle Cancellation in Workflow")
...
## Handle Cancellation in an Activity[​](#handle-cancellation-in-an-activity "Direct link to Handle Cancellation in an Activity")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/cancellation/activity.go)
...
## Request Cancellation[​](#request-cancellation "Direct link to Request Cancellation")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/cancellation/cancel/main.go)
...
## Heartbeating after a Cancellation[​](#heartbeating-after-a-cancellation "Direct link to Heartbeating after a Cancellation")
...
* [Handle Cancellation in Workflow](#handle-cancellation-in-workflow)* [Handle Cancellation in an Activity](#handle-cancellation-in-an-activity)* [Request Cancellation](#request-cancellation)* [Heartbeating after a Cancellation](#heartbeating-after-a-cancellation)* [Reset a Workflow Execution](#reset)