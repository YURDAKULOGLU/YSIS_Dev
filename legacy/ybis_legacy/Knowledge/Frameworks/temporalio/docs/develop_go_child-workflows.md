Child Workflows - Go SDK | Temporal Platform Documentation
...
## Start a Child Workflow Execution[​](#child-workflows "Direct link to Start a Child Workflow Execution")
...
#### Set a Parent Close Policy[​](#parent-close-policy "Direct link to Set a Parent Close Policy")
...
* [Start a Child Workflow Execution](#child-workflows)
  + [Async Child Workflows](#async-child-workflows)
    - [Set a Parent Close Policy](#parent-close-policy)