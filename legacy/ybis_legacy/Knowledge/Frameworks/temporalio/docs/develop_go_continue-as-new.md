Continue-As-New - Go SDK | Temporal Platform Documentation
...
## How to Continue-As-New using the Go SDK[​](#how "Direct link to How to Continue-As-New using the Go SDK")
...
[View the source code](https://github.com/temporalio/samples-go/blob/main/safe_message_handler/workflow.go)
...
See the [`AllHandlersFinished`](/develop/go/message-passing#wait-for-message-handlers) example for guidance.

## When is it right to Continue-as-New using the Go SDK?[​](#when "Direct link to When is it right to Continue-as-New using the Go SDK?")
...
## How to test Continue-as-New using the Go SDK[​](#how-to-test "Direct link to How to test Continue-as-New using the Go SDK")
...
* [What is Continue-As-New?](#what)* [How to Continue-As-New using the Go SDK](#how)
    + [Considerations for Workflows with Message Handlers](#with-message-handlers)* [When is it right to Continue-as-New using the Go SDK?](#when)* [How to test Continue-as-New using the Go SDK](#how-to-test)