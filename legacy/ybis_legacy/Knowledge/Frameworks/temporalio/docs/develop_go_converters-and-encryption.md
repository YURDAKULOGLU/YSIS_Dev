Converters and encryption - Go SDK | Temporal Platform Documentation
...
## Use a custom Payload Codec in Go[​](#custom-payload-codec "Direct link to Use a custom Payload Codec in Go")
...
## Use custom Payload conversion[​](#custom-payload-conversion "Direct link to Use custom Payload conversion")
...
## How to use a custom Payload Converter in Go[​](#custom-payload-converter "Direct link to How to use a custom Payload Converter in Go")
...
* [Use a custom Payload Codec in Go](#custom-payload-codec)
  + [Using a Codec Server](#using-a-codec-server)* [Use custom Payload conversion](#custom-payload-conversion)* [How to use a custom Payload Converter in Go](#custom-payload-converter)