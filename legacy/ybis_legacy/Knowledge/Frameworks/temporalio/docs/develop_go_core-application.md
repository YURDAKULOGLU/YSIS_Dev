...
## How to install the Temporal CLI and run a development server[​](#run-a-development-server "Direct link to How to install the Temporal CLI and run a development server")
...
### Start the Temporal Development Server[​](#start-the-temporal-development-server "Direct link to Start the Temporal Development Server")
...
## How to install a Temporal SDK[​](#install-a-temporal-sdk "Direct link to How to install a Temporal SDK")
...
### How to find the Go SDK API reference[​](#api-reference "Direct link to How to find the Go SDK API reference")
...
### Where are SDK-specific code examples?[​](#code-samples "Direct link to Where are SDK-specific code examples?")
...
## How to develop a basic Workflow[​](#develop-workflows "Direct link to How to develop a basic Workflow")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/yourapp/your_workflow_definition_dacx.go)
...
### How to define Workflow parameters[​](#workflow-parameters "Direct link to How to define Workflow parameters")
...
### How to define Workflow return parameters[​](#workflow-return-values "Direct link to How to define Workflow return parameters")
...
### How to customize Workflow Type in Go[​](#customize-workflow-type "Direct link to How to customize Workflow Type in Go")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/yourapp/worker/main_dacx.go)
...
### How to develop Workflow logic[​](#workflow-logic-requirements "Direct link to How to develop Workflow logic")
...
## How to develop an Activity Definition in Go[​](#activity-definition "Direct link to How to develop an Activity Definition in Go")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/yourapp/your_activity_definition_dacx.go)
...
### How to develop Activity Parameters[​](#activity-parameters "Direct link to How to develop Activity Parameters")
...
### How to define Activity return values[​](#activity-return-values "Direct link to How to define Activity return values")
...
### How to customize Activity Type in Go[​](#customize-activity-type "Direct link to How to customize Activity Type in Go")
...
## How to start an Activity Execution[​](#activity-execution "Direct link to How to start an Activity Execution")
...
### How to set the required Activity Timeouts[​](#required-timeout "Direct link to How to set the required Activity Timeouts")
...
### Go ActivityOptions reference[​](#activity-options-reference "Direct link to Go ActivityOptions reference")
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Field Required Type|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [`ActivityID`](#activityid) No `string`| [`TaskQueueName`](#taskqueuename) No `string`| [`ScheduleToCloseTimeout`](#scheduletoclosetimeout) Yes (or `StartToCloseTimeout`) `time.Duration`| [`ScheduleToStartTimeout`](#scheduletostarttimeout) No `time.Duration`| [`StartToCloseTimeout`](#scheduletoclosetimeout) Yes (or `ScheduleToCloseTimeout`) `time.Duration`| [`HeartbeatTimeout`](#heartbeattimeout) No `time.Duration`| [`WaitForCancellation`](#waitforcancellation) No `bool`| [`OriginalTaskQueueName`](#originaltaskqueuename) No `string`| [`RetryPolicy`](#retrypolicy) No [`RetryPolicy`](https://pkg.go.dev/go.temporal.io/sdk/temporal#RetryPolicy) | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |

#### ActivityID[​](#activityid "Direct link to ActivityID")
...
#### TaskQueueName[​](#taskqueuename "Direct link to TaskQueueName")
...
#### ScheduleToCloseTimeout[​](#scheduletoclosetimeout "Direct link to ScheduleToCloseTimeout")
...
#### ScheduleToStartTimeout[​](#scheduletostarttimeout "Direct link to ScheduleToStartTimeout")
...
#### StartToCloseTimeout[​](#starttoclosetimeout "Direct link to StartToCloseTimeout")
...
#### HeartbeatTimeout[​](#heartbeattimeout "Direct link to HeartbeatTimeout")
...
#### WaitForCancellation[​](#waitforcancellation "Direct link to WaitForCancellation")
...
#### OriginalTaskQueueName[​](#originaltaskqueuename "Direct link to OriginalTaskQueueName")
...
#### RetryPolicy[​](#retrypolicy "Direct link to RetryPolicy")
...
### How to get the results of an Activity Execution[​](#get-activity-results "Direct link to How to get the results of an Activity Execution")
...
## How to develop a Worker in Go[​](#develop-worker "Direct link to How to develop a Worker in Go")
...
### How to set WorkerOptions in Go[​](#workeroptions "Direct link to How to set WorkerOptions in Go")
...
#### WorkerActivitiesPerSecond[​](#workeractivitiespersecond "Direct link to WorkerActivitiesPerSecond")
...
#### MaxConcurrentLocalActivityExecutionSize[​](#maxconcurrentlocalactivityexecutionsize "Direct link to MaxConcurrentLocalActivityExecutionSize")
...
#### WorkerLocalActivitiesPerSecond[​](#workerlocalactivitiespersecond "Direct link to WorkerLocalActivitiesPerSecond")
...
#### TaskQueueActivitiesPerSecond[​](#taskqueueactivitiespersecond "Direct link to TaskQueueActivitiesPerSecond")
...
#### MaxConcurrentActivityTaskPollers[​](#maxconcurrentactivitytaskpollers "Direct link to MaxConcurrentActivityTaskPollers")
...
#### MaxConcurrentWorkflowTaskExecutionSize[​](#maxconcurrentworkflowtaskexecutionsize "Direct link to MaxConcurrentWorkflowTaskExecutionSize")
...
#### MaxConcurrentWorkflowTaskPollers[​](#maxconcurrentworkflowtaskpollers "Direct link to MaxConcurrentWorkflowTaskPollers")
...
#### EnableLoggingInReplay[​](#enablelogginginreplay "Direct link to EnableLoggingInReplay")
...
#### DisableStickyExecution[​](#disablestickyexecution "Direct link to DisableStickyExecution")
...
#### StickyScheduleToStartTimeout[​](#stickyscheduletostarttimeout "Direct link to StickyScheduleToStartTimeout")
...
#### BackgroundActivityContext[​](#backgroundactivitycontext "Direct link to BackgroundActivityContext")
...
#### WorkflowPanicPolicy[​](#workflowpanicpolicy "Direct link to WorkflowPanicPolicy")
...
#### WorkerStopTimeout[​](#workerstoptimeout "Direct link to WorkerStopTimeout")
...
#### EnableSessionWorker[​](#enablesessionworker "Direct link to EnableSessionWorker")
...
#### MaxConcurrentSessionExecutionSize[​](#maxconcurrentsessionexecutionsize "Direct link to MaxConcurrentSessionExecutionSize")
...
#### WorkflowInterceptorChainFactories[​](#workflowinterceptorchainfactories "Direct link to WorkflowInterceptorChainFactories")
...
#### LocalActivityWorkerOnly[​](#localactivityworkeronly "Direct link to LocalActivityWorkerOnly")
...
#### DeadlockDetectionTimeout[​](#deadlockdetectiontimeout "Direct link to DeadlockDetectionTimeout")
...
## How to run a Temporal Cloud Worker[​](#run-a-temporal-cloud-worker "Direct link to How to run a Temporal Cloud Worker")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/cloud/worker/main_dacx.go)
...
### How to register types[​](#register-types "Direct link to How to register types")
...
### How to set RegisterWorkflowOptions in Go[​](#registerworkflowoptions "Direct link to How to set RegisterWorkflowOptions in Go")
...
|  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Field Required Type|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | [`Name`](#name) No `string`| [`DisableAlreadyRegisteredCheck`](#disablealreadyregisteredcheck) No `bool` | | | | | | | | |

#### Name[​](#name "Direct link to Name")

See [How to customize a Workflow Type in Go](#customize-workflow-type)

#### DisableAlreadyRegisteredCheck[​](#disablealreadyregisteredcheck "Direct link to DisableAlreadyRegisteredCheck")
...
### How to set RegisterActivityOptions in Go[​](#registeractivityoptions "Direct link to How to set RegisterActivityOptions in Go")
...
|  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Field Required Type|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [`Name`](#name) No `string`| [`DisableAlreadyRegisteredCheck`](#disablealreadyregisteredcheck) No `bool`| [`SkipInvalidStructFunctions`](#skipinvalidstructfunctions) No `bool` | | | | | | | | | | | |

#### Name[​](#name-1 "Direct link to Name")

See [How to customize Activity Type in Go](#customize-activity-type).

#### DisableAlreadyRegisteredCheck[​](#disablealreadyregisteredcheck-1 "Direct link to DisableAlreadyRegisteredCheck")
...
#### SkipInvalidStructFunctions[​](#skipinvalidstructfunctions "Direct link to SkipInvalidStructFunctions")
...
## Set a Dynamic Workflow[​](#set-a-dynamic-workflow "Direct link to Set a Dynamic Workflow")
...
## Set a Dynamic Activity[​](#set-a-dynamic-activity "Direct link to Set a Dynamic Activity")
...
* [How to install the Temporal CLI and run a development server](#run-a-development-server)
  + [macOS](#macos)+ [Linux](#linux)+ [Windows](#windows)+ [Start the Temporal Development Server](#start-the-temporal-development-server)* [How to install a Temporal SDK](#install-a-temporal-sdk)
    + [How to find the Go SDK API reference](#api-reference)+ [Where are SDK-specific code examples?](#code-samples)* [How to develop a basic Workflow](#develop-workflows)
      + [How to define Workflow parameters](#workflow-parameters)+ [How to define Workflow return parameters](#workflow-return-values)+ [How to customize Workflow Type in Go](#customize-workflow-type)+ [How to develop Workflow logic](#workflow-logic-requirements)* [How to develop an Activity Definition in Go](#activity-definition)
        + [How to develop Activity Parameters](#activity-parameters)+ [How to define Activity return values](#activity-return-values)+ [How to customize Activity Type in Go](#customize-activity-type)* [How to start an Activity Execution](#activity-execution)
          + [How to set the required Activity Timeouts](#required-timeout)+ [Go ActivityOptions reference](#activity-options-reference)
              - [ActivityID](#activityid)- [TaskQueueName](#taskqueuename)- [ScheduleToCloseTimeout](#scheduletoclosetimeout)- [ScheduleToStartTimeout](#scheduletostarttimeout)- [StartToCloseTimeout](#starttoclosetimeout)- [HeartbeatTimeout](#heartbeattimeout)- [WaitForCancellation](#waitforcancellation)- [OriginalTaskQueueName](#originaltaskqueuename)- [RetryPolicy](#retrypolicy)+ [How to get the results of an Activity Execution](#get-activity-results)* [How to develop a Worker in Go](#develop-worker)
            + [How to set WorkerOptions in Go](#workeroptions)
              - [MaxConcurrentActivityExecutionSize](#maxconcurrentactivityexecutionsize)- [WorkerActivitiesPerSecond](#workeractivitiespersecond)- [MaxConcurrentLocalActivityExecutionSize](#maxconcurrentlocalactivityexecutionsize)- [WorkerLocalActivitiesPerSecond](#workerlocalactivitiespersecond)- [TaskQueueActivitiesPerSecond](#taskqueueactivitiespersecond)- [MaxConcurrentActivityTaskPollers](#maxconcurrentactivitytaskpollers)- [MaxConcurrentWorkflowTaskExecutionSize](#maxconcurrentworkflowtaskexecutionsize)- [MaxConcurrentWorkflowTaskPollers](#maxconcurrentworkflowtaskpollers)- [EnableLoggingInReplay](#enablelogginginreplay)- [DisableStickyExecution](#disablestickyexecution)- [StickyScheduleToStartTimeout](#stickyscheduletostarttimeout)- [BackgroundActivityContext](#backgroundactivitycontext)- [WorkflowPanicPolicy](#workflowpanicpolicy)- [WorkerStopTimeout](#workerstoptimeout)- [EnableSessionWorker](#enablesessionworker)- [MaxConcurrentSessionExecutionSize](#maxconcurrentsessionexecutionsize)- [WorkflowInterceptorChainFactories](#workflowinterceptorchainfactories)- [LocalActivityWorkerOnly](#localactivityworkeronly)- [Identity](#identity)- [DeadlockDetectionTimeout](#deadlockdetectiontimeout)* [How to run a Temporal Cloud Worker](#run-a-temporal-cloud-worker)
              + [How to register types](#register-types)+ [How to set RegisterWorkflowOptions in Go](#registerworkflowoptions)
                  - [Name](#name)- [DisableAlreadyRegisteredCheck](#disablealreadyregisteredcheck)+ [How to set RegisterActivityOptions in Go](#registeractivityoptions)
                    - [Name](#name-1)- [DisableAlreadyRegisteredCheck](#disablealreadyregisteredcheck-1)- [SkipInvalidStructFunctions](#skipinvalidstructfunctions)* [Set a Dynamic Workflow](#set-a-dynamic-workflow)* [Set a Dynamic Activity](#set-a-dynamic-activity)