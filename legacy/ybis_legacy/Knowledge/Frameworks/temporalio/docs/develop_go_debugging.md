Debugging - Go SDK | Temporal Platform Documentation
...
## How to test Workflow Definitions in Go[​](#testing-and-debugging "Direct link to How to test Workflow Definitions in Go")
...
#### A Simple Test[​](#a-simple-test "Direct link to A Simple Test")
...
#### Activity mocking and overriding[​](#activity-mocking-and-overriding "Direct link to Activity mocking and overriding")
...
* [How to debug in a development environment](#debug-in-a-development-environment)* [How to debug in a production environment](#debug-in-a-production-environment)* [How to test Workflow Definitions in Go](#testing-and-debugging)
      + [Setup](#setup)+ [A Simple Test](#a-simple-test)+ [Activity mocking and overriding](#activity-mocking-and-overriding)+ [Queries](#queries)+ [Debugging](#debugging)