Failure detection - Go SDK | Temporal Platform Documentation
...
### Workflow Retry Policy[​](#workflow-retries "Direct link to Workflow Retry Policy")
...
## How to set Activity timeouts[​](#activity-timeouts "Direct link to How to set Activity timeouts")
...
### Set a custom Activity Retry Policy[​](#activity-retries "Direct link to Set a custom Activity Retry Policy")
...
### Overriding the retry interval with Next Retry Delay[​](#next-retry-delay "Direct link to Overriding the retry interval with Next Retry Delay")
...
## Activity Heartbeats[​](#activity-heartbeats "Direct link to Activity Heartbeats")
...
* [Workflow timeouts](#workflow-timeouts)
  + [Workflow Retry Policy](#workflow-retries)* [How to set Activity timeouts](#activity-timeouts)
    + [Set a custom Activity Retry Policy](#activity-retries)+ [Overriding the retry interval with Next Retry Delay](#next-retry-delay)* [Activity Heartbeats](#activity-heartbeats)
