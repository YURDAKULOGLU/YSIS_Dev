Workflow message passing - Go SDK | Temporal Platform Documentation
...
## Handle messages[​](#handling-messages "Direct link to Handle messages")
...
### Signal Channels[​](#signals "Direct link to Signal Channels")
...
#### Sending a Signal from a Workflow[​](#send-signal-from-workflow "Direct link to Sending a Signal from a Workflow")
...
### Blocking handlers[​](#blocking-handlers "Direct link to Blocking handlers")
...
#### Use `workflow.Mutex` to prevent concurrent handler execution[​](#control-handler-concurrency "Direct link to control-handler-concurrency")
...
### Problems when sending an Update[​](#problems-when-sending-an-update "Direct link to Problems when sending an Update")
...
### Problems when sending a Query[​](#problems-when-sending-a-query "Direct link to Problems when sending a Query")
...
* [Handle messages](#handling-messages)
  + [Query handlers](#queries)+ [Signal Channels](#signals)+ [Update handlers and validators](#updates)* [Send messages](#send-messages)
    + [Send a Query](#send-query)+ [Send a Signal](#send-signal)+ [Send an Update](#send-update-from-client)* [Message handler patterns](#message-handler-patterns)
      + [Blocking handlers](#blocking-handlers)+ [Add blocking wait conditions](#block-with-wait)* [Troubleshooting](#troubleshooting)
        + [Problems when sending an Update](#problems-when-sending-an-update)+ [Problems when sending a Query](#problems-when-sending-a-query)