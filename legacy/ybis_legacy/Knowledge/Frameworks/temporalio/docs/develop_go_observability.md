Observability - Go SDK | Temporal Platform Documentation
...
* [Metrics](#metrics)
* [Tracing](#tracing-and-context-propagation)
* [Logging](#logging)
* [Visibility](#visibility)

## How to emit metrics[​](#metrics "Direct link to How to emit metrics")
...
## Tracing and Context Propagation[​](#tracing-and-context-propagation "Direct link to Tracing and Context Propagation")
...
Tracing functionality uses generic context propagation provided by the client.
...
#### Server-Side Headers[​](#server-side-headers "Direct link to Server-Side Headers")
...
#### Context Propagators[​](#context-propagators "Direct link to Context Propagators")
...
#### Is there a complete example?[​](#is-there-a-complete-example "Direct link to Is there a complete example?")
...
#### Can I configure multiple context propagators?[​](#can-i-configure-multiple-context-propagators "Direct link to Can I configure multiple context propagators?")

Yes. Multiple context propagators help to structure code with each propagator having its own scope of responsibility.

### Context Propagation Over Nexus Operation Calls[​](#context-propagation-over-nexus-operation-calls "Direct link to Context Propagation Over Nexus Operation Calls")
...
### Provide a custom logger[​](#custom-logger "Direct link to Provide a custom logger")
...
### Search Attributes[​](#search-attributes "Direct link to Search Attributes")
...
### Set custom Search Attributes[​](#custom-search-attributes "Direct link to Set custom Search Attributes")
...
### Upsert Search Attributes[​](#upsert-search-attributes "Direct link to Upsert Search Attributes")
...
### Remove a Search Attribute from a Workflow[​](#remove-search-attribute "Direct link to Remove a Search Attribute from a Workflow")
...
* [How to emit metrics](#metrics)* [Tracing and Context Propagation](#tracing-and-context-propagation)
    + [Context Propagation](#context-propagation)
      - [Server-Side Headers](#server-side-headers)- [Context Propagators](#context-propagators)- [Is there a complete example?](#is-there-a-complete-example)- [Can I configure multiple context propagators?](#can-i-configure-multiple-context-propagators)+ [Context Propagation Over Nexus Operation Calls](#context-propagation-over-nexus-operation-calls)+ [Useful Resources](#useful-resources)* [Log from a Workflow](#logging)
      + [Provide a custom logger](#custom-logger)* [Visibility APIs](#visibility)
        + [Search Attributes](#search-attributes)+ [Set custom Search Attributes](#custom-search-attributes)+ [Upsert Search Attributes](#upsert-search-attributes)+ [Remove a Search Attribute from a Workflow](#remove-search-attribute)