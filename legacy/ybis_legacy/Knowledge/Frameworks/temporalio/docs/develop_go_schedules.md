...
## Scheduled Workflows[​](#schedule-a-workflow "Direct link to Scheduled Workflows")

Scheduling Workflows is a crucial aspect of any automation process, especially when dealing with time-sensitive tasks. By scheduling a Workflow, you can automate repetitive tasks, reduce the need for manual intervention, and ensure timely execution of your business processes

Use any of the following action to help Schedule a Workflow Execution and take control over your automation process.

### Create a Schedule[​](#create-schedule "Direct link to Create a Schedule")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/create/main.go)
...
### Backfill a Schedule[​](#backfill-schedule "Direct link to Backfill a Schedule")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/backfill/main.go)
...
### Delete a Schedule[​](#delete-schedule "Direct link to Delete a Schedule")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/delete/main.go)
...
### Describe a Schedule[​](#describe-schedule "Direct link to Describe a Schedule")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/describe/main.go)
...
### List Schedules[​](#list-schedules "Direct link to List Schedules")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/list/main.go)
...
### Pause a Schedule[​](#pause-schedule "Direct link to Pause a Schedule")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/pause/main.go)
...
### Trigger a Schedule[​](#trigger-schedule "Direct link to Trigger a Schedule")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/trigger/main.go)
...
### Update a Schedule[​](#update-schedule "Direct link to Update a Schedule")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/schedules/update/main.go)
