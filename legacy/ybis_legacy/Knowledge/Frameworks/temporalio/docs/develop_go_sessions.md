Worker Sessions - Go SDK | Temporal Platform Documentation
...
## Enable Worker Sessions[​](#enable-sessions "Direct link to Enable Worker Sessions")

**How to enable Worker Sessions using the Go SDK.**

Set `EnableSessionWorker` to `true` in the Worker options.

[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/sessions/worker/main.go)
...
### Change the maximum concurrent Sessions of a Worker.[​](#max-concurrent-sessions "Direct link to Change the maximum concurrent Sessions of a Worker.")
...
## Create a Worker Session[​](#create-a-session "Direct link to Create a Worker Session")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/go/features/sessions/workflow.go)
...
## Additional Session usage information[​](#session-metadata "Direct link to Additional Session usage information")
...
### Recreate Session[​](#recreate-session "Direct link to Recreate Session")
...
* [Enable Worker Sessions](#enable-sessions)
  + [Change the maximum concurrent Sessions of a Worker.](#max-concurrent-sessions)* [Create a Worker Session](#create-a-session)* [Additional Session usage information](#session-metadata)
