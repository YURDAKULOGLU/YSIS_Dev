Testing - Go SDK | Temporal Platform Documentation
...
## Test frameworks[​](#test-frameworks "Direct link to Test frameworks")
...
## Testing Activities[​](#test-activities "Direct link to Testing Activities")
...
## Mock and override Activities[​](#mock-and-override-activities "Direct link to Mock and override Activities")
...
### Run an Activity[​](#run-an-activity "Direct link to Run an Activity")

If an Activity references its context, you need to mock that context when testing in isolation.

### Listen to Heartbeats[​](#listen-to-heartbeats "Direct link to Listen to Heartbeats")

When an Activity sends a Heartbeat, be sure that you can see the Heartbeats in your test code so that you can verify them.

### Cancel an Activity[​](#cancel-an-activity "Direct link to Cancel an Activity")

If an Activity is supposed to react to a Cancellation, you can test whether it reacts correctly by canceling it.

## Mock and override Nexus operations[​](#mock-and-override-nexus-operations "Direct link to Mock and override Nexus operations")
...
## Testing Workflows[​](#test-workflows "Direct link to Testing Workflows")
...
### Query tests[​](#query-tests "Direct link to Query tests")
...
### How to mock Activities[​](#mock-activities "Direct link to How to mock Activities")
...
### How to skip time[​](#skip-time "Direct link to How to skip time")
...
#### Set up time skipping[​](#setting-up "Direct link to Set up time skipping")
...
#### Skip time in Activities[​](#skip-time-in-activities "Direct link to Skip time in Activities")

Skip time in Activities in the SDK of your choice.

## How to Replay a Workflow Execution[​](#replay "Direct link to How to Replay a Workflow Execution")
...
Then it calls the `ReplayWorkflowHistory` to *replay* the Event History and return an error code.
...
* [Test frameworks](#test-frameworks)* [Test setup](#test-setup)* [Testing Activities](#test-activities)* [Mock and override Activities](#mock-and-override-activities)
        + [Run an Activity](#run-an-activity)+ [Listen to Heartbeats](#listen-to-heartbeats)+ [Cancel an Activity](#cancel-an-activity)* [Mock and override Nexus operations](#mock-and-override-nexus-operations)* [Testing Workflows](#test-workflows)
            + [Query tests](#query-tests)+ [How to mock Activities](#mock-activities)+ [How to skip time](#skip-time)
                  - [Set up time skipping](#setting-up)- [Skip time in Activities](#skip-time-in-activities)* [How to Replay a Workflow Execution](#replay)