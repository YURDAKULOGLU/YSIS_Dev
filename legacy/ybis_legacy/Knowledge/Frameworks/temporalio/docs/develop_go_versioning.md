Versioning - Go SDK | Temporal Platform Documentation
...
### Deprecating old Workflow versions[​](#deprecating-old-workflow-versions "Direct link to Deprecating old Workflow versions")
...
## Runtime checking[​](#runtime-checking "Direct link to Runtime checking")
...
* [Worker Versioning](#worker-versioning)* [Versioning with Patching](#patching)
    + [Patching with GetVersion](#patching-with-getversion)+ [Deprecating old Workflow versions](#deprecating-old-workflow-versions)+ [Workflow cutovers](#workflow-cutovers)* [Runtime checking](#runtime-checking)