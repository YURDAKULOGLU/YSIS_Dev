...
## How to Continue-As-New using the Java SDK[​](#how "Direct link to How to Continue-As-New using the Java SDK")
...
[View the source code](https://github.com/temporalio/samples-java/blob/main/core/src/main/java/io/temporal/samples/safemessagepassing/ClusterManagerWorkflow.java)
...
[View the source code](https://github.com/temporalio/samples-java/blob/main/core/src/main/java/io/temporal/samples/safemessagepassing/ClusterManagerWorkflowImpl.java)
...
## When is it right to Continue-as-New using the Java SDK?[​](#when "Direct link to When is it right to Continue-as-New using the Java SDK?")
...
## How to test Continue-as-New using the Java SDK[​](#how-to-test "Direct link to How to test Continue-as-New using the Java SDK")
...
* [What is Continue-As-New?](#what)* [How to Continue-As-New using the Java SDK](#how)* [When is it right to Continue-as-New using the Java SDK?](#when)* [How to test Continue-as-New using the Java SDK](#how-to-test)