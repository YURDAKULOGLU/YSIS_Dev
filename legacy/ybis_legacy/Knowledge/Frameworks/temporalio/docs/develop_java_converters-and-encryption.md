Converters and encryption - Java SDK | Temporal Platform Documentation
...
## Custom Payload Codec in Java[​](#custom-payload-codec "Direct link to Custom Payload Codec in Java")
...
## Using custom Payload conversion[​](#custom-payload-conversion "Direct link to Using custom Payload conversion")
...
* [Custom Payload Codec in Java](#custom-payload-codec)
  + [Using a Codec Server](#using-a-codec-server)* [Using custom Payload conversion](#custom-payload-conversion)