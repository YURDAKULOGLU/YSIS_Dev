...
## Develop a Workflow Definition[​](#develop-workflows "Direct link to Develop a Workflow Definition")
...
### Workflow interface inheritance[​](#interface-inheritance "Direct link to Workflow interface inheritance")
...
### Define Workflow parameters[​](#workflow-parameters "Direct link to Define Workflow parameters")
...
### Define Workflow return parameters[​](#workflow-return-values "Direct link to Define Workflow return parameters")
...
### Customize your Workflow Type[​](#workflow-type "Direct link to Customize your Workflow Type")
...
### Workflow logic requirements[​](#workflow-logic-requirements "Direct link to Workflow logic requirements")
...
## Develop a basic Activity[​](#develop-activities "Direct link to Develop a basic Activity")
...
### Define Activity parameters[​](#activity-parameters "Direct link to Define Activity parameters")
...
### Define Activity return values[​](#activity-return-values "Direct link to Define Activity return values")
...
### Customize your Activity Type[​](#activity-type "Direct link to Customize your Activity Type")
...
## Start an Activity Execution[​](#activity-execution "Direct link to Start an Activity Execution")
...
### Set required Activity Timeouts[​](#required-timeout "Direct link to Set required Activity Timeouts")
...
### Java ActivityOptions reference[​](#activity-options-reference "Direct link to Java ActivityOptions reference")
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Option Required Type|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [`setScheduleToCloseTimeout`](#scheduletoclosetimeout) Yes (if `StartToCloseTimeout` is not specified) Duration|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [`setScheduleToStartTimeout`](#scheduletostarttimeout) No Duration|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [`setStartToCloseTimeout`](#starttoclosetimeout) Yes (if `ScheduleToCloseTimeout` is not specified) Duration|  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [`setHeartbeatTimeout`](#heartbeattimeout) No Duration|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [`setTaskQueue`](#taskqueue) No String|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | [`setRetryOptions`](#retryoptions) No RetryOptions|  |  |  | | --- | --- | --- | | [`setCancellationType`](#setcancellationtype) No ActivityCancellationType | | | | | | | | | | | | | | | | | | | | | | | |
...
#### setCancellationType[​](#setcancellationtype "Direct link to setCancellationType")
...
### Get the result of an Activity Execution[​](#activity-execution-result "Direct link to Get the result of an Activity Execution")
...
## Develop a Worker Program in Java[​](#run-a-dev-worker "Direct link to Develop a Worker Program in Java")
...
* [Develop a Workflow Definition](#develop-workflows)
  + [Workflow interface inheritance](#interface-inheritance)+ [Define Workflow parameters](#workflow-parameters)+ [Define Workflow return parameters](#workflow-return-values)+ [Customize your Workflow Type](#workflow-type)+ [Workflow logic requirements](#workflow-logic-requirements)* [Develop a basic Activity](#develop-activities)
    + [Define Activity parameters](#activity-parameters)+ [Define Activity return values](#activity-return-values)+ [Customize your Activity Type](#activity-type)* [Start an Activity Execution](#activity-execution)
      + [Set required Activity Timeouts](#required-timeout)+ [Java ActivityOptions reference](#activity-options-reference)
          - [ScheduleToCloseTimeout](#scheduletoclosetimeout)- [ScheduleToStartTimeout](#scheduletostarttimeout)- [StartToCloseTimeout](#starttoclosetimeout)- [HeartbeatTimeout](#heartbeattimeout)- [TaskQueue](#taskqueue)- [RetryOptions](#retryoptions)- [setCancellationType](#setcancellationtype)+ [Get the result of an Activity Execution](#activity-execution-result)* [Develop a Worker Program in Java](#run-a-dev-worker)
