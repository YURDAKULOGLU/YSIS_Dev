Debugging - Java SDK | Temporal Platform Documentation
...
* [How to debug in a development environment](#debug-in-a-development-environment)* [How to debug in a production environment](#debug-in-a-production-environment)