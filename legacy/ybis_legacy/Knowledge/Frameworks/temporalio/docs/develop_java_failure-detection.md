Failure detection - Java SDK | Temporal Platform Documentation
...
### Custom Activity Retry Policy[​](#activity-retries "Direct link to Custom Activity Retry Policy")
...
### Heartbeat Timeout[​](#heartbeat-timeout "Direct link to Heartbeat Timeout")
...
* [Workflow timeouts](#workflow-timeouts)
  + [Workflow Retry Policy](#workflow-retries)* [Activity timeouts](#activity-timeouts)
    + [Custom Activity Retry Policy](#activity-retries)* [Activity next Retry delay](#activity-next-retry-delay)* [Heartbeat an Activity](#activity-heartbeats)
