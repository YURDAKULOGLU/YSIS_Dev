Namespaces - Java SDK | Temporal Platform Documentation
...
## Register a Namespace[​](#register-namespace "Direct link to Register a Namespace")
...
## Manage Namespaces[​](#manage-namespaces "Direct link to Manage Namespaces")
