Observability - Java SDK | Temporal Platform Documentation
...
* [Emit metrics](#metrics)* [Set up tracing](#tracing)
    + [Context Propagation Over Nexus Operation Calls](#context-propagation-over-nexus-operation-calls)* [Log from a Workflow](#logging)
      + [How to provide a custom logger](#custom-logger)* [Visibility APIs](#visibility)
