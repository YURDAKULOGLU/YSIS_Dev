Testing - Java SDK | Temporal Platform Documentation
...
### Setup testing dependency[​](#setup-testing-dependency "Direct link to Setup testing dependency")
...
### Sample unit tests[​](#sample-unit-tests "Direct link to Sample unit tests")
...
### Testing with JUnit4[​](#testing-with-junit4 "Direct link to Testing with JUnit4")
...
### Testing with JUnit5[​](#testing-with-junit5 "Direct link to Testing with JUnit5")
...
## Test Activities[​](#test-activities "Direct link to Test Activities")
...
### How to mock Nexus Operations[​](#mock-nexus-operations "Direct link to How to mock Nexus Operations")
...
* [Test frameworks](#test-frameworks)
  + [Setup testing dependency](#setup-testing-dependency)+ [Sample unit tests](#sample-unit-tests)+ [Testing with JUnit4](#testing-with-junit4)+ [Testing with JUnit5](#testing-with-junit5)* [Test Activities](#test-activities)
    + [Run an Activity](#run-an-activity)+ [Listen to Heartbeats](#listen-to-heartbeats)+ [Cancel an Activity](#cancel-an-activity)* [Testing Workflows](#test-workflows)
      + [How to mock Activities](#mock-activities)+ [How to mock Nexus Operations](#mock-nexus-operations)+ [How to skip time](#skip-time)
            - [Set up time skipping](#setting-up)* [How to Replay a Workflow Execution](#replay)