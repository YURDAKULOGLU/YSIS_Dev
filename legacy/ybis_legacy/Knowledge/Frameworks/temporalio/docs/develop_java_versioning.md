Versioning - Java SDK | Temporal Platform Documentation
...
### Patching with GetVersion[​](#patching-with-getversion "Direct link to Patching with GetVersion")
...
### Adding Support for Versioned Workflow Visibility in the Event History[​](#adding-support-for-versioned-workflow-visibility-in-the-event-history "Direct link to Adding Support for Versioned Workflow Visibility in the Event History")
...
#### Import the `SearchAttributes` class[​](#import-the-searchattributes-class "Direct link to import-the-searchattributes-class")

```
import io.temporal.common.SearchAttributeKey;
```

#### Define the `SearchAttributesKey` object[​](#define-the-searchattributeskey-object "Direct link to define-the-searchattributeskey-object")
...
#### Set the Search Attribute using `upsert`[​](#set-the-search-attribute-using-upsert "Direct link to set-the-search-attribute-using-upsert")
...
#### Setting Attributes for Multiple `getVersion` Calls[​](#setting-attributes-for-multiple-getversion-calls "Direct link to setting-attributes-for-multiple-getversion-calls")
