...
## How to Continue-As-New using the Python SDK[​](#how "Direct link to How to Continue-As-New using the Python SDK")
...
[View the source code](https://github.com/temporalio/samples-python/blob/main/message_passing/safe_message_handlers/workflow.py)
...
See the [`all_handlers_finished`](/develop/python/message-passing#wait-for-message-handlers) example for guidance.

## When is it right to Continue-as-New using the Python SDK?[​](#when "Direct link to When is it right to Continue-as-New using the Python SDK?")
...
## How to test Continue-as-New using the Python SDK[​](#how-to-test "Direct link to How to test Continue-as-New using the Python SDK")
...
* [What is Continue-As-New?](#what)* [How to Continue-As-New using the Python SDK](#how)* [When is it right to Continue-as-New using the Python SDK?](#when)* [How to test Continue-as-New using the Python SDK](#how-to-test)