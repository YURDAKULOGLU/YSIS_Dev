Converters and encryption - Python SDK | Temporal Platform Documentation
...
## Custom Payload Codec[​](#custom-payload-codec "Direct link to Custom Payload Codec")
...
### Using a Codec Server[​](#using-a-codec-server "Direct link to Using a Codec Server")
...
## Payload conversion[​](#payload-conversion "Direct link to Payload conversion")
...
### Conversion sequence[​](#conversion-sequence "Direct link to Conversion sequence")
...
### Custom Payload Converter[​](#custom-payload-converter "Direct link to Custom Payload Converter")
...
### Pydantic Support[​](#pydantic-support "Direct link to Pydantic Support")
...
### Custom Type Data Conversion[​](#custom-type-data-conversion "Direct link to Custom Type Data Conversion")
...
* [Custom Payload Codec](#custom-payload-codec)* [Payload conversion](#payload-conversion)