Core application - Python SDK | Temporal Platform Documentation
...
## Develop a basic Workflow[​](#develop-workflows "Direct link to Develop a basic Workflow")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_app/your_workflows_dacx.py)
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_app/your_dataobject_dacx.py)
...
### Develop Workflow logic[​](#workflow-logic-requirements "Direct link to Develop Workflow logic")
...
All API safe for Workflows used in the [`temporalio.workflow`](https://python.temporal.io/temporalio.workflow.html) must run in the implicit [`asyncio` event loop](https://docs.python.org/3/library/asyncio-eventloop.html) and be *deterministic*.
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_app/your_activities_dacx.py)
...
### Develop Activity Parameters[​](#activity-parameters "Direct link to Develop Activity Parameters")
...
### Set the required Activity Timeouts[​](#required-timeout "Direct link to Set the required Activity Timeouts")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/python/activity_timeouts_retires/your_workflows_dacx.py)
...
### Get the results of an Activity Execution[​](#get-activity-results "Direct link to Get the results of an Activity Execution")
...
## Run a Worker Process[​](#run-a-dev-worker "Direct link to Run a Worker Process")
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_app/run_worker_dacx.py)
...
### Register types[​](#register-types "Direct link to Register types")
...
* [Develop a basic Workflow](#develop-workflows)* [Develop a basic Activity](#develop-activities)* [Start an Activity Execution](#activity-execution)* [Run a Worker Process](#run-a-dev-worker)