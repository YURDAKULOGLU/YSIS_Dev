...
#### [Outbound Client calls](https://python.temporal.io/temporalio.client.OutboundInterceptor.html)[​](#outbound-client-calls "Direct link to outbound-client-calls")
...
#### [Inbound Workflow calls](https://python.temporal.io/temporalio.worker.WorkflowInboundInterceptor.html)[​](#inbound-workflow-calls "Direct link to inbound-workflow-calls")
...
#### [Outbound Workflow calls](https://python.temporal.io/temporalio.worker.WorkflowOutboundInterceptor.html)[​](#outbound-workflow-calls "Direct link to outbound-workflow-calls")
...
#### [Inbound Activity calls](https://python.temporal.io/temporalio.worker.ActivityInboundInterceptor.html)[​](#inbound-activity-calls "Direct link to inbound-activity-calls")

* `execute_activity()`
  + i.e. handle a task to execute an Activity (this is the only Inbound Activity call)

#### [Outbound Activity calls](https://python.temporal.io/temporalio.worker.ActivityOutboundInterceptor.html)[​](#outbound-activity-calls "Direct link to outbound-activity-calls")
...
## Client call Interceptors[​](#client-call-interceptors "Direct link to Client call Interceptors")
...
In the Python SDK, you will typically want to create an interceptor class that inherits from *both* `client.Interceptor` and `worker.Interceptor` as above, since their method sets do not overlap.
...
## Worker call Interceptors[​](#worker-call-interceptors "Direct link to Worker call Interceptors")
...
* [Client call Interceptors](#client-call-interceptors)* [Worker call Interceptors](#worker-call-interceptors)