Observability - Python SDK | Temporal Platform Documentation
...
[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_loggers/your_workflow_dacx.py)
...
### Use Search Attributes[​](#search-attributes "Direct link to Use Search Attributes")
...
Use the [list\_workflows()](https://python.temporal.io/temporalio.client.Client.html#list_workflows) method on the Client handle and pass a [List Filter](/list-filter) as an argument to filter the listed Workflows.

[View the source code](https://github.com/temporalio/documentation/blob/main/sample-apps/python/your_visibility/starter_dacx.py)
...
These can be created via value\_set calls on Search Attribute keys:
...
* [Emit metrics](#metrics)* [Set up tracing](#tracing)* [Log from a Workflow](#logging)* [Visibility APIs](#visibility)