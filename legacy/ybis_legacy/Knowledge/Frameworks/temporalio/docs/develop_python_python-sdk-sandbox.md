Temporal Python SDK sandbox environment | Temporal Platform Documentation
...
### Global state isolation[​](#global-state-isolation "Direct link to Global state isolation")
...
## Skip Workflow Sandboxing[​](#skip-workflow-sandboxing "Direct link to Skip Workflow Sandboxing")
...
### Skip Sandboxing for a block of code[​](#skip-sandboxing-for-a-block-of-code "Direct link to Skip Sandboxing for a block of code")
...
### Skip Sandboxing for an entire Workflow[​](#skip-sandboxing-for-an-entire-workflow "Direct link to Skip Sandboxing for an entire Workflow")
...
### Skip Sandboxing for a Worker[​](#skip-sandboxing-for-a-worker "Direct link to Skip Sandboxing for a Worker")
...
## Customize the sandbox[​](#customize-the-sandbox "Direct link to Customize the sandbox")
...
### Passthrough modules[​](#passthrough-modules "Direct link to Passthrough modules")
...
### Invalid module members[​](#invalid-module-members "Direct link to Invalid module members")
...
### Import Notification Policy[​](#import-notification-policy "Direct link to Import Notification Policy")
...
* [Benefits](#benefits)* [How it works](#how-it-works)
    + [Global state isolation](#global-state-isolation)+ [Restrictions](#restrictions)* [Skip Workflow Sandboxing](#skip-workflow-sandboxing)
      + [Skip Sandboxing for a block of code](#skip-sandboxing-for-a-block-of-code)+ [Skip Sandboxing for an entire Workflow](#skip-sandboxing-for-an-entire-workflow)+ [Skip Sandboxing for a Worker](#skip-sandboxing-for-a-worker)* [Customize the sandbox](#customize-the-sandbox)
        + [Passthrough modules](#passthrough-modules)+ [Invalid module members](#invalid-module-members)+ [Import Notification Policy](#import-notification-policy)