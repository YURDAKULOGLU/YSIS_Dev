Temporal Python SDK synchronous vs. asynchronous Activity implementations | Temporal Platform Documentation
...
## The Python Asynchronous Event Loop and Blocking Calls[​](#the-python-asynchronous-event-loop-and-blocking-calls "Direct link to The Python Asynchronous Event Loop and Blocking Calls")
...
## Python SDK Worker Execution Architecture[​](#python-sdk-worker-execution-architecture "Direct link to Python SDK Worker Execution Architecture")
...
### Number of CPU cores[​](#number-of-cpu-cores "Direct link to Number of CPU cores")
...
### A Worker infrastructure option: Separate Activity and Workflow Workers[​](#a-worker-infrastructure-option-separate-activity-and-workflow-workers "Direct link to A Worker infrastructure option: Separate Activity and Workflow Workers")
...
## Activity Definition[​](#activity-definition "Direct link to Activity Definition")
...
## How to implement Synchronous Activities[​](#how-to-implement-synchronous-activities "Direct link to How to implement Synchronous Activities")
...
### How to run Synchronous Activities on a Worker[​](#how-to-run-synchronous-activities-on-a-worker "Direct link to How to run Synchronous Activities on a Worker")
...
## How to Implement Asynchronous Activities[​](#how-to-implement-asynchronous-activities "Direct link to How to Implement Asynchronous Activities")
...
### How to run synchronous code from an asynchronous activity[​](#how-to-run-synchronous-code-from-an-asynchronous-activity "Direct link to How to run synchronous code from an asynchronous activity")
...
## When Should You Use Async Activities[​](#when-should-you-use-async-activities "Direct link to When Should You Use Async Activities")
...
using asynchronous Activities *only* when you are certain that your Activities
...
* [The Python Asynchronous Event Loop and Blocking Calls](#the-python-asynchronous-event-loop-and-blocking-calls)* [Python SDK Worker Execution Architecture](#python-sdk-worker-execution-architecture)
    + [Activities](#activities)+ [Workflows](#workflows)+ [Number of CPU cores](#number-of-cpu-cores)+ [A Worker infrastructure option: Separate Activity and Workflow Workers](#a-worker-infrastructure-option-separate-activity-and-workflow-workers)* [Activity Definition](#activity-definition)* [How to implement Synchronous Activities](#how-to-implement-synchronous-activities)
        + [How to run Synchronous Activities on a Worker](#how-to-run-synchronous-activities-on-a-worker)* [How to Implement Asynchronous Activities](#how-to-implement-asynchronous-activities)
          + [How to run synchronous code from an asynchronous activity](#how-to-run-synchronous-code-from-an-asynchronous-activity)* [When Should You Use Async Activities](#when-should-you-use-async-activities)