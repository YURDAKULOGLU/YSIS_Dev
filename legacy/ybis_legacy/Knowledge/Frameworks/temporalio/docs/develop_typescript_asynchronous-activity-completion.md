Asynchronous Activity Completion - TypeScript SDK | Temporal Platform Documentation
...
## How to asynchronously complete an Activity[​](#asynchronous-activity-completion "Direct link to How to asynchronously complete an Activity")
...
## Local Activities[​](#local-activities "Direct link to Local Activities")
...
* [How to asynchronously complete an Activity](#asynchronous-activity-completion)* [Local Activities](#local-activities)