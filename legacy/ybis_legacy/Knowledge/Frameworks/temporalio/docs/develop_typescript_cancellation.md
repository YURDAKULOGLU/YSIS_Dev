Interrupt a Workflow - TypeScript SDK | Temporal Platform Documentation
...
## Cancel an Activity from a Workflow[​](#cancel-an-activity "Direct link to Cancel an Activity from a Workflow")
...
* [Cancellation scopes in Typescript](#cancellation-scopes)
  + [CancelledFailure](#cancelledfailure)+ [Internal cancellation example](#internal-cancellation-example)+ [External cancellation example](#external-cancellation-example)+ [nonCancellable example](#noncancellable-example)+ [withTimeout example](#withtimeout-example)+ [scope.cancelRequested](#scopecancelrequested)+ [Cancellation scopes and callbacks](#cancellation-scopes-and-callbacks)+ [Nesting cancellation scopes](#nesting-cancellation-scopes)+ [Sharing promises between scopes](#sharing-promises-between-scopes)* [Cancel an Activity from a Workflow](#cancel-an-activity)* [Reset a Workflow Execution](#reset)