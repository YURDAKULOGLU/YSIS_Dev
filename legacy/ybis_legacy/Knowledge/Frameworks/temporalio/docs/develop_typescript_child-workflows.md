Child Workflows - TypeScript SDK | Temporal Platform Documentation
...
## How to start a Child Workflow Execution[​](#child-workflows "Direct link to How to start a Child Workflow Execution")
...
### How to set a Parent Close Policy[​](#parent-close-policy "Direct link to How to set a Parent Close Policy")
