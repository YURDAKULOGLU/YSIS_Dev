Converters and encryption - TypeScript SDK | Temporal Platform Documentation
...
## Payload Converter and Payload Codec Summary[​](#payload-converter-and-payload-codec-summary "Direct link to Payload Converter and Payload Codec Summary")

This section summarizes the difference between a Payload Converter and Payload Codec.

### Payload Converter[​](#payload-converter "Direct link to Payload Converter")
...
### Payload Codec[​](#payload-codec "Direct link to Payload Codec")
...
### Operational Chain[​](#operational-chain "Direct link to Operational Chain")
...
## Payload Codec[​](#payload-codec-1 "Direct link to Payload Codec")
...
## Use custom payload conversion[​](#use-custom-payload-conversion "Direct link to Use custom payload conversion")
...
## Composite Data Converters[​](#composite-data-converters "Direct link to Composite Data Converters")
...
## How to use a custom payload converter in TypeScript[​](#custom-payload-conversion "Direct link to How to use a custom payload converter in TypeScript")
...
* [Payload Converter and Payload Codec Summary](#payload-converter-and-payload-codec-summary)* [Payload Codec](#payload-codec-1)* [Use custom payload conversion](#use-custom-payload-conversion)* [Composite Data Converters](#composite-data-converters)* [How to use a custom payload converter in TypeScript](#custom-payload-conversion)