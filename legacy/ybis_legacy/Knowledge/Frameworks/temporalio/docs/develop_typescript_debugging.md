Debugging - TypeScript SDK | Temporal Platform Documentation
...
## How to debug in a development environment[​](#debug-in-a-development-environment "Direct link to How to debug in a development environment")
...
## How to debug in a production environment[​](#debug-in-a-production-environment "Direct link to How to debug in a production environment")
...
## How to troubleshoot common issues in the TypeScript SDK[​](#troubleshoot-common-issues "Direct link to How to troubleshoot common issues in the TypeScript SDK")

### Two locations to watch[​](#two-locations-to-watch "Direct link to Two locations to watch")
...
### Stale Workflows[​](#stale-workflows "Direct link to Stale Workflows")
...
### Workflow/Activity registration errors[​](#workflowactivity-registration-errors "Direct link to Workflow/Activity registration errors")
...
### Webpack errors[​](#webpack-errors "Direct link to Webpack errors")
...
### Works in Dev but not in Prod[​](#works-in-dev-but-not-in-prod "Direct link to Works in Dev but not in Prod")

The two main sources of dev-prod discrepancies are in bundling and connecting.

#### Production bundling[​](#production-bundling "Direct link to Production bundling")
...
Temporal Web UI showing stripped 'Workflow Type' entries, in this case the single letter 's'
...
#### Connecting to Temporal Server[​](#connecting-to-temporal-server "Direct link to Connecting to Temporal Server")
...
### Resetting Workflows to deal with logical bugs[​](#resetting-workflows-to-deal-with-logical-bugs "Direct link to Resetting Workflows to deal with logical bugs")
...
### gRPC call timeouts (context deadline exceeded)[​](#grpc-call-timeouts-context-deadline-exceeded "Direct link to gRPC call timeouts (context deadline exceeded)")
...
* [How to debug in a development environment](#debug-in-a-development-environment)* [How to debug in a production environment](#debug-in-a-production-environment)* [How to troubleshoot common issues in the TypeScript SDK](#troubleshoot-common-issues)
      + [Two locations to watch](#two-locations-to-watch)+ [Stale Workflows](#stale-workflows)+ [Workflow/Activity registration errors](#workflowactivity-registration-errors)+ [Webpack errors](#webpack-errors)+ [Works in Dev but not in Prod](#works-in-dev-but-not-in-prod)
                - [Production bundling](#production-bundling)- [Connecting to Temporal Server](#connecting-to-temporal-server)+ [Resetting Workflows to deal with logical bugs](#resetting-workflows-to-deal-with-logical-bugs)+ [gRPC call timeouts (context deadline exceeded)](#grpc-call-timeouts-context-deadline-exceeded)