Failure detection - TypeScript SDK feature guide | Temporal Platform Documentation
...
## Activity Timeouts[​](#activity-timeouts "Direct link to Activity Timeouts")
...
## Activity Retry Policy[​](#activity-retries "Direct link to Activity Retry Policy")
...
## Activity next Retry delay[​](#activity-next-retry-delay "Direct link to Activity next Retry delay")
...
## Activity Heartbeat Timeout[​](#activity-heartbeat-timeout "Direct link to Activity Heartbeat Timeout")
