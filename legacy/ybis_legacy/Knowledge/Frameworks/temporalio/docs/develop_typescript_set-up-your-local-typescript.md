Set up your local with the Typescript SDK | Temporal Platform Documentation
...
Install Node.js via your package manager by following the [official Node.js instructions](https://nodejs.org/en/download/).

## Install the Temporal TypeScript SDK[​](#install-the-temporal-typescript-sdk "Direct link to Install the Temporal TypeScript SDK")
...
→](https://learn.temporal.io/getting_started/typescript/first_program_in_typescript/)