Testing - TypeScript SDK | Temporal Platform Documentation
...
#### Skip time automatically[​](#automatic-method "Direct link to Skip time automatically")
...
#### Skip time manually[​](#manual-method "Direct link to Skip time manually")
...
### Test functions in Workflow context[​](#workflow-context "Direct link to Test functions in Workflow context")
...
### Assert in Workflow[​](#assert-in-workflow "Direct link to Assert in Workflow")
...
* [Test frameworks](#test-frameworks)* [Testing Activities](#test-activities)
    + [Run an Activity](#run-an-activity)+ [Listen to Heartbeats](#listen-to-heartbeats)+ [Cancel an Activity](#cancel-an-activity)* [Testing Workflows](#test-workflows)
      + [How to mock Activities](#mock-activities)+ [How to skip time](#skip-time)
          - [Set up time skipping](#setting-up)- [Skip time automatically](#automatic-method)- [Skip time manually](#manual-method)- [Skip time in Activities](#skip-time-in-activities)+ [Test functions in Workflow context](#workflow-context)+ [Assert in Workflow](#assert-in-workflow)* [How to Replay a Workflow Execution](#replay)