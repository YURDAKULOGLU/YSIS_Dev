Versioning - TypeScript SDK | Temporal Platform Documentation
...
### Patching in new code[​](#patching-in-new-code "Direct link to Patching in new code")
...
* [Versioning with Patching](#patching)
  + [Adding a patch](#adding-a-patch)+ [Patching in new code](#patching-in-new-code)+ [Deprecating patches](#deprecated-patches)+ [Removing a patch](#deploy-new-code)+ [Workflow cutovers](#workflow-cutovers)+ [Testing a Workflow for replay safety](#testing-a-workflow-for-replay-safety)* [Worker Versioning](#worker-versioning)