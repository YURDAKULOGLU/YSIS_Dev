QueryPredicateArg.Literal (JTreeSitter 0.26.0 API)
...
public static record QueryPredicateArg.Literal([String](https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/lang/String.html "class or interface in java.lang") value)
...
* ## Constructor Details
  ...
  + ### Literal
    ...
    public Literal([String](https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/lang/String.html "class or interface in java.lang") value)
