...
* Build the `tree-sitter-cli` [Rust crate](https://crates.io/crates/tree-sitter-cli) from source using [`cargo`](https://doc.rust-lang.org/cargo/getting-started/installation.html), the Rust package manager. This works
  on any platform. See [the contributing docs](../6-contributing.html#developing-tree-sitter) for more information.
...
To learn more about this command, check the [reference page](../cli/init.html).
...
To learn more about this command, check the [reference page](../cli/generate.html).