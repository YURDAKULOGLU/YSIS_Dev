...
* **`bool (*is_at_included_range_start)(const TSLexer *)`** — A function for checking whether the parser has just skipped
  ...
  (described in the [multi-language document section](../using-parsers/3-advanced-parsing.html#multi-language-documents)), the scanner may want to apply some special
