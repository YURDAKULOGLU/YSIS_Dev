...
def test_ollama():
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            print(f"[WARN] Ollama Server: Online but returned {resp.status_code}")
    except:
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if tags_resp.status_code == 200:
                ...
                print(f"[INFO]️ Installed Models: {models}")
                print(f"[WARN] Configured model '{model_name}' might be missing.")
