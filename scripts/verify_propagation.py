...
def run_propagation():
    ...
    print(f"[INFO] Cloning core organs into {sub_factory}...")
    ...
    print("[INFO] Verifying health of the new organism...")
    try:
        ...
        if "[SUCCESS] SYSTEM INTEGRITY: 100%" in result.stdout:
            print("\n[SUCCESS] SUCCESS: The organism has successfully propagated!")
            return True
        else:
            print("\n[ERROR] FAILURE: Sub-factory integrity compromised.")
            print(result.stderr)
            return False
