...
def test_mem0_integration():
    print("[INFO] Testing Mem0 Integration...")
    ...
    # 2. Add Memory
    print("[INFO] Adding memory: 'The user prefers Python over Java.'")
    memory.add("The user prefers Python over Java.", metadata={"category": "preference"})

    # 3. Search Memory
    print("[INFO] Searching for 'programming preference'...")
    results = memory.search("programming preference")
    print(f"   Found: {results}")

    if any("Python" in r for r in results):
        print("[OK] Mem0 Test PASSED: Memory retrieved successfully.")
    else:
        print("[ERROR] Mem0 Test FAILED: Could not retrieve memory.")
